...
setupEvent = AddEventHandler("Core:Shared:Ready", function()
  exports['core']:RequestDependencies("Sounds", {
    "Callbacks",
    "Logger",
    "Sounds",
    "UISounds",
...
AddEventHandler("Proxy:Shared:RegisterReady", function()
  exports['core']:RegisterComponent("Sounds", SOUNDS)
end)

RegisterNUICallback("SoundEnd", function(data, cb)
  exports['core']:LoggerTrace("Sounds", ("^2Stopping Sound %s For ID %s^7"):format(data.file, data.source))
...
SOUNDS.Do = {
  Loop = {
    One = function(self, soundFile, soundVolume)
      exports['core']:LoggerTrace("Sounds", ("^2Looping Sound %s On Client Only^7"):format(soundFile))
  ...
  Play = {
    One = function(self, soundFile, soundVolume)
      exports['core']:LoggerTrace("Sounds", ("^2Playing Sound %s On Client Only^7"):format(soundFile))
      _sounds[LocalPlayer.state.ID] = _sounds[LocalPlayer.state.ID] or {}
      _sounds[LocalPlayer.state.ID][soundFile] = {
        file = soundFile,
        volume = soundVolume,
  ...
  Stop = {
    One = function(self, soundFile)
      exports['core']:LoggerTrace("Sounds", ("^2Stopping Sound %s On Client^7"):format(soundFile))
    ...
    Distance = function(self, playerNetId, soundFile)
      exports['core']:LoggerTrace("Sounds", ("^2Stopping Sound %s Per Request From %s^7"):format(soundFile, playerNetId))
...
SOUNDS.Play = {
  ...
  Distance = function(self, maxDistance, soundFile, soundVolume)
    exports['core']:CallbacksServer("Sounds:Play:Distance", {
  ...
  Location = function(self, location, maxDistance, soundFile, soundVolume)
    exports['core']:CallbacksServer("Sounds:Play:Location", {
      location = location,
      maxDistance = maxDistance,
      soundFile = soundFile,
      soundVolume = soundVolume,
...
SOUNDS.Loop = {
  ...
  Distance = function(self, maxDistance, soundFile, soundVolume)
    exports['core']:CallbacksServer("Sounds:Loop:Distance", {
      maxDistance = maxDistance,
      soundFile = soundFile,
      soundVolume = soundVolume,
    })
  ...
  Location = function(self, location, maxDistance, soundFile, soundVolume)
    exports['core']:CallbacksServer("Sounds:Loop:Location", {
      location = location,
      maxDistance = maxDistance,
      soundFile = soundFile,
      soundVolume = soundVolume,
...
SOUNDS.Stop = {
  ...
  Distance = function(self, pNet, soundFile)
    exports['core']:CallbacksServer("Sounds:Stop:Distance", {
      soundFile = soundFile,
    })
  end,
