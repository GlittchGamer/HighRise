...
setupEvent = AddEventHandler("Core:Shared:Ready", function()
  exports["hrrp-base"]:RequestDependencies("Lasers", {
    ...
    exports["hrrp-base"]:CallbacksRegisterClient("Lasers:Create:Start", function()
      creationEnabled = true
      inOriginMode = true
      startCreation()
    end)

    exports["hrrp-base"]:CallbacksRegisterClient("Lasers:Create:End", function()
      creationEnabled = false
    end)

    exports["hrrp-base"]:CallbacksRegisterClient("Lasers:Create:Save", function()
...
AddEventHandler("Proxy:Shared:RegisterReady", function()
  exports["hrrp-base"]:RegisterComponent("Lasers", _LASERS)
end)
