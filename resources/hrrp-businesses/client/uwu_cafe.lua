...
AddEventHandler('Businesses:Client:Startup', function()
  for k, v in ipairs(cats) do
    exports['hrrp-pedinteraction']:Add('uwu-cat-' .. k, `a_c_cat_01`, v.coords, v.heading, 25.0, {
  ...
  exports['hrrp-polyzone']:PolyZoneCreateBox('uwu_cafe_door', vector3(-581.05, -1068.09, 22.34), 3.0, 1.6, {
    heading = 0,
    --debugPoly=true,
    minZ = 21.34,
    maxZ = 24.54
