...
Citizen.CreateThread(function()
    ...
    exports['hrrp-base']:LoggerInfo("Jobs", "Salary Thread Starting")
        ...
        for k, v in pairs(Fetch:All()) do
            ...
            if char ~= nil then
                ...
                if dutyData and not Player(v:GetData("Source")).state.gettingPaycheck then
                    ...
                    exports['hrrp-base']:LoggerInfo("Jobs", string.format("Adding Salary Data For ^3%s^7 (^2%s Minutes^7 - ^3$%s^7)", char:GetData("SID"), workedMinutes, salary))
