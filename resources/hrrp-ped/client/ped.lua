...
function RetrieveComponents()
  ...
  Spawn = exports["hrrp-base"]:FetchComponent("Spawn")
    ...
    Interaction:ShowMenu({
      {
        ...
        action = function()
          exports["hrrp-base"]:CallbacksServer("Ped:RemoveMask")
          Interaction:Hide()
        end,
      },
      {
        ...
        action = function()
          exports["hrrp-base"]:CallbacksServer("Ped:RemoveHat")
          Interaction:Hide()
        end,
      },
      {
...
PED = {
  ...
  Creator = {
    ...
    End = function(self)
      ...
      exports["hrrp-base"]:CallbacksServer("Apartment:SpawnInside", {})
    end,
  },
  Customization = {
    ...
    Save = function(self, cb)
      FROZEN = false
      exports["hrrp-base"]:CallbacksServer("Ped:MakePayment", {
        type = _currentState,
        ...
        if status then
          ...
          Ped:ApplyToPed(LocalPed)
          exports["hrrp-base"]:CallbacksServer("Ped:SavePed", {
            ped = LocalPed,
          }, function(saved)
            if _currentState == "CREATOR" then
              ...
              Ped.Customization:Hide()
              exports['hrrp-hud']:NotificationSuccess(string.format("You Paid $%s", paid))
            end
          end)
        else
          exports['hrrp-hud']:NotificationError("You Don't Have Enough Cash")
        end
        cb(status)
      end)
    end,
