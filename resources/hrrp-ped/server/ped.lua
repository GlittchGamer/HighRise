...
setupEvent = AddEventHandler("Core:Shared:Ready", function()
  exports["hrrp-base"]:RequestDependencies("Ped", {
    "Fetch",
    "Callbacks",
...
AddEventHandler("Proxy:Shared:RegisterReady", function()
  exports["hrrp-base"]:RegisterComponent("Ped", PED)
end)
...
function RegisterCallbacks()
  exports['hrrp-base']:CallbacksRegisterServer("Ped:CheckPed", function(source, data, cb)
  ...
  exports['hrrp-base']:CallbacksRegisterServer("Ped:MakePayment", function(source, data, cb)
  ...
  exports['hrrp-base']:CallbacksRegisterServer("Ped:SavePed", function(source, data, cb)
    local player = exports["hrrp-base"]:FetchComponent("Fetch"):Source(source)
    local char = player:GetData("Character")
    cb(Ped:Save(char, data.ped))
  end)

  exports['hrrp-base']:CallbacksRegisterServer("Ped:RemoveMask", function(source, data, cb)
    local plyr = exports['hrrp-base']:FetchSource(source)
    if plyr ~= nil then
      local char = plyr:GetData("Character")
      if char ~= nil then
  ...
  exports['hrrp-base']:CallbacksRegisterServer("Ped:RemoveHat", function(source, data, cb)
    local plyr = exports['hrrp-base']:FetchSource(source)
    if plyr ~= nil then
      local char = plyr:GetData("Character")
      if char ~= nil then
  ...
  exports['hrrp-base']:CallbacksRegisterServer("Ped:RemoveAccessory", function(source, data, cb)
    local plyr = exports['hrrp-base']:FetchSource(source)
    if plyr ~= nil then
      local char = plyr:GetData("Character")
      if char ~= nil then
