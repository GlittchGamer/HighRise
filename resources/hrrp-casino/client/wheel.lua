...
AddEventHandler("Casino:Client:UnlockWheel", function()
  exports["hrrp-base"]:CallbacksServer("Casino:UnlockWheel", {}, function(success)
    if success then
      exports['hrrp-hud']:NotificationSuccess("Wheel Unlocked")
    else
...
AddEventHandler("Casino:Client:StartSpin", function(_, data)
  exports["hrrp-base"]:CallbacksServer("Casino:WheelStart", data, function(success, tooPoor)
    if success then
      ...
      exports["hrrp-base"]:CallbacksServer("Casino:WheelSpin", {})
      ...
      if tooPoor then
        if data.turbo then
          exports['hrrp-hud']:NotificationError("Not Enough Cash or No VIP Card")
        else
