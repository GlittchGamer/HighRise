...
AddEventHandler("Casino:Client:StartChipPurchase", function()
  ...
  if cash >= 100 then
    ...
    exports['hrrp-hud']:ListMenuShow(buyMenu)
  else
    exports['hrrp-hud']:NotificationError("Not Enough Cash - Minimum is $100")
  end
end)

AddEventHandler("Casino:Client:ConfirmChipPurchase", function(data)
  exports["hrrp-base"]:CallbacksServer("Casino:BuyChips", data.amount)
end)
...
AddEventHandler("Casino:Client:StartChipSell", function()
  ...
  if chips > 0 then
    ...
    exports['hrrp-hud']:NotificationError("No Chips to Sell")
  end
end)

AddEventHandler("Casino:Client:ConfirmChipSell", function(data)
  exports["hrrp-base"]:CallbacksServer("Casino:SellChips", data.amount)
end)
