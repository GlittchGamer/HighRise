...
AddEventHandler("Casino:Server:Startup", function()
  ...
  exports['hrrp-base']:CallbacksRegisterServer("Casino:SlotMachineSit", function(source, machineId, cb)
  ...
  exports['hrrp-base']:CallbacksRegisterServer("Casino:SlotMachinePlay", function(source, data, cb)
    --local char = exports['hrrp-base']:FetchSource(source):GetData("Character")
  ...
  exports['hrrp-base']:CallbacksRegisterServer("Casino:SlotMachineLeave", function(source, data, cb)
    local char = exports['hrrp-base']:FetchSource(source):GetData("Character")
    if not char then
      return cb(false)
    end
