...
AddEventHandler("Casino:Server:Startup", function()
  ...
  exports['hrrp-base']:CallbacksRegisterServer("Casino:WheelStart", function(source, data, cb)
  ...
  exports['hrrp-base']:CallbacksRegisterServer("Casino:WheelSpin", function(source, data, cb)
  ...
  exports['hrrp-base']:CallbacksRegisterServer("Casino:UnlockWheel", function(source, data, cb)
