...
function RegisterCallbacks()
  exports['hrrp-base']:CallbacksRegisterServer("Characters:GetServerData", function(source, data, cb)
    local motd = GetConvar("motd", "Welcome to HighRiseRP")
    cb({ changelog = nil, motd = motd })
  end)

  exports['hrrp-base']:CallbacksRegisterServer("Characters:GetCharacters", function(source, data, cb)
  ...
  exports['hrrp-base']:CallbacksRegisterServer("Characters:CreateCharacter", function(source, data, cb)
    local player = exports['hrrp-base']:FetchSource(source)
    ...
    local extra = exports['hrrp-base']:MiddlewareTriggerEventWithData("Characters:Creating", source, doc)
    ...
    exports['hrrp-base']:MiddlewareTriggerEvent("Characters:Created", source, doc)
  ...
  exports['hrrp-base']:CallbacksRegisterServer("Characters:DeleteCharacter", function(source, data, cb)
    local player = exports['hrrp-base']:FetchSource(source)
  ...
  exports['hrrp-base']:CallbacksRegisterServer("Characters:GetSpawnPoints", function(source, data, cb)
    local player = exports['hrrp-base']:FetchSource(source)
    local myCharacter = MySQL.single.await(
      [[
        SELECT * FROM `characters` WHERE `User` = @User AND `_id` = @ID
    ...
    local spawns = exports['hrrp-base']:MiddlewareTriggerEventWithData("Characters:GetSpawnPoints", source, data, myCharacter)
    cb(spawns)
  end)

  exports['hrrp-base']:CallbacksRegisterServer("Characters:GetCharacterData", function(source, data, cb)
    local player = exports['hrrp-base']:FetchSource(source)
    local myCharacter = MySQL.single.await(
      [[
        SELECT * FROM `characters` WHERE `User` = @User AND `_id` = @ID
    ...
    local store = exports['hrrp-base']:DataStoreCreate(source, 'Character', cData)
    ...
    exports['hrrp-base']:MiddlewareTriggerEvent("Characters:CharacterSelected", source)

    cb(cData)
  end)

  exports['hrrp-base']:CallbacksRegisterServer("Characters:Logout", function(source, data, cb)
    local player = exports['hrrp-base']:FetchSource(source)
    exports['hrrp-base']:MiddlewareTriggerEvent("Characters:Logout", source)
  ...
  exports['hrrp-base']:CallbacksRegisterServer("Characters:GlobalSpawn", function(source, data, cb)
...
function RegisterMiddleware()
  ...
  exports['hrrp-base']:MiddlewareAdd("Characters:ForceStore", function(source)
    local player = exports['hrrp-base']:FetchSource(source)
    if player ~= nil then
      local char = player:GetData("Character")
      if char ~= nil then
  ...
  exports['hrrp-base']:MiddlewareAdd("Characters:GetSpawnPoints", function(source, id)
    if id then
  ...
  exports['hrrp-base']:MiddlewareAdd("Characters:GetSpawnPoints", function(source)
    local spawns = {}
  ...
  exports['hrrp-base']:MiddlewareAdd("playerDropped", function(source, message)
    local player = exports['hrrp-base']:FetchSource(source)
    if player ~= nil then
      local char = player:GetData("Character")
      if char ~= nil then
  ...
  exports['hrrp-base']:MiddlewareAdd("Characters:Logout", HandleLastLocation, 6)
  exports['hrrp-base']:MiddlewareAdd("playerDropped", HandleLastLocation, 6)
end
