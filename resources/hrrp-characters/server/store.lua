...
function StoreData(source)
  ...
  exports['hrrp-base']:LoggerTrace("Characters", string.format("Saving Character %s", cId), { console = true })
  ...
  exports['hrrp-base']:LoggerTrace("Characters", string.format("Character %s has been saved to the Database successfully", cId),
    { console = true })
end
...
Citizen.CreateThread(function()
  ...
  while true do
    local v = exports['hrrp-base']:FetchNext(_prevSaved)
    ...
    local c = exports['hrrp-base']:FetchCountCharacters() or 1
    exports['hrrp-base']:LoggerTrace(
      "Characters",
