        ...
        while _characterLoaded do
            if not _customChannelOverride then
                ...
                if newGrid ~= CURRENT_GRID then
                    --exports['core']:LoggerTrace('VOIP', ('Changing Grid Zone To %s From %s'):format(newGrid, CURRENT_GRID))
                ...
                if CURRENT_GRID ~= _customChannelOverride then
                    exports['core']:LoggerTrace('VOIP', 'Channel Override Set to ' .. _customChannelOverride)
