function RegisterStashCallbacks()
	exports['core']:CallbacksRegisterServer("Stash:Server:Open", function(source, data, cb)
	...
	exports['core']:CallbacksRegisterServer("Shop:Server:Open", function(source, data, cb)
	...
	exports['core']:CallbacksRegisterServer("Inventory:Server:Open", function(source, data, cb)
