local vendingMachines = {
  { model = `prop_vend_coffe_01`,    shop = "vending-coffee", icon = "coffee-pot",      text = "Use Coffee Machine" },
  ...
  { model = `prop_vend_soda_01`,     shop = "vending-drinks", icon = "cup-straw-swoosh" },
  { model = `prop_vend_soda_02`,     shop = "vending-drinks", icon = "cup-straw-swoosh" },
  { model = `v_68_broeknvend`,       shop = "vending-drinks", icon = "cup-straw-swoosh" },
  { model = `prop_vend_snak_01`,     shop = "vending-food",   icon = "gingerbread-man" },
...
function CreateVendingMachines()
  for k, v in ipairs(vendingMachines) do
    exports['ox_target']:TargetingAddObject(v.model, v.icon, {
      {
