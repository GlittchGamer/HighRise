...
setupEvent = AddEventHandler("Core:Shared:Ready", function()
  exports['core']:RequestDependencies("Weapons", {
    "Callbacks",
    "Notification",
    "Weapons",
    "Progress",
    ...
    exports['core']:CallbacksRegisterClient("Weapons:Check", function(data, cb)
    ...
    exports['core']:CallbacksRegisterClient("Weapons:EquipAttachment", function(data, cb)
      if _equipped ~= nil then
        Progress:Progress({
          name = "attch_action",
          duration = 5000,
    ...
    exports['core']:CallbacksRegisterClient("Weapons:Logout", function(data, cb)
      if _equipped ~= nil then
        _interacting = true
    ...
    exports['core']:CallbacksRegisterClient("Weapons:AddAmmo", function(data, cb)
      if _equipped ~= nil and _items[_equipped.Name].ammoType == data.ammoType then
        ...
        if _equipped == nil then
          exports['hud']:NotificationError("No Weapon Equipped")
        else
          exports['hud']:NotificationError("Wrong Ammo Type")
        end
    ...
    exports['core']:CallbacksRegisterClient("Weapons:CanEquipParachute", function(data, cb)
...
-- 					xhair = true
-- 					exports['hud']:XHair(true)
-- 				end
-- 			elseif not (fa or sh) and xhair then
-- 				xhair = false
-- 				exports['hud']:XHair(false)
-- 			end
-- 			Citizen.Wait(3)
-- 		end
-- 		exports['hud']:XHair(false)
...
AddEventHandler("Proxy:Shared:RegisterReady", function()
  exports['core']:RegisterComponent("Weapons", WEAPONS)
end)
    ...
    while LocalPlayer.state.loggedIn do
      if _equipped ~= nil then
        if IsPedShooting(LocalPlayer.state.ped) and _equippedData.isThrowable then
          ...
          Inventory.Close:All()
          exports['core']:CallbacksServer("Weapons:UseThrowable", _equipped, function()
            SendNUIMessage({
              type = "SLOT_NOT_USED",
              data = {
                originSlot = slot,
    ...
    Citizen.CreateThread(function()
      while _parachuteThread and LocalPlayer.state.loggedIn do
        ...
        if GetPedParachuteState(LocalPlayer.state.ped) >= 2 then
          Citizen.Wait(2500)
          exports['core']:CallbacksServer("Inventory:UsedParachute", {})
          break
        end
      end
    end)
...
AddEventHandler("Characters:Client:Spawn", function()
  Citizen.Wait(1000)
  exports['hud']:RegisterStatus("parachute", 0, 100, "parachute-box", "#A72929", false, false, {
    hideZero = true,
  })
end)
