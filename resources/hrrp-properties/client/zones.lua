...
function DestroyPropertyZones(propertyId)
  exports['ox_target']:TargetingZonesRemoveZone(string.format("property-%s-exit", propertyId))
  exports['ox_target']:TargetingZonesRemoveZone(string.format("property-%s-exit-back", propertyId))
  exports['ox_target']:TargetingZonesRemoveZone(string.format("property-%s-warehouse", propertyId))
  exports['ox_target']:TargetingZonesRemoveZone(string.format("property-%s-office", propertyId))
  exports['ox_target']:TargetingZonesRemoveZone(string.format("property-%s-crafting", propertyId))
end
