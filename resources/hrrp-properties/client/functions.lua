...
function EnterProperty(data, backdoor)
  exports["hrrp-base"]:CallbacksServer("Properties:EnterProperty", data.propertyId, function(state, pId, int)
    if state then
      Interaction:Hide()
...
function ExitProperty(data, backdoor)
  exports["hrrp-base"]:CallbacksServer("Properties:ExitProperty", {}, function(pId)
    ...
    if _placingFurniture then
      exports['hrrp-objects']:Cancel(true, true)
      Phone:ResetRoute()
    ...
    -- exports['ox_target']:TargetingZonesRemoveZone(string.format("property-%s-logout", pId))
    -- exports['ox_target']:TargetingZonesRemoveZone(string.format("property-%s-closet", pId))
    -- exports['ox_target']:TargetingZonesRemoveZone(string.format("property-%s-stash", pId))
    exports['ox_target']:TargetingZonesRemoveZone(string.format("property-%s-exit", pId))
    exports['ox_target']:TargetingZonesRemoveZone(string.format("property-%s-exit-back", pId))
    --exports['hrrp-polyzone']:PolyZoneRemove("property-int-zone")
