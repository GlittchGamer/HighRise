function RegisterStashCallbacks()
	exports['hrrp-base']:CallbacksRegisterServer("Stash:Server:Open", function(source, data, cb)
	...
	exports['hrrp-base']:CallbacksRegisterServer("Shop:Server:Open", function(source, data, cb)
	...
	exports['hrrp-base']:CallbacksRegisterServer("Inventory:Server:Open", function(source, data, cb)
