...
setupEvent = AddEventHandler("Core:Shared:Ready", function()
  exports["hrrp-base"]:RequestDependencies("Weapons", {
    "Callbacks",
    "Notification",
    "Weapons",
    "Progress",
    ...
    exports["hrrp-base"]:CallbacksRegisterClient("Weapons:Check", function(data, cb)
    ...
    exports["hrrp-base"]:CallbacksRegisterClient("Weapons:EquipAttachment", function(data, cb)
      if _equipped ~= nil then
        Progress:Progress({
          name = "attch_action",
          duration = 5000,
    ...
    exports["hrrp-base"]:CallbacksRegisterClient("Weapons:Logout", function(data, cb)
      if _equipped ~= nil then
        _interacting = true
    ...
    exports["hrrp-base"]:CallbacksRegisterClient("Weapons:AddAmmo", function(data, cb)
      if _equipped ~= nil and _items[_equipped.Name].ammoType == data.ammoType then
        ...
        if _equipped == nil then
          exports['hrrp-hud']:NotificationError("No Weapon Equipped")
        else
          exports['hrrp-hud']:NotificationError("Wrong Ammo Type")
        end
    ...
    exports["hrrp-base"]:CallbacksRegisterClient("Weapons:CanEquipParachute", function(data, cb)
...
-- 					xhair = true
-- 					exports['hrrp-hud']:XHair(true)
-- 				end
-- 			elseif not (fa or sh) and xhair then
-- 				xhair = false
-- 				exports['hrrp-hud']:XHair(false)
-- 			end
-- 			Citizen.Wait(3)
-- 		end
-- 		exports['hrrp-hud']:XHair(false)
...
AddEventHandler("Proxy:Shared:RegisterReady", function()
  exports["hrrp-base"]:RegisterComponent("Weapons", WEAPONS)
end)
    ...
    while LocalPlayer.state.loggedIn do
      if _equipped ~= nil then
        if IsPedShooting(LocalPlayer.state.ped) and _equippedData.isThrowable then
          ...
          Inventory.Close:All()
          exports["hrrp-base"]:CallbacksServer("Weapons:UseThrowable", _equipped, function()
            SendNUIMessage({
              type = "SLOT_NOT_USED",
              data = {
                originSlot = slot,
    ...
    Citizen.CreateThread(function()
      while _parachuteThread and LocalPlayer.state.loggedIn do
        ...
        if GetPedParachuteState(LocalPlayer.state.ped) >= 2 then
          Citizen.Wait(2500)
          exports["hrrp-base"]:CallbacksServer("Inventory:UsedParachute", {})
          break
        end
      end
    end)
...
AddEventHandler("Characters:Client:Spawn", function()
  Citizen.Wait(1000)
  exports['hrrp-hud']:RegisterStatus("parachute", 0, 100, "parachute-box", "#A72929", false, false, {
    hideZero = true,
  })
end)
