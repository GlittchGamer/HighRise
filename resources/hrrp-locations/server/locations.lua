AddEventHandler("Proxy:Shared:RegisterReady", function()
  exports["hrrp-base"]:RegisterComponent("Locations", LOCATIONS)
end)
...
setupEvent = AddEventHandler("Core:Shared:Ready", function()
  exports["hrrp-base"]:RequestDependencies("Locations", {
...
function RegisterCallbacks()
  exports['hrrp-base']:CallbacksRegisterServer("Locations:GetAll", function(source, data, cb)
