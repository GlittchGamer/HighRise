...
AddEventHandler("Laptop:Server:RegisterCallbacks", function()
  exports['core']:CallbacksRegisterServer("Laptop:Teams:Get", function(source, data, cb)
    cb(Laptop.Teams:GetAll())
  end)

  exports['core']:CallbacksRegisterServer("Laptop:Teams:GetRequests", function(source, data, cb)
    cb(Laptop.Teams.Requests:Get(source))
  end)

  exports['core']:CallbacksRegisterServer("Laptop:Teams:Create", function(source, data, cb)
    cb(Laptop.Teams:Create(source, data.Name))
  end)

  exports['core']:CallbacksRegisterServer("Laptop:Teams:Delete", function(source, data, cb)
    local char = exports['core']:FetchSource(source):GetData("Character")
    if char then
  ...
  exports['core']:CallbacksRegisterServer("Laptop:Teams:Members:Invite", function(source, data, cb)
    local char = exports['core']:FetchSource(source):GetData("Character")
  ...
  exports['core']:CallbacksRegisterServer("Laptop:Teams:Members:Remove", function(source, data, cb)
    local char = exports['core']:FetchSource(source):GetData("Character")
  ...
  exports['core']:CallbacksRegisterServer("Laptop:Teams:ActionRequest", function(source, data, cb)
    local char = exports['core']:FetchSource(source):GetData("Character")
  ...
  exports['core']:CallbacksRegisterServer("Laptop:Teams:RequestInvite", function(source, data, cb)
    local char = exports['core']:FetchSource(source):GetData("Character")
