AddEventHandler("Laptop:Server:RegisterCallbacks", function()
  ...
  exports['core']:LoggerTrace("Laptop", "[BizWiz] Loaded ^2" .. #fetchBusinessNotices .. "^7 Business Notices", { console = true })
  ...
  exports['core']:CallbacksRegisterServer("Laptop:BizWiz:Notice:Create", function(source, data, cb)
  ...
  exports['core']:CallbacksRegisterServer("Laptop:BizWiz:Notice:Delete", function(source, data, cb)
...
LAPTOP.BizWiz.Notices = {
  Create = function(self, source, job, data)
    ...
    if char then
      ...
      local jobDutyData = exports['jobs']:JobsDutyGetDutyData(job)
