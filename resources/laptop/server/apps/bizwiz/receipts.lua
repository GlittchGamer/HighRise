...
AddEventHandler("Laptop:Server:RegisterCallbacks", function()
  exports['core']:CallbacksRegisterServer("Laptop:BizWiz:Receipt:Search", function(source, data, cb)
  ...
  exports['core']:CallbacksRegisterServer("Laptop:BizWiz:Receipt:Create", function(source, data, cb)
  ...
  exports['core']:CallbacksRegisterServer("Laptop:BizWiz:Receipt:Update", function(source, data, cb)
    local char = exports['core']:FetchSource(source):GetData("Character")
  ...
  exports['core']:CallbacksRegisterServer("Laptop:BizWiz:Receipt:Delete", function(source, data, cb)
    local job = CheckBusinessPermissions(source, 'TABLET_MANAGE_RECEIPT')
    if job then
  ...
  exports['core']:CallbacksRegisterServer("Laptop:BizWiz:Receipt:DeleteAll", function(source, data, cb)
  ...
  exports['core']:CallbacksRegisterServer("Laptop:BizWiz:Receipt:View", function(source, data, cb)
    local job = CheckBusinessPermissions(source)
    if job then
