...
AddEventHandler("Laptop:Server:RegisterCallbacks", function()
  exports['core']:CallbacksRegisterServer("Laptop:BizWiz:Document:Search", function(source, data, cb)
  ...
  exports['core']:CallbacksRegisterServer("Laptop:BizWiz:Document:Create", function(source, data, cb)
  ...
  exports['core']:CallbacksRegisterServer("Laptop:BizWiz:Document:Update", function(source, data, cb)
    local char = exports['core']:FetchSource(source):GetData("Character")
    local job = CheckBusinessPermissions(source, 'TABLET_CREATE_DOCUMENT')
  ...
  exports['core']:CallbacksRegisterServer("Laptop:BizWiz:Document:Delete", function(source, data, cb)
  ...
  exports['core']:CallbacksRegisterServer("Laptop:BizWiz:Document:View", function(source, data, cb)
    local job = CheckBusinessPermissions(source, 'TABLET_VIEW_DOCUMENT')
    if job then
