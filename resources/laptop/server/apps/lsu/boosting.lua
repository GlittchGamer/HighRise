...
AddEventHandler("Laptop:Server:RegisterCallbacks", function()
  exports['core']:CallbacksRegisterServer("Laptop:LSUnderground:Boosting:Admin:CreateContract", function(source, data, cb)
    local char = exports['core']:FetchSource(source):GetData("Character")
  ...
  exports['core']:CallbacksRegisterServer("Laptop:LSUnderground:Boosting:Admin:GetBans", function(source, data, cb)
    local char = exports['core']:FetchSource(source):GetData("Character")
    if char then
      local perm = char:GetData("LaptopPermissions")
      if perm["lsunderground"] and perm["lsunderground"]["admin"] then
  ...
  exports['core']:CallbacksRegisterServer("Laptop:LSUnderground:Boosting:Admin:Ban", function(source, data, cb)
    local char = exports['core']:FetchSource(source):GetData("Character")
    if char and data?.SID then
      ...
      if perm["lsunderground"] and perm["lsunderground"]["admin"] then
        ...
        local targetChar = exports['core']:FetchSID(data.SID)
        if targetChar then
  ...
  exports['core']:CallbacksRegisterServer("Laptop:LSUnderground:Boosting:Admin:Unban", function(source, data, cb)
    local char = exports['core']:FetchSource(source):GetData("Character")
    if char and data?.SID then
      local perm = char:GetData("LaptopPermissions")
  ...
  exports['core']:CallbacksRegisterServer("Laptop:LSUnderground:Boosting:EnterQueue", function(source, data, cb)
    local char = exports['core']:FetchSource(source):GetData("Character")
  ...
  exports['core']:CallbacksRegisterServer("Laptop:LSUnderground:Boosting:ExitQueue", function(source, data, cb)
    local char = exports['core']:FetchSource(source):GetData("Character")
    if char then
      for k, v in ipairs(_boostingQueue) do
        if v.source == source then
  ...
  exports['core']:CallbacksRegisterServer("Laptop:LSUnderground:Boosting:DeclineContract", function(source, data, cb)
    local char = exports['core']:FetchSource(source):GetData("Character")
    if char then
  ...
  exports['core']:CallbacksRegisterServer("Laptop:LSUnderground:Boosting:TransferContract", function(source, data, cb)
    local char = exports['core']:FetchSource(source):GetData("Character")
  ...
  exports['core']:CallbacksRegisterServer("Laptop:LSUnderground:Boosting:AcceptContract", function(source, data, cb)
    local char = exports['core']:FetchSource(source):GetData("Character")
    if char then
      local boostingContracts = char:GetData("BoostingContracts") or {}
      local perm = char:GetData("LaptopPermissions")
  ...
  exports['core']:CallbacksRegisterServer("Laptop:LSUnderground:Boosting:Exterior", function(source, data, cb)
    local char = exports['core']:FetchSource(source):GetData("Character")
    if char then
  ...
  exports['core']:CallbacksRegisterServer("Laptop:LSUnderground:Boosting:Ignition", function(source, data, cb)
    local char = exports['core']:FetchSource(source):GetData("Character")
    if char then
      local team = Laptop.Teams:GetByMemberSource(source)
  ...
  exports['core']:CallbacksRegisterServer("Laptop:LSUnderground:Boosting:DropOff", function(source, data, cb)
    local char = exports['core']:FetchSource(source):GetData("Character")
    if char then
      local team = Laptop.Teams:GetByMemberSource(source)
  ...
  exports['core']:CallbacksRegisterServer("Laptop:LSUnderground:Boosting:LeftArea", function(source, data, cb)
    local char = exports['core']:FetchSource(source):GetData("Character")
    if char then
      local team = Laptop.Teams:GetByMemberSource(source)
  ...
  Inventory.Items:RegisterUse("boosting_tracking_disabler", "Boosting", function(source, slot, itemData)
    ...
    then
      Citizen.SetTimeout(500, function()
        exports['core']:CallbacksClient(source, "Laptop:LSUnderground:Boosting:TrackerHacker", {}, function(using, success)
      ...
      exports['core']:ExecuteClient(source, "Notification", "Error", "Can't Use Right Now...")
    end
  end)
...
LAPTOP.LSUnderground.Boosting = {
  ...
  GiveContract = function(self, source, vehicle, prices, timeLength, settings)
    ...
    if char then
      ...
      exports['core']:LoggerInfo("Boosting",
      ...
      Vehicles:SpawnTemp(source, GetHashKey(contract.vehicle.vehicle), 'automobile', pickUpLocation.coords.xyz,
        pickUpLocation.coords.w, function(spawnedVehicle, VIN, plate)
          if spawnedVehicle then
            ...
            exports['core']:LoggerError("Boosting",
...
function SetupBoostingQueue()
  ...
  Citizen.CreateThread(function()
    ...
    exports['core']:LoggerInfo("Boosting", "Boosting Contracts Can Now Be Rewarded")
    ...
    while true do
      ...
      if #_boostingQueue > 0 then
        ...
        if not chosen then
          exports['core']:LoggerInfo("Boosting", string.format("Nobody Chosen for Boosting Contract (%s | %s)", index, #_boostingQueue))
        end
      end
