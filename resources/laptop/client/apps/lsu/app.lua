...
AddEventHandler("Characters:Client:Spawn", function()
  ...
  exports['pedinteraction']:Add("lsu-pickup-guy", `s_m_y_dockwork_01`, GlobalState.LSUPickupLocation.coords, GlobalState.LSUPickupLocation.heading, 50.0, {
    {
      icon = "box-taped",
      text = "Collect Order",
...
RegisterNUICallback("GetLSUDetails", function(data, cb)
  exports['core']:CallbacksServer("Laptop:LSUnderground:GetDetails", {}, function(data)
    cb(data)
  end)
end)

RegisterNUICallback("LSUNDG:Market:Checkout", function(data, cb)
  exports['core']:CallbacksServer("Laptop:LSUnderground:Market:Checkout", data, function(data)
    cb(data)
...
RegisterNUICallback("Boosting:EnterQueue", function(data, cb)
  exports['core']:CallbacksServer("Laptop:LSUnderground:Boosting:EnterQueue", {}, cb)
end)

RegisterNUICallback("Boosting:ExitQueue", function(data, cb)
  exports['core']:CallbacksServer("Laptop:LSUnderground:Boosting:ExitQueue", {}, cb)
end)

RegisterNUICallback("Boosting:AcceptContract", function(data, cb)
  exports['core']:CallbacksServer("Laptop:LSUnderground:Boosting:AcceptContract", data, function(res)
    if res?.success then
...
RegisterNUICallback("Boosting:TransferContract", function(data, cb)
  exports['core']:CallbacksServer("Laptop:LSUnderground:Boosting:TransferContract", data, cb)
end)

RegisterNUICallback("Boosting:DeclineContract", function(data, cb)
  exports['core']:CallbacksServer("Laptop:LSUnderground:Boosting:DeclineContract", data, cb)
end)

AddEventHandler("Laptop:Client:LSUnderground:Collect", function()
  exports['core']:CallbacksServer("Laptop:LSUnderground:Market:Collect", {})
end)
...
RegisterNUICallback("Boosting:Admin:CreateContract", function(data, cb)
  ...
  exports['core']:CallbacksServer("Laptop:LSUnderground:Boosting:Admin:CreateContract", data, cb)
end)

RegisterNUICallback("Boosting:Admin:GetBans", function(data, cb)
  exports['core']:CallbacksServer("Laptop:LSUnderground:Boosting:Admin:GetBans", data, cb)
end)

RegisterNUICallback("Boosting:Admin:Ban", function(data, cb)
  exports['core']:CallbacksServer("Laptop:LSUnderground:Boosting:Admin:Ban", data, cb)
end)

RegisterNUICallback("Boosting:Admin:Unban", function(data, cb)
  exports['core']:CallbacksServer("Laptop:LSUnderground:Boosting:Admin:Unban", data, cb)
end)
