...
setupEvent = AddEventHandler("Core:Shared:Ready", function()
  exports['core']:RequestDependencies("Vendor", {
    ...
    exports['core']:CallbacksRegisterServer("Vendor:GetItems", function(source, data, cb)
    ...
    exports['core']:CallbacksRegisterServer("Vendor:BuyItem", function(source, data, cb)
      local plyr = exports['core']:FetchSource(source)
      if plyr ~= nil then
        local char = plyr:GetData("Character")
        if char ~= nil then
...
AddEventHandler("Proxy:Shared:RegisterReady", function()
  exports['core']:RegisterComponent("Vendor", _VENDORS)
end)
