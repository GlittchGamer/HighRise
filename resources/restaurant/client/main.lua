...
function Startup()
  exports['ox_target']:TargetingZonesAddBox("burgershot-clockinoff", "chess-clock", vector3(-1189.17, -901.79, 13.97), 2.2, 2, {
    heading = 30,
    --debugPoly=true,
    minZ = 12.37,
    maxZ = 15.77
  ...
  exports['ox_target']:TargetingZonesAddBox("lasttrain-clockinoff", "chess-clock", vector3(-384.8, 268.03, 86.46), 1, 0.8, {
    heading = 305,
    --debugPoly = true,
    minZ = 86.41,
    maxZ = 87.41
  ...
  exports['ox_target']:TargetingZonesAddBox("triad-clockinoff", "chess-clock", vector3(-830.56, -730.64, 28.06), 1, 1, {
    heading = 0,
    --debugPoly=true,
    minZ = 27.06,
    maxZ = 28.66
  ...
  exports['ox_target']:TargetingZonesAddBox("uwu-clockinoff", "chess-clock", vector3(-593.97, -1053.52, 22.34), 0.6, 2.8, {
    heading = 90,
    --debugPoly=true,
    minZ = 21.94,
    maxZ = 23.94
  ...
  exports['ox_target']:TargetingZonesAddBox("pizza_this-clockinoff", "chess-clock", vector3(804.4, -760.87, 31.27), 1, 1, {
    heading = 0,
    --debugPoly=true,
    minZ = 30.27,
    maxZ = 32.07
  ...
  exports['ox_target']:TargetingZonesAddBox("avast_arcade-clockinoff", "chess-clock", vector3(-1659.51, -1061.26, 12.16), 1, 1, {
    name = "duty",
    heading = 46,
    --debugPoly=true,
    minZ = 11.56,
  ...
  exports['ox_target']:TargetingZonesAddBox("bballs-clockinoff", "bowling-ball", vector3(755.73, -775.51, 26.34), 1.0, 0.6, {
    heading = 0,
    --debugPoly=true,
    minZ = 26.34,
    maxZ = 27.14
  ...
  exports['ox_target']:TargetingZonesAddBox("beanmachine-clockinoff", "chess-clock", vector3(126.86, -1035.47, 29.28), 2.0, 0.4, {
    heading = 340,
    --debugPoly=true,
    minZ = 28.48,
    maxZ = 31.48
  ...
  exports['ox_target']:TargetingZonesAddBox("vu-clockinoff", "chess-clock", vector3(133.06, -1286.17, 29.27), 0.9, 0.7, {
    heading = 30,
    --debugPoly=true,
    minZ = 29.07,
    maxZ = 30.07
  ...
  exports['ox_target']:TargetingZonesAddBox("vu-clockinoff2", "chess-clock", vector3(102.0, -1299.66, 28.77), 1, 1, {
    heading = 30,
    --debugPoly=true,
    minZ = 28.37,
    maxZ = 30.77
  ...
  exports['ox_target']:TargetingZonesAddBox("bakery-clockinoff", "chess-clock", vector3(-1264.53, -291.36, 37.39), 0.6, 1, {
    heading = 20,
    --debugPoly=true,
    minZ = 36.39,
    maxZ = 37.99
  ...
  exports['ox_target']:TargetingZonesAddBox("noodle-clockinoff", "chess-clock", vector3(-1185.77, -1149.25, 7.67), 0.8, 2, {
    heading = 15,
    --debugPoly=true,
    minZ = 6.67,
    maxZ = 8.87
  ...
  exports['ox_target']:TargetingZonesAddBox("tequila-clockinoff", "chess-clock", vector3(-562.95, 283.25, 82.18), 1, 1, {
    heading = 0,
    --debugPoly=true,
    minZ = 81.58,
    maxZ = 83.38
  ...
  exports['ox_target']:TargetingZonesAddBox("rockford_records-clockinoff", "chess-clock", vector3(-1004.61, -269.61, 39.04), 1.2, 2.2, {
    heading = 20,
    --debugPoly=true,
    minZ = 38.44,
    maxZ = 40.24
  ...
  exports['ox_target']:TargetingZonesAddBox("rockford_records-clockinoff2", "chess-clock", vector3(-990.76, -279.55, 38.2), 0.8, 3.0, {
    heading = 25,
    --debugPoly=true,
    minZ = 37.6,
    maxZ = 39.4
  ...
  exports['ox_target']:TargetingZonesAddBox("prego-clockinoff", "chess-clock", vector3(-1122.19, -1456.06, 5.11), 0.6, 1.6, {
    heading = 35,
    --debugPoly=true,
    minZ = 4.71,
    maxZ = 6.71
...
RegisterNetEvent("Restaurant:Client:CreatePoly", function(pickups, warmersList, onSpawn)
  for k, v in ipairs(pickups) do
    ...
    if data ~= nil then
      exports['ox_target']:TargetingZonesAddBox(data.id, "fork-knife", data.coords, data.width, data.length, data.options, {
        {
          icon = "fork-knife",
  ...
  for k, v in ipairs(warmersList) do
    for k2, v2 in ipairs(v) do
      ...
      if data ~= nil then
        ...
        exports['ox_target']:TargetingZonesAddBox(data.id, icon, data.coords, data.width, data.length, data.options, {
          {
            icon = icon,
