function OpenStaffMenu(data)
  ...
  if data then
    adminSubMenus = {}
    adminMenu = exports['menu']:Create('adminMenu', 'Staff Menu', function(id, back)
      _menuOpen = true
    end, function()
      _menuOpen = false
      Citizen.Wait(100)
    ...
    if data.playerData then
      ...
      if #data.playerData > 0 then
        ...
        for _, player in ipairs(data.playerData) do
          ...
          -- PUNISH MENU
          adminSubMenus[playerMenuId .. '-punish'] = exports['menu']:Create('adminActivePlayersPunish-' .. player.Source,
