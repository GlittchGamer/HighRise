...
--     _menuOpen = true
--     exports['core']:CallbacksServer('Admin:GetMenuData', {}, function(isAdmin, data)
...
--         if data then
--             adminSubMenus = {}
--             adminMenu = exports['menu']:Create('adminMenu', 'Admin Menu', function(id, back)
--                 _menuOpen = true
--             end, function()
--                 _menuOpen = false
--                 Citizen.Wait(100)
...
--                 adminSubMenus['activePlayers'] = exports['menu']:Create('adminActivePlayers', 'Player Management')
...
--                         adminSubMenus[playerMenuId] = exports['menu']:Create(playerMenuId, string.format('Viewing Player: [%s] %s', player.Source, player.Name))

--                         -- PUNISH MENU
--                         adminSubMenus[playerMenuId.. '-punish'] = exports['menu']:Create('adminActivePlayersPunish-' .. player.Source, string.format('Punish Player: [%s] %s', player.Source, player.Name))
...
--                             exports['core']:CallbacksServer('Admin:PlayerTeleportAction', {
--                                 action = 'GOTO',
--                                 target = player.Source,
--                             }, function(success)
--                                 if success then
--                                     exports['hud']:NotificationSuccess('Successfully Teleported to '.. player.Name)
--                                 else
--                                     exports['hud']:NotificationError('Failed to Teleport to '.. player.Name)
--                                 end
--                             end)
--                         end)
...
--                             }, function(success)
--                                 if success then
--                                     exports['hud']:NotificationSuccess('Successfully Brought '.. player.Name)
--                                 else
--                                     exports['hud']:NotificationError('Failed to Bring '.. player.Name)
--                                 end
--                             end)
--                         end)
...
--                                 AdminStopAttach()
--                             else
--                                 exports['core']:CallbacksServer('Admin:AttachToPlayer', player.Source, function(targetCoords)
...
--                         if player.Character then
--                             adminSubMenus[playerMenuId.. '-phone-perms'] = exports['menu']:Create('adminPhonePerms-' .. player.Source, 'Update Phone Permissions')
...
--                                         exports['core']:CallbacksServer('Admin:UpdatePhonePerms', {
--                                             target = player.Source,
--                                             app = appKey,
--                                             perm = permKey,
...
--             adminSubMenus['recentDisconnects'] = exports['menu']:Create('adminRecentDisconnects', 'Recent Disconnects')
...
--                         adminSubMenus[playerMenuId] = exports['menu']:Create(playerMenuId, string.format('Disconnected Player: [%s] %s', player.Source, player.Name))
...
--             -- Teleportation
--             adminSubMenus['teleportationUtils'] = exports['menu']:Create('adminTeleportUtils', 'Teleport')
--             if data.spawnLocations then
--                 local spawnLocations = exports['menu']:Create('adminSpawnLocations', 'Spawn Locations')
...
--             adminSubMenus['developerUtilities'] = exports['menu']:Create('adminDevUtils', 'Developer Utilities')
...
--                 adminSubMenus['vehicleUtilities'] = exports['menu']:Create('adminVehUtils', 'Vehicle Utilities')
...
--                         exports['hud']:NotificationSuccess('Repaired Vehicle')
--                     end
--                 end)
...
--                         exports['hud']:NotificationSuccess('Repaired Vehicle Fully')
--                     end
--                 end)
