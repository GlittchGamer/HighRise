...
function RegisterCallbacks()
  exports['core']:CallbacksRegisterServer('Admin:GetPlayerList', function(source, data, cb)
  ...
  exports['core']:CallbacksRegisterServer('Admin:GetDisconnectedPlayerList', function(source, data, cb)
    local player = exports['core']:FetchSource(source)
    if player and player.Permissions:IsStaff() then
      local rDs = exports['core']:FetchComponent('RecentDisconnects')
      cb(rDs)
    else
      cb(false)
    end
  ...
  exports['core']:CallbacksRegisterServer('Admin:GetPlayer', function(source, data, cb)
    local player = exports['core']:FetchSource(source)
    if player and player.Permissions:IsStaff() then
  ...
  exports['core']:CallbacksRegisterServer('Admin:BanPlayer', function(source, data, cb)
    local player = exports['core']:FetchSource(source)
  ...
  exports['core']:CallbacksRegisterServer('Admin:KickPlayer', function(source, data, cb)
    local player = exports['core']:FetchSource(source)
  ...
  exports['core']:CallbacksRegisterServer('Admin:ActionPlayer', function(source, data, cb)
    local player = exports['core']:FetchSource(source)
    if player and data.action and data.targetSource and player.Permissions:IsStaff() then
      local target = exports['core']:FetchSource(data.targetSource)
      if target then
        ...
        if targetChar then
          ...
          if data.action == 'bring' and canFuckWith and notMe then
            ...
            exports['pwnzor']:PwnzorPlayersTempPosIgnore(target:GetData("Source"))
          ...
          elseif data.action == 'heal' then
            if (notMe or player.Permissions:IsAdmin()) then
              exports['core']:CallbacksClient(targetChar:GetData("Source"), "Damage:Heal", true)
  ...
  exports['core']:CallbacksRegisterServer('Admin:CurrentVehicleAction', function(source, data, cb)
    local player = exports['core']:FetchSource(source)
  ...
  exports['core']:CallbacksRegisterServer('Admin:NoClip', function(source, data, cb)
    local player = exports['core']:FetchSource(source)
  ...
  exports['core']:CallbacksRegisterServer('Admin:UpdatePhonePerms', function(source, data, cb)
    local player = exports['core']:FetchSource(source)
    if player.Permissions:IsAdmin() then
      local target = exports['core']:FetchSource(data.target)
      if target ~= nil then
        local char = target:GetData("Character")
        if char ~= nil then
  ...
  exports['core']:CallbacksRegisterServer('Admin:ToggleInvisible', function(source, data, cb)
    local player = exports['core']:FetchSource(source)
    if player and player.Permissions:IsAdmin() then
      exports['core']:LoggerWarn(
        "Admin",
