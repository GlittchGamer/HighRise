function HospitalCallbacks()
  ...
  exports['hrrp-base']:CallbacksRegisterServer("Hospital:Treat", function(source, data, cb)
  ...
  exports['hrrp-base']:CallbacksRegisterServer("Hospital:Respawn", function(source, data, cb)
    local char = exports['hrrp-base']:FetchSource(source):GetData("Character")
  ...
  exports['hrrp-base']:CallbacksRegisterServer("Hospital:FindBed", function(source, data, cb)
    cb(Hospital:FindBed(source, data))
  end)

  exports['hrrp-base']:CallbacksRegisterServer("Hospital:OccupyBed", function(source, data, cb)
    cb(Hospital:OccupyBed(source, data))
  end)

  exports['hrrp-base']:CallbacksRegisterServer("Hospital:LeaveBed", function(source, data, cb)
    cb(Hospital:LeaveBed(source))
  end)

  exports['hrrp-base']:CallbacksRegisterServer("Hospital:RetreiveItems", function(source, data, cb)
    Hospital.ICU:GetItems(source)
  end)

  exports['hrrp-base']:CallbacksRegisterServer("Hospital:HiddenRevive", function(source, data, cb)
    local char = exports['hrrp-base']:FetchSource(source):GetData("Character")
    ...
    if p.isEscorting ~= nil then
      ...
      if t ~= nil and t.isDead then
        if Crypto.Exchange:Remove("PLEB", char:GetData("CryptoWallet"), 20) then
          cb(true)
          local tPlyr = exports['hrrp-base']:FetchSource(p.isEscorting)
          if tPlyr ~= nil then
            exports["hrrp-base"]:CallbacksClient(tPlyr:GetData("Source"), "Damage:Heal", true)
          else
  ...
  exports['hrrp-base']:CallbacksRegisterServer("Hospital:SpawnICU", function(source, data, cb)
