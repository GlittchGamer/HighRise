...
setupEvent = AddEventHandler("Core:Shared:Ready", function()
  exports['core']:RequestDependencies("Pwnzor", {
    "Punishment",
    "Callbacks",
    "Logger",
    "Fetch",
      ...
      Citizen.CreateThread(function()
        ...
        while _loaded do
          for k, v in pairs(Fetch:All()) do
            ...
            if mult > 1.0 then
              exports['core']:LoggerWarn("Pwnzor", string.format("%s (%s) Had An Unusual Damage Modifier: %s", v:GetData("Name"), v:GetData("AccountID"), mult))
            end
          end
          Citizen.Wait(60000)
        end
...
AddEventHandler("playerDropped", function()
  exports['pwnzor']:PwnzorPlayersDisconnected(source)
end)
