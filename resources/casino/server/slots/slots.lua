...
AddEventHandler("Casino:Server:Startup", function()
  ...
  exports['core']:CallbacksRegisterServer("Casino:SlotMachineSit", function(source, machineId, cb)
  ...
  exports['core']:CallbacksRegisterServer("Casino:SlotMachinePlay", function(source, data, cb)
    --local char = exports['core']:FetchSource(source):GetData("Character")
  ...
  exports['core']:CallbacksRegisterServer("Casino:SlotMachineLeave", function(source, data, cb)
    local char = exports['core']:FetchSource(source):GetData("Character")
    if not char then
      return cb(false)
    end
