...
AddEventHandler("Casino:Server:Startup", function()
  ...
  exports['core']:CallbacksRegisterServer("Casino:WheelStart", function(source, data, cb)
  ...
  exports['core']:CallbacksRegisterServer("Casino:WheelSpin", function(source, data, cb)
  ...
  exports['core']:CallbacksRegisterServer("Casino:UnlockWheel", function(source, data, cb)
