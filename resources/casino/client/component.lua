...
AddEventHandler("Characters:Client:Spawn", function()
  exports['blips']:Add("casino", "Diamond Casino & Resort", vector3(956.586, 36.004, 71.429), 680, 22, 1.0, 2, 11)
...
AddEventHandler("Casino:Client:Startup", function()
  ...
  exports['pedinteraction']:Add("CasinoStaff1", `u_f_m_casinoshop_01`, vector3(965.357, 48.067, 70.701), 146.416, 25.0, false, "seal-question",
    "WORLD_HUMAN_STAND_IMPATIENT")
  exports['pedinteraction']:Add("CasinoStaff2", `s_m_y_casino_01`, vector3(951.773, 21.896, 70.904), 346.697, 25.0, false, "seal-question",
    "WORLD_HUMAN_GUARD_STAND")

  exports['polyzonehandler']:PolyZoneCreateBox('casino_inside', vector3(1004.77, 38.26, 77.91), 129.2, 90.0, {
    heading = 305,
    --debugPoly=true,
    minZ = 62.71,
    maxZ = 78.11
  ...
  exports['polyzonehandler']:PolyZoneCreatePoly('casino_audio', {
  ...
  exports['pedinteraction']:Add("CasinoCashier", `s_m_y_casino_01`, vector3(990.372, 31.271, 70.466), 56.249, 25.0, {
    {
      icon = "inbox-out",
      text = "Cash Out Chips",
...
AddEventHandler("Casino:Client:OpenClose", function(_, data)
  exports['core']:CallbacksServer("Casino:OpenClose", data)
end)

AddEventHandler("Casino:Client:PurchaseVIP", function(_, data)
  exports['core']:CallbacksServer("Casino:PurchaseVIP", data)
end)
