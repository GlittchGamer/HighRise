...
AddEventHandler("Casino:Client:UseSlotMachine", function()
  ...
  if tableId then
    exports['core']:CallbacksServer("Casino:SlotMachineSit", tableId, function(success)
      if success then
        ...
        exports['hud']:NotificationError("Seat Taken")
      end
    end)
  else
    exports['hud']:NotificationError("Not Close Enough to Machine")
  end
end)
...
AddEventHandler("Casino:Client:PlaySlotMachine", function(_, data)
  if _satInChair then
    ...
    exports['core']:CallbacksServer("Casino:SlotMachinePlay", data, function(success, reelRotations, timeOut, sound, wonAmount)
      if success then
...
AddEventHandler("Casino:Client:LeaveSlotMachine", function()
  if _satInChair then
    exports['core']:CallbacksServer("Casino:SlotMachineLeave", {}, function(success)
      if success then
        InfoOverlay:Close()
