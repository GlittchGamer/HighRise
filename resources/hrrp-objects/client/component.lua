...
setupEvent = AddEventHandler("Core:Shared:Ready", function()
  exports["hrrp-base"]:RequestDependencies("Objects", {
    ...
    exports["hrrp-base"]:CallbacksRegisterClient("Objects:StartPlacement", function(data, cb)
      exports['hrrp-objects']:Start(data.model, "Objects:Client:FinishPlacement", data.data, true)
      cb()
    end)
