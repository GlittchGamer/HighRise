...
setupEvent = AddEventHandler("Core:Shared:Ready", function()
  exports["hrrp-base"]:RequestDependencies("Vendor", {
    ...
    exports['hrrp-base']:CallbacksRegisterServer("Vendor:GetItems", function(source, data, cb)
    ...
    exports['hrrp-base']:CallbacksRegisterServer("Vendor:BuyItem", function(source, data, cb)
      local plyr = exports['hrrp-base']:FetchSource(source)
      if plyr ~= nil then
        local char = plyr:GetData("Character")
        if char ~= nil then
...
AddEventHandler("Proxy:Shared:RegisterReady", function()
  exports["hrrp-base"]:RegisterComponent("Vendor", _VENDORS)
end)
