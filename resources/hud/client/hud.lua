...
setupEvent = AddEventHandler("Core:Shared:Ready", function()
  exports['core']:RequestDependencies("Hud", {
    ...
    exports['keybinds']:Add("show_interaction", "F1", "keyboard", "Hud - Show Interaction Menu", function()
      INTERACTION:Show()
    end)

    -- exports['keybinds']:Add("map_zoom_in", "PageUp", "keyboard", "Minimap - Zoom In", function()
    -- 	Hud.Minimap:In()
    -- end)

    -- exports['keybinds']:Add("map_zoom_out", "PageDown", "keyboard", "Minimap - Zoom Out", function()
    -- 	Hud.Minimap:Out()
    -- end)

    exports['keybinds']:Add("ui_toggle", "F11", "keyboard", "Hud - Toggle HUD", function()
      HUD:Toggle()
    end)

    exports['keybinds']:Add("ids_toggle", "I", "keyboard", "Hud - Toggle IDs", function()
      if not _idsCd then
        HUD.ID:Toggle()
      end
    end)

    exports['core']:CallbacksRegisterClient("HUD:GetTargetInfront", function(data, cb)
    ...
    exports['core']:CallbacksRegisterClient("HUD:PutOnBlindfold", function(data, cb)
      Progress:Progress({
  ...
  DeathTexts = {
    Show = function(self, type, deathTime, timer, keyOverride)
      SendNUIMessage({
        ...
        data = {
          key = exports['keybinds']:GetKey(keyOverride or "secondary_action") or 'Unknown',
          f1Key = exports['keybinds']:GetKey(keyOverride or "show_interaction") or 'Unknown',
          type = type,
          deathTime = deathTime,
          timer = timer,
...
AddEventHandler("Proxy:Shared:RegisterReady", function()
  exports['core']:RegisterComponent("Hud", HUD)
end)
...
function ShowIds()
  ...
  Citizen.CreateThread(function()
    while _showingIds do
      ...
      if exports['admin']:NoClipIsActive() then
        playerCoords = exports['admin']:NoClipGetPos()
      end
