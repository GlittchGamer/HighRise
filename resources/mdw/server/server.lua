...
AddEventHandler("Proxy:Shared:RegisterReady", function()
  exports['core']:RegisterComponent("MDT", _MDT)
end)
...
AddEventHandler('Job:Server:DutyAdd', function(dutyData, source, SID)
  if governmentJobs[dutyData.Id] then
    ...
    if job then
      ...
      local permissions = exports['jobs']:JobsPermissionsGetPermissionsFromJob(source, job.Id)
...
function CheckMDTPermissions(source, permission, jobId)
  ...
  if mdtUser and (not jobId or jobId == mdtUser or (type(jobId) == 'table' and jobId[mdtUser])) then
    ...
    if type(permission) == 'string' then
      local hasPerm = exports['jobs']:JobsPermissionsHasPermissionInJob(source, mdtUser, permission)
      if hasPerm then
        return true, mdtUser
      end
    elseif type(permission) == 'table' then
      local jobPermissions = exports['jobs']:JobsPermissionsGetPermissionsFromJob(source, mdtUser)
...
RegisterNetEvent('MDT:Server:OpenPublicRecords', function()
  local src = source
  local dutyData = exports['jobs']:JobsDutyGet(src)
...
AddEventHandler("MDT:Server:RegisterCallbacks", function()
  exports['core']:CallbacksRegisterServer("MDT:GetHomeData", function(source, data, cb)
  ...
  exports['core']:CallbacksRegisterServer("MDT:IssueWarrant", function(source, data, cb)
    local player = exports['core']:FetchSource(source)
    local char = player:GetData("Character")
  ...
  exports['core']:CallbacksRegisterServer("MDT:SentencePlayer", function(source, data, cb)
    local player = exports['core']:FetchSource(source)
    local char = player:GetData("Character")
    ...
    if CheckMDTPermissions(source, false) and data.report and not data.data.sentenced then
      ...
      if data.data.SID and not sentencedSuspects[data.report][data.data.SID] then
        ...
        if data.sentence.revoke or data.points > 0 then
          ...
          local targetPly = exports['core']:FetchSID(fetchUser.SID)
          if targetPly then
  ...
  exports['core']:CallbacksRegisterServer("MDT:OverturnSentence", function(source, data, cb)
    local player = exports['core']:FetchSource(source)
    local char = player:GetData("Character")
  ...
  exports['core']:CallbacksRegisterServer("MDT:RosterView", function(source, data, cb)
    print(data.job)
    local query = [[
      SELECT
        Mugshot,
  ...
  exports['core']:CallbacksRegisterServer("MDT:FleetDriverFetchOfficers", function(source, data, cb)
  ...
  exports['core']:CallbacksRegisterServer("MDT:RosterSelect", function(source, data, cb)
  ...
  exports['core']:CallbacksRegisterServer("MDT:RevokeLicenseSuspension", function(source, data, cb)
    local player = exports['core']:FetchSource(source)
    local char = player:GetData("Character")
  ...
  exports['core']:CallbacksRegisterServer("MDT:RemoveLicensePoints", function(source, data, cb)
    local player = exports['core']:FetchSource(source)
    local char = player:GetData("Character")
  ...
  exports['core']:CallbacksRegisterServer("MDT:ClearCriminalRecord", function(source, data, cb)
    local player = exports['core']:FetchSource(source)
    local char = player:GetData("Character")
  ...
  exports['core']:CallbacksRegisterServer("MDT:OpenEvidenceLocker", function(source, caseNum, cb)
  ...
  exports['core']:CallbacksRegisterServer("MDT:OpenPersonalLocker", function(source, data, cb)
    local player = exports['core']:FetchSource(source)
    local char = player:GetData("Character")
    if char and (exports['jobs']:JobsPermissionsHasJob(source, 'police') or exports['jobs']:JobsPermissionsHasJob(source, 'ems') or exports['jobs']:JobsPermissionsHasJob(source, 'prison')) then
      cb(true)
  ...
  exports['core']:CallbacksRegisterServer("MDT:DOCGetPrisoners", function(source, data, cb)
    cb(Jail:GetPrisoners())
  end)

  exports['core']:CallbacksRegisterServer("MDT:DOCReduceSentence", function(source, data, cb)
    local player = exports['core']:FetchSource(source)
    local char = player:GetData("Character")
  ...
  local vCooldowns = {}
  exports['core']:CallbacksRegisterServer("MDT:DOCRequestVisitation", function(source, data, cb)
    local player = exports['core']:FetchSource(source)
    local char = player:GetData("Character")
    if char and (vCooldowns[source] == nil or vCooldowns[source] <= os.time()) and data.SID then
      ...
      if target then
        ...
        if jailed and not jailed.Released then
          local dutyData = exports['jobs']:JobsDutyGetDutyData("prison")
