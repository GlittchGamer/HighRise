...
AddEventHandler("MDT:Server:RegisterCallbacks", function()
  exports['core']:CallbacksRegisterServer("MDT:Search:firearm", function(source, data, cb)
  ...
  exports['core']:CallbacksRegisterServer("MDT:View:firearm", function(source, data, cb)
    if CheckMDTPermissions(source, false) then
  ...
  exports['core']:CallbacksRegisterServer("MDT:Create:firearm-flag", function(source, data, cb)
  ...
  exports['core']:CallbacksRegisterServer("MDT:Delete:firearm-flag", function(source, data, cb)
    if CheckMDTPermissions(source, false) then
