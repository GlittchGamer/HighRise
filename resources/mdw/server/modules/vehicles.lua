...
_MDT.Vehicles = {
  ...
  View = function(self, VIN)
    ...
    if fetchVehicle.RegisteredPlate then
      local flagged = exports['radar']:CheckPlate(fetchVehicle.RegisteredPlate)
  ...
  Flags = {
    Add = function(self, VIN, data, plate)
      ...
      if updateFlags > 0 and data.Type and data.Description and plate then
        exports['radar']:AddFlaggedPlate(plate, 'Vehicle Flagged in MDT')
      end
      return true
    end,
    Remove = function(self, VIN, flag, plate, removeRadarFlag)
      ...
      if updateFlags > 0 and plate and removeRadarFlag then
        local isFlagged = exports['radar']:CheckPlate(plate)
...
AddEventHandler("MDT:Server:RegisterCallbacks", function()
  exports['core']:CallbacksRegisterServer("MDT:Search:vehicle", function(source, data, cb)
  ...
  exports['core']:CallbacksRegisterServer("MDT:View:vehicle", function(source, data, cb)
    if CheckMDTPermissions(source, false) then
  ...
  exports['core']:CallbacksRegisterServer("MDT:Create:vehicle-flag", function(source, data, cb)
  ...
  exports['core']:CallbacksRegisterServer("MDT:Delete:vehicle-flag", function(source, data, cb)
    if CheckMDTPermissions(source, false, 'police') then
  ...
  exports['core']:CallbacksRegisterServer("MDT:Update:vehicle-strikes", function(source, data, cb)
    if CheckMDTPermissions(source, false, 'police') then
