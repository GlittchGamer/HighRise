...
_MDT.People = {
  ...
  Update = function(self, requester, id, key, value)
    ...
    if updateCharacter > 0 then
      local target = exports['core']:FetchSID(id)
      if target then
...
AddEventHandler("MDT:Server:RegisterCallbacks", function()
  exports['core']:CallbacksRegisterServer("MDT:InputSearch:people", function(source, data, cb)
    cb(MDT.People.Search:People(data.term))
  end)

  exports['core']:CallbacksRegisterServer("MDT:InputSearch:job", function(source, data, cb)
    cb(_MDT.People.Search:Job(data.job, data.term))
  end)

  exports['core']:CallbacksRegisterServer("MDT:InputSearchSID", function(source, data, cb)
    cb(MDT.People.Search:People(data.term))
  end)

  exports['core']:CallbacksRegisterServer("MDT:Search:people", function(source, data, cb)
    cb(MDT.People.Search:People(data.term))
  end)

  exports['core']:CallbacksRegisterServer("MDT:View:person", function(source, data, cb)
    cb(MDT.People:View(data, true))
  end)

  exports['core']:CallbacksRegisterServer("MDT:Update:person", function(source, data, cb)
  ...
  exports['core']:CallbacksRegisterServer("MDT:CheckCallsign", function(source, data, cb)
