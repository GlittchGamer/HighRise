...
AddEventHandler("MDT:Server:RegisterCallbacks", function()
  exports['core']:CallbacksRegisterServer("MDT:Create:BOLO", function(source, data, cb)
  ...
  exports['core']:CallbacksRegisterServer("MDT:Delete:BOLO", function(source, data, cb)
    if CheckMDTPermissions(source, false, 'police') then
  ...
  exports['core']:CallbacksRegisterServer("MDT:Create:charge", function(source, data, cb)
  ...
  exports['core']:CallbacksRegisterServer("MDT:Update:charge", function(source, data, cb)
    if CheckMDTPermissions(source, true) then
  ...
  exports['core']:CallbacksRegisterServer("MDT:Delete:charge", function(source, data, cb)
    if CheckMDTPermissions(source, true) then
  ...
  exports['core']:CallbacksRegisterServer("MDT:Create:notice", function(source, data, cb)
    local char = exports['core']:FetchSource(source)
  ...
  exports['core']:CallbacksRegisterServer("MDT:View:notice", function(source, data, cb)
    cb(MDT.Misc.View:Notice(data))
  end)

  exports['core']:CallbacksRegisterServer("MDT:Delete:notice", function(source, data, cb)
