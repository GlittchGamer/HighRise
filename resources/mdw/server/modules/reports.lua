...
AddEventHandler("MDT:Server:RegisterCallbacks", function()
  exports['core']:CallbacksRegisterServer("MDT:Search:report", function(source, data, cb)
  ...
  exports['core']:CallbacksRegisterServer("MDT:Search:report-evidence", function(source, data, cb)
  ...
  exports['core']:CallbacksRegisterServer("MDT:Create:report", function(source, data, cb)
    local char = exports['core']:FetchSource(source):GetData("Character")
    if CheckMDTPermissions(source, false) then
      data.doc.author = {
  ...
  exports['core']:CallbacksRegisterServer("MDT:Update:report", function(source, data, cb)
    local char = exports['core']:FetchSource(source):GetData("Character")
  ...
  exports['core']:CallbacksRegisterServer("MDT:Delete:report", function(source, data, cb)
  ...
  exports['core']:CallbacksRegisterServer("MDT:View:report", function(source, data, cb)
    local char = exports['core']:FetchSource(source):GetData("Character")
