...
AddEventHandler("MDT:Server:RegisterCallbacks", function()
  exports['core']:CallbacksRegisterServer("MDT:Search:warrant", function(source, data, cb)
    cb(MDT.Warrants:Search(data.term, data.page, data.perPage))
  end)

  exports['core']:CallbacksRegisterServer("MDT:View:warrant", function(source, data, cb)
    cb(MDT.Warrants:View(data))
  end)

  exports['core']:CallbacksRegisterServer("MDT:Update:warrant", function(source, data, cb)
