...
AddEventHandler("Proxy:Shared:RegisterReady", function()
  exports['core']:RegisterComponent("EmergencyAlerts", _pdAlerts)
end)
...
_pdAlerts = {
  ...
  OnDuty = function(self, dutyData, source, stateId, callsign)
    ...
    then
      ...
      local allJobPermissions = exports['jobs']:JobsPermissionsGetPermissionsFromJob(source, dutyData.Id)
      ...
      local token = exports["ws"]:generateSocketToken("mdt-alerts", {
        source = source,
        job = dutyData.Id,
  ...
  GetUnitData = function(self, source, job)
    ...
    if char then
      local alertPermissions = {}
      local allJobPermissions = exports['jobs']:JobsPermissionsGetPermissionsFromJob(source, job)
