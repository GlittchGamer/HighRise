...
export default () => {
	...
	const [settingsState, setSettingsState] = useState(
		JSON.parse(localStorage.getItem('dispatchLog_settings')) ?? defaultSettings,
	);
		...
		<div className={classes.dispatchContainer}>
			...
			>
				...
				>
					...
					{pauseScroll && (
						<div className={classes.scroller} onClick={scrollBottom}>
							Resume Scroll
						</div>
					)}
				</div>
			...
			<div className={classes.title} onClick={toggleLog}>
				...
				{expanded && (
					<IconButton
						size="small"
						style={{ position: 'absolute', bottom: 0, marginBottom: 10, marginRight: 10 }}
