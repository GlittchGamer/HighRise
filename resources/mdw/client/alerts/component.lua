...
setupEvent = AddEventHandler("Core:Shared:Ready", function()
  exports['core']:RequestDependencies("MDT", {
    ...
    RegisterCallbacks()
    exports['keybinds']:Add("emergency_alerts_toggle", "GRAVE", "keyboard", "Police - Toggle Alerts Panel", function()
...
function RegisterCallbacks()
  exports['core']:CallbacksRegisterClient("EmergencyAlerts:GetStreetName", function(data, cb)
