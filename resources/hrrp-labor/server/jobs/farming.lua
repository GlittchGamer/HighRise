...
AddEventHandler("Labor:Server:Startup", function()
  exports['hrrp-base']:CallbacksRegisterServer("Farming:StartJob", function(source, data, cb)
  ...
  exports['hrrp-base']:CallbacksRegisterServer("Farming:CompleteNode", function(source, data, cb)
  ...
  exports['hrrp-base']:CallbacksRegisterServer("Farming:TurnIn", function(source, data, cb)
    local char = exports['hrrp-base']:FetchSource(source):GetData("Character")
    if char:GetData("TempJob") == _JOB and _joiners[source] ~= nil and _farming[_joiners[source]] ~= nil then
