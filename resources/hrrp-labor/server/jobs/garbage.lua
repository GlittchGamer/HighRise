...
AddEventHandler("Labor:Server:Startup", function()
  exports['hrrp-base']:CallbacksRegisterServer("Garbage:StartJob", function(source, data, cb)
  ...
  exports['hrrp-base']:CallbacksRegisterServer("Garbage:GarbageSpawn", function(source, data, cb)
  ...
  exports['hrrp-base']:CallbacksRegisterServer("Garbage:GarbageSpawnRemove", function(source, data, cb)
  ...
  exports['hrrp-base']:CallbacksRegisterServer("Garbage:TrashGrab", function(source, data, cb)
    if _joiners[source] ~= nil then
      exports["hrrp-base"]:CallbacksClient(source, "Garbage:DoingSomeAction", "grabTrash")
  ...
  exports['hrrp-base']:CallbacksRegisterServer("Garbage:TrashPutIn", function(source, data, cb)
    ...
    if char:GetData("TempJob") == _JOB and _joiners[source] ~= nil and _Garbage[_joiners[source]] ~= nil then
      ...
      exports["hrrp-base"]:CallbacksClient(source, "Garbage:DoingSomeAction", "trashPutIn")
  ...
  exports['hrrp-base']:CallbacksRegisterServer("Garbage:TurnIn", function(source, data, cb)
  ...
  exports['hrrp-base']:CallbacksRegisterServer("Garbage:Pawn:Sell", function(source, data, cb)
    local char = exports['hrrp-base']:FetchSource(source):GetData("Character")
    ...
    if repLvl > 0 then
      ...
      if money > 0 then
        ...
        exports['hrrp-base']:ExecuteClient(source, "Notification", "Error", "You Have Nothing To Sell")
      end
    else
      exports['hrrp-base']:ExecuteClient(source, "Notification", "Error", "You're Not Trusted Enough To Do This Yet")
    end
  end)

  -- exports['hrrp-base']:CallbacksRegisterServer("Gabage:Pawn:Buy", function(source, data, cb)
  -- 	local char = exports['hrrp-base']:FetchSource(source):GetData("Character")
  -- 	local repLvl = Reputation:GetLevel(source, _JOB)
  ...
  -- exports['hrrp-base']:CallbacksRegisterServer("Garbage:Pawn:BuyLimited", function(source, data, cb)
  -- 	local char = exports['hrrp-base']:FetchSource(source):GetData("Character")
  -- 	local repLvl = Reputation:GetLevel(source, _JOB)
  ...
  -- 			else
  -- 				exports['hrrp-base']:ExecuteClient(source, "Notification", "Error", "Not Enough Crypto")
  -- 			end
  -- 		else
  -- 			exports['hrrp-base']:ExecuteClient(source, "Notification", "Error", "Item Not In Stock")
  -- 		end
  -- 	else
  -- 		exports['hrrp-base']:ExecuteClient(source, "Notification", "Error", "You're Not Trusted Enough To Do This Yet")
  -- 	end
