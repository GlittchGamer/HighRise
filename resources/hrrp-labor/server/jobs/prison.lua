...
AddEventHandler("Labor:Server:Startup", function()
  ...
  exports['hrrp-base']:CallbacksRegisterServer("Prison:Action", function(source, data, cb)
  ...
  exports['hrrp-base']:CallbacksRegisterServer("Prison:TurnIn", function(source, data, cb)
