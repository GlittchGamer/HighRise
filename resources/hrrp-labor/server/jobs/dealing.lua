...
AddEventHandler("Labor:Server:Startup", function()
  ...
  exports['hrrp-base']:CallbacksRegisterServer("CornerDealing:Enable", function(source, data, cb)
  ...
  exports['hrrp-base']:CallbacksRegisterServer("CornerDealing:Disable", function(source, data, cb)
    local char = exports['hrrp-base']:FetchSource(source):GetData("Character")
    local states = char:GetData("States") or {}
  ...
  exports['hrrp-base']:CallbacksRegisterServer("CornerDealing:SyncPed", function(source, data, cb)
  ...
  exports['hrrp-base']:CallbacksRegisterServer("CornerDealing:SyncEvent", function(source, data, cb)
    if _joiners[source] ~= nil then
      local plyr = exports['hrrp-base']:FetchSource(source)
      if plyr ~= nil then
        local char = plyr:GetData("Character")
  ...
  exports['hrrp-base']:CallbacksRegisterServer("CornerDealing:CheckCorner", function(source, data, cb)
    if _joiners[source] ~= nil then
      local plyr = exports['hrrp-base']:FetchSource(source)
      if plyr ~= nil then
        local char = plyr:GetData("Character")
        if char ~= nil then
          for k, v in ipairs(_cornerCds) do
            if os.time() < v.expires and #(data.coords - v.coords) < 100.0 then
              exports['hrrp-base']:ExecuteClient(source, "Notification", "Error", "Someone Has Recently Sold Around Here")
              return cb(false)
            end
          end
  ...
  exports['hrrp-base']:CallbacksRegisterServer("CornerDealing:StartCornering", function(source, data, cb)
    if _joiners[source] ~= nil then
      local plyr = exports['hrrp-base']:FetchSource(source)
      if plyr ~= nil then
        local char = plyr:GetData("Character")
  ...
  exports['hrrp-base']:CallbacksRegisterServer("CornerDealing:StopCornering", function(source, data, cb)
    if _joiners[source] ~= nil then
      Labor.Offers:Fail(_joiners[source], _JOB)
    end
  end)

  exports['hrrp-base']:CallbacksRegisterServer("CornerDealing:GetSaleMenu", function(source, data, cb)
    if _joiners[source] ~= nil then
      local plyr = exports['hrrp-base']:FetchSource(source)
      if plyr ~= nil then
        local char = plyr:GetData("Character")
  ...
  exports['hrrp-base']:CallbacksRegisterServer("CornerDealing:DoSale", function(source, data, cb)
    if _joiners[source] ~= nil then
      local plyr = exports['hrrp-base']:FetchSource(source)
      if plyr ~= nil then
        local char = plyr:GetData("Character")
  ...
  exports['hrrp-base']:CallbacksRegisterServer("CornerDealing:NoPeds", function(source, data, cb)
  ...
  -- exports['hrrp-base']:CallbacksRegisterServer("CornerDealing:PedDied", function(source, data, cb)
  -- 	if _joiners[source] ~= nil then
  -- 		local plyr = exports['hrrp-base']:FetchSource(source)
  -- 		if plyr ~= nil then
  -- 			local char = plyr:GetData("Character")
  ...
  exports['hrrp-base']:CallbacksRegisterServer("CornerDealing:DestroyVehicle", function(source, data, cb)
    if _joiners[source] ~= nil then
      local plyr = exports['hrrp-base']:FetchSource(source)
      if plyr ~= nil then
        local char = plyr:GetData("Character")
  ...
  exports['hrrp-base']:CallbacksRegisterServer("CornerDealing:PedTimeout", function(source, data, cb)
    if _joiners[source] ~= nil then
      local plyr = exports['hrrp-base']:FetchSource(source)
      if plyr ~= nil then
        local char = plyr:GetData("Character")
  ...
  exports['hrrp-base']:CallbacksRegisterServer("CornerDealing:LeaveArea", function(source, data, cb)
    if _joiners[source] ~= nil then
      local plyr = exports['hrrp-base']:FetchSource(source)
      if plyr ~= nil then
        local char = plyr:GetData("Character")
