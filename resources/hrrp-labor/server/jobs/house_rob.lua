...
AddEventHandler("Labor:Server:Startup", function()
  ...
  exports['hrrp-base']:CallbacksRegisterServer("HouseRobbery:Enable", function(source, data, cb)
    local char = exports['hrrp-base']:FetchSource(source):GetData("Character")
  ...
  exports['hrrp-base']:CallbacksRegisterServer("HouseRobbery:Disable", function(source, data, cb)
    local char = exports['hrrp-base']:FetchSource(source):GetData("Character")
    local states = char:GetData("States") or {}
  ...
  exports['hrrp-base']:CallbacksRegisterServer("HouseRobbery:ArrivedNear", function(source, data, cb)
  ...
  exports['hrrp-base']:CallbacksRegisterServer("HouseRobbery:BreakIn", function(source, data, cb)
  ...
  exports['hrrp-base']:CallbacksRegisterServer("HouseRobbery:Exit", function(source, data, cb)
    exports['hrrp-pwnzor']:PwnzorPlayersTempPosIgnore(source)
    local intr = nil
  ...
  exports['hrrp-base']:CallbacksRegisterServer("HouseRobbery:HackAlarm", function(source, data, cb)
    if
        _joiners[source] ~= nil
        and _robbers[_joiners[source]] ~= nil
  ...
  exports['hrrp-base']:CallbacksRegisterServer("HouseRobbery:Search", function(source, data, cb)
    local char = exports['hrrp-base']:FetchSource(source):GetData("Character")
    if
        char:GetData("TempJob") == _JOB
        and _joiners[source] ~= nil
...
AddEventHandler("HouseRobbery:Server:OnDuty", function(joiner, members, isWorkgroup)
  ...
  elseif isWorkgroup then
    if #members > 0 then
      for k, v in ipairs(members) do
        local gChar = exports['hrrp-base']:FetchSource(v.ID):GetData("Character")
