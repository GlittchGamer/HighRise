...
AddEventHandler("Labor:Server:Startup", function()
  ...
  exports['hrrp-base']:CallbacksRegisterServer("OxyRun:Enable", function(source, data, cb)
    local char = exports['hrrp-base']:FetchSource(source):GetData("Character")
  ...
  exports['hrrp-base']:CallbacksRegisterServer("OxyRun:Disable", function(source, data, cb)
    local char = exports['hrrp-base']:FetchSource(source):GetData("Character")
    local states = char:GetData("States") or {}
  ...
  exports['hrrp-base']:CallbacksRegisterServer("OxyRun:EnteredCar", function(source, data, cb)
    local char = exports['hrrp-base']:FetchSource(source):GetData("Character")
    if
        char:GetData("TempJob") == _JOB
        and _joiners[source] ~= nil
            ...
            while _sellers[_joiners[source]] ~= nil do
              if not ending then
                if ent ~= nil and not DoesEntityExist(ent) then
                  exports['hrrp-base']:LoggerTrace("OxyRun", "Vehicle No Longer Exists")
                  ending = true
  ...
  exports['hrrp-base']:CallbacksRegisterServer("OxyRun:EnteredPickup", function(source, data, cb)
    local char = exports['hrrp-base']:FetchSource(source):GetData("Character")
    if
        char:GetData("TempJob") == _JOB
        and _joiners[source] ~= nil
  ...
  exports['hrrp-base']:CallbacksRegisterServer("OxyRun:CancelPickup", function(source, data, cb)
    local char = exports['hrrp-base']:FetchSource(source):GetData("Character")
  ...
  exports['hrrp-base']:CallbacksRegisterServer("OxyRun:CheckPickup", function(source, data, cb)
    local char = exports['hrrp-base']:FetchSource(source):GetData("Character")
    if
        char:GetData("TempJob") == _JOB
        and _joiners[source] ~= nil
  ...
  exports['hrrp-base']:CallbacksRegisterServer("OxyRun:PickupProduct", function(source, data, cb)
    local char = exports['hrrp-base']:FetchSource(source):GetData("Character")
  ...
  exports['hrrp-base']:CallbacksRegisterServer("OxyRun:EnteredArea", function(source, data, cb)
    local char = exports['hrrp-base']:FetchSource(source):GetData("Character")
    if
        char:GetData("TempJob") == _JOB
        and _joiners[source] ~= nil
      ...
      Citizen.CreateThread(function()
        ...
        do
          if not _sellers[_joiners[source]].pending then
            ...
            exports["hrrp-base"]:CallbacksClient(_joiners[source], "OxyRun:GetSpawn", {
  ...
  exports['hrrp-base']:CallbacksRegisterServer("OxyRun:DeleteShit", function(source, data, cb)
  ...
  exports['hrrp-base']:CallbacksRegisterServer("OxyRun:SellProduct", function(source, data, cb)
    local char = exports['hrrp-base']:FetchSource(source):GetData("Character")
    if
        char:GetData("TempJob") == _JOB
        and _joiners[source] ~= nil
  ...
  exports['hrrp-base']:CallbacksRegisterServer("OxyRun:DestroyVehicle", function(source, data, cb)
    local char = exports['hrrp-base']:FetchSource(source):GetData("Character")
    if char:GetData("TempJob") == _JOB and _joiners[source] ~= nil and _sellers[_joiners[source]] ~= nil then
  ...
  exports['hrrp-base']:CallbacksRegisterServer("OxyRun:VehiclePoofed", function(source, data, cb)
    local char = exports['hrrp-base']:FetchSource(source):GetData("Character")
    if char:GetData("TempJob") == _JOB and _joiners[source] ~= nil and _sellers[_joiners[source]] ~= nil then
      if _sellers[_joiners[source]].state == 6 then
        _sellers[_joiners[source]].state = 7
  ...
  exports['hrrp-base']:CallbacksRegisterServer("OxyRun:LeftZone", function(source, data, cb)
    local char = exports['hrrp-base']:FetchSource(source):GetData("Character")
    if
        char:GetData("TempJob") == _JOB
        and _joiners[source] ~= nil
...
AddEventHandler('entityRemoved', function(entity)
  if GetEntityType(entity) == 2 then
    ...
    if ent?.state?.oxyBuying and _sellers[ent?.state?.oxyBuying]?.pending then
      exports['hrrp-base']:LoggerWarn("Vehicles", string.format("Oxy Vehicle For %s Deleted Unexpectedly, Clearing To Spawn New Vehicle", ent?.state?.oxyBuying))
...
AddEventHandler("OxyRun:Server:OnDuty", function(joiner, members, isWorkgroup)
  ...
  local plyr = exports['hrrp-base']:FetchSource(joiner)
  local char = plyr:GetData("Character")
  if char == nil then
    Labor.Offers:Cancel(joiner, _JOB)
    Labor.Duty:Off(_JOB, joiner, false, true)
...
function Cleanup(src)
  ...
  if _sellers[joiner] ~= nil then
    if _sellers[joiner].isWorkgroup then
      if #_sellers[joiner].members > 0 then
        for k, v in ipairs(_sellers[joiner].members) do
          local mPlyr = exports['hrrp-base']:FetchSource(v.ID)
          if mPlyr ~= nil then
    ...
    local jPlyr = exports['hrrp-base']:FetchSource(joiner)
    if jPlyr ~= nil then
