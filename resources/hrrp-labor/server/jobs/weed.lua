...
AddEventHandler("Labor:Server:Startup", function()
  ...
  exports['hrrp-base']:CallbacksRegisterServer("WeedRun:Enable", function(source, data, cb)
  ...
  exports['hrrp-base']:CallbacksRegisterServer("WeedRun:Disable", function(source, data, cb)
    local char = exports['hrrp-base']:FetchSource(source):GetData("Character")
    local states = char:GetData("States") or {}
  ...
  exports['hrrp-base']:CallbacksRegisterServer("WeedRun:StartDropoff", function(source, data, cb)
  ...
  exports['hrrp-base']:CallbacksRegisterServer("WeedRun:DoDropoff", function(source, data, cb)
    if _joiners[source] ~= nil then
