...
AddEventHandler("Labor:Client:Setup", function()
  exports['hrrp-pedinteraction']:Add("DeliveryJob", GetHashKey("s_m_y_ammucity_01"), vector3(919.87, -1256.43, 24.52), 34.85, 25.0, {
    {
      icon = "person",
      text = "Interact",
  ...
  exports["hrrp-base"]:CallbacksRegisterClient("Deliveries:DoingSomeAction", function(item, cb)
...
RegisterNetEvent("Deliveries:Client:OnDuty", function(joiner, time)
  ...
  _blip = exports['hrrp-blips']:Add("DeliveriesStart", "Deliveries Foreman", { x = 918.01, y = -1255.28, z = 0 }, 478, 3, 1.4)
  ...
  eventHandlers["new-route"] = RegisterNetEvent(string.format("Deliveries:Client:%s:NewRoute", joiner), function(r)
    ...
    if _blip ~= nil then
      exports['hrrp-blips']:Remove("DeliveriesStart")
      RemoveBlip(_blip)
      _blip = nil
    end

    _blip = exports['hrrp-blips']:Add("DeliveriesStart", "Delivery Location", { x = _route.coords.x, y = _route.coords.y, z = _route.coords.z }, 478, 3, 1.4)
  ...
  eventHandlers["deliveries-drop"] = AddEventHandler("Deliveries:Client:DeliverPackage", function(entity, data)
    ...
    exports["hrrp-base"]:CallbacksServer("Deliveries:DeliverPackage", {}, function(s)
      if s then
  ...
  eventHandlers["deliveries-grab"] = AddEventHandler("Deliveries:Client:Grab", function()
    exports["hrrp-base"]:CallbacksServer("Deliveries:PackageGrab", {}, function(s)
      if s then
  ...
  eventHandlers["spawn-truck"] = AddEventHandler("Deliveries:Client:DeliveriesSpawn", function()
    exports["hrrp-base"]:CallbacksServer("Deliveries:DeliveriesSpawn", {}, function(netId)
  ...
  eventHandlers["despawn-truck"] = AddEventHandler("Deliveries:Client:DeliveriesSpawnRemove", function()
    exports["hrrp-base"]:CallbacksServer("Deliveries:DeliveriesSpawnRemove", {})
  end)
  ...
  eventHandlers["turn-in"] = AddEventHandler("Deliveries:Client:TurnIn", function()
    exports["hrrp-base"]:CallbacksServer("Deliveries:TurnIn", _joiner)
  end)
end)

AddEventHandler("Deliveries:Client:StartJob", function()
  exports["hrrp-base"]:CallbacksServer("Deliveries:StartJob", _joiner, function(state)
    if not state then
