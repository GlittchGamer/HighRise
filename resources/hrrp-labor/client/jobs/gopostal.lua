...
AddEventHandler("Labor:Client:Setup", function()
  exports['hrrp-pedinteraction']:Add("GoPostalJob", GetHashKey("s_m_y_construct_01"), vector3(919.87, -1256.43, 24.52), 34.85, 25.0, {
    {
      icon = "person",
      text = "Interact",
  ...
  exports["hrrp-base"]:CallbacksRegisterClient("GoPostal:DoingSomeAction", function(item, cb)
...
RegisterNetEvent("GoPostal:Client:OnDuty", function(joiner, time)
  ...
  _blip = exports['hrrp-blips']:Add("GoPostalStart", "GoPostal Boss", { x = 918.01, y = -1255.28, z = 0 }, 478, 3, 1.4)
  ...
  eventHandlers["new-route"] = RegisterNetEvent(string.format("GoPostal:Client:%s:NewRoute", joiner), function(r)
    ...
    if _blip ~= nil then
      exports['hrrp-blips']:Remove("GoPostalStart")
      RemoveBlip(_blip)
      _blip = nil
    end

    _blip = exports['hrrp-blips']:Add("GoPostalStart", "Delivery Location", { x = _route.coords.x, y = _route.coords.y, z = _route.coords.z }, 478, 3, 1.4)
  ...
  eventHandlers["GoPostal-drop"] = AddEventHandler("GoPostal:Client:DeliverPackage", function(entity, data)
    ...
    exports["hrrp-base"]:CallbacksServer("GoPostal:DeliverPackage", {}, function(s)
      if s then
  ...
  eventHandlers["GoPostal-grab"] = AddEventHandler("GoPostal:Client:Grab", function()
    exports["hrrp-base"]:CallbacksServer("GoPostal:PackageGrab", {}, function(s)
      if s then
  ...
  eventHandlers["spawn-truck"] = AddEventHandler("GoPostal:Client:GoPostalSpawn", function()
    exports["hrrp-base"]:CallbacksServer("GoPostal:GoPostalSpawn", {}, function(netId)
  ...
  eventHandlers["despawn-truck"] = AddEventHandler("GoPostal:Client:GoPostalSpawnRemove", function()
    exports["hrrp-base"]:CallbacksServer("GoPostal:GoPostalSpawnRemove", {})
  end)
  ...
  eventHandlers["turn-in"] = AddEventHandler("GoPostal:Client:TurnIn", function()
    exports["hrrp-base"]:CallbacksServer("GoPostal:TurnIn", _joiner)
  end)
end)

AddEventHandler("GoPostal:Client:StartJob", function()
  exports["hrrp-base"]:CallbacksServer("GoPostal:StartJob", _joiner, function(state)
    if not state then
