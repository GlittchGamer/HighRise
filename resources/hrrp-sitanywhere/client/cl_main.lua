...
setupEvent = AddEventHandler("Core:Shared:Ready", function()
  exports['hrrp-base']:RequestDependencies('SitAny', {
    'Action',
    'Logger',
    'Notification',
    'Interaction'
    ...
    Interaction:RegisterMenu("sitanywhere", 'Sit Down', "chair", function()
      ...
      if not animToUse then
        exports['hrrp-hud']:NotificationError("No animation found.")
        return
      end
...
local function StartSittingThread()
  sitting = true
  exports['hrrp-hud']:ActionShow("Press [Q] to cancel")
...
function PlacingThread(animData)
  if ClonedPed == nil then
    ...
    exports['hrrp-hud']:ActionShow(table.concat(txt))
    CreateThread(function()
      ...
      while ClonedPed ~= nil do
        ...
        if IsControlJustPressed(0, 38) then
          if #(GetEntityCoords(PlayerPedId()) - currentCoords) < 5.0 then
            ...
            exports['hrrp-hud']:NotificationError("You are too far")
          end
        end
