function RegisterCallbacks()
  exports['core']:CallbacksRegisterServer('Racing:Server:SaveRace', function(src, data, cb)
  ...
  exports['core']:CallbacksRegisterServer('Racing:Server:DeleteRace', function(src, data, cb)
    local char = exports['core']:FetchSource(src):GetData("Character")
    local alias = char:GetData("Alias").redline
    local isPDTrack = false
    if data.raceVariant == 'blueline' then
  ...
  exports['core']:CallbacksRegisterServer('Racing:Server:CreateRace', function(src, data, cb)
    local char = exports['core']:FetchSource(src):GetData("Character")
    local alias = char:GetData("Alias").redline
    if data.isPD then
      alias = tostring(char:GetData("Callsign"))
    ...
    if data.isPD then
      hasPermission = exports['jobs']:JobsPermissionsHasJob(src, "police", false, false, false, false, "PD_MANAGE_TRIALS")
    else
    ...
    -- for k, v in pairs(exports['core']:FetchAll()) do
  ...
  exports['core']:CallbacksRegisterServer('Racing:Server:CancelRace', function(src, data, cb)
    local char = exports['core']:FetchSource(src):GetData("Character")
  ...
  exports['core']:CallbacksRegisterServer('Racing:Server:StartRace', function(src, data, cb)
    local char = exports['core']:FetchSource(src):GetData("Character")
  ...
  exports['core']:CallbacksRegisterServer('Racing:Server:EndRace', function(src, data, cb)
    local char = exports['core']:FetchSource(src):GetData("Character")
  ...
  exports['core']:CallbacksRegisterServer('Racing:Server:JoinRace', function(src, data, cb)
    local char = exports['core']:FetchSource(src):GetData("Character")
    ...
    if raceData.isPD then
      alias = tostring(char:GetData("Callsign"))
      hasPermissionToJoinRace = exports['jobs']:JobsPermissionsHasJob(src, "police")
    end
  ...
  exports['core']:CallbacksRegisterServer('Racing:Server:LeaveRace', function(src, data, cb)
    local char = exports['core']:FetchSource(src):GetData("Character")
    local alias = char:GetData("Alias").redline
    if data.isPD then
      alias = tostring(char:GetData("Callsign"))
