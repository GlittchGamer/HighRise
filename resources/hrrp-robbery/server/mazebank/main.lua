...
AddEventHandler("Robbery:Server:Setup", function()
  ...
  exports['hrrp-base']:CallbacksRegisterServer("Robbery:MazeBank:SecureBank", function(source, data, cb)
  ...
  exports['hrrp-base']:CallbacksRegisterServer("Robbery:MazeBank:ElectricBox:Hack", function(source, data, cb)
    local plyr = exports['hrrp-base']:FetchSource(source)
    if plyr ~= nil then
      local char = plyr:GetData("Character")
      if char ~= nil then
  ...
  exports['hrrp-base']:CallbacksRegisterServer("Robbery:MazeBank:ElectricBox:Thermite", function(source, data, cb)
    local plyr = exports['hrrp-base']:FetchSource(source)
    if plyr ~= nil then
      local char = plyr:GetData("Character")
      if char ~= nil then
  ...
  exports['hrrp-base']:CallbacksRegisterServer("Robbery:MazeBank:Drill", function(source, data, cb)
    local plyr = exports['hrrp-base']:FetchSource(source)
    if plyr ~= nil then
      local char = plyr:GetData("Character")
      if char ~= nil then
  ...
  exports['hrrp-base']:CallbacksRegisterServer("Robbery:MazeBank:PC:Hack", function(source, data, cb)
    local plyr = exports['hrrp-base']:FetchSource(source)
    if plyr ~= nil then
      local char = plyr:GetData("Character")
      if char ~= nil then
          ...
          if not _mbInUse.officePcs[data.id] then
            ...
            if Inventory.Items:Has(char:GetData("SID"), 1, "adv_electronics_kit", 1) then
              ...
              if itemData ~= nil then
                ...
                exports["hrrp-base"]:CallbacksClient(source, "Robbery:Games:Progress", {
                  config = {
