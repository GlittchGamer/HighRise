...
AddEventHandler("Robbery:Server:Setup", function()
    ...
    then
      ...
      if not _bcInUse.extrDoor then
        ...
        if Inventory.Items:RemoveSlot(itemData.Owner, itemData.Name, 1, itemData.Slot, itemData.invType) then
          exports['hrrp-base']:LoggerInfo("Robbery",
            string.format("%s %s (%s) Started Thermiting Bobcat Exterior Door", char:GetData("First"), char:GetData("Last"), char:GetData("SID")))
          exports["hrrp-base"]:CallbacksClient(source, "Robbery:Games:Thermite", {
            passes = 1,
            ...
            if success then
              exports['hrrp-base']:LoggerInfo("Robbery",
                string.format("%s %s (%s) Successfully Thermited Bobcat Exterior Door", char:GetData("First"), char:GetData("Last"), char:GetData("SID")))
              ...
              exports['hrrp-doors']:SetLock("bobcat_extr", false)
              ...
              exports['hrrp-base']:LoggerInfo("Robbery",
                string.format("%s %s (%s) Failed Thermiting Bobcat Exterior Door", char:GetData("First"), char:GetData("Last"), char:GetData("SID")))
            end
            _bcInUse.extrDoor = false
          end)
        end
      else
        exports['hrrp-base']:ExecuteClient(source, "Notification", "Error", "Someone Is Already Doing This", 6000)
      end
    else
      if pState.inBobcat then
        ...
        then
          ...
          if not _bcInUse.frontDoor then
            ...
            if Inventory.Items:RemoveSlot(itemData.Owner, itemData.Name, 1, itemData.Slot, itemData.invType) then
              exports['hrrp-base']:LoggerInfo("Robbery",
                string.format("%s %s (%s) Started Thermiting Bobcat Interior Door", char:GetData("First"), char:GetData("Last"), char:GetData("SID")))
              exports["hrrp-base"]:CallbacksClient(source, "Robbery:Games:Thermite", {
                passes = 1,
                ...
                if success then
                  exports['hrrp-base']:LoggerInfo("Robbery",
                    string.format("%s %s (%s) Successfully Thermited Bobcat Interior Door", char:GetData("First"), char:GetData("Last"), char:GetData("SID")))
                  if not GlobalState["AntiShitlord"] or os.time() >= GlobalState["AntiShitlord"] then
                    GlobalState["AntiShitlord"] = os.time() + (60 * math.random(20, 30))
                  end
                  ...
                  exports['hrrp-doors']:SetLock("bobcat_front", false)
                  if not _alerted or os.time() > _alerted then
                    Robbery:TriggerPDAlert(
                      source,
                      vector3(879.020, -2263.657, 30.468),
                  ...
                  exports['hrrp-base']:LoggerInfo("Robbery",
                    string.format("%s %s (%s) Failed Thermiting Bobcat Interior Door", char:GetData("First"), char:GetData("Last"), char:GetData("SID")))
                end
        ...
        exports["hrrp-base"]:CallbacksClient(source, "Robbery:Moneytruck:CheckForTruck", {}, function(type, vNet)
          if type ~= nil then
            ...
            if not entState.robberyInProgress then
              ...
              if not entState.wasThermited then
                ...
                then
                  exports['hrrp-base']:LoggerInfo("Robbery",
                    string.format("%s %s (%s) Started Thermiting Moneytruck", char:GetData("First"), char:GetData("Last"), char:GetData("SID")))
                  exports["hrrp-base"]:CallbacksClient(source, "Robbery:Moneytruck:Thermite:Door", {
                    vNet = vNet,
                    passes = 1,
                    location = _bobcatLocations.startDoor,
                    duration = 3000,
                    ...
                    if success then
                      exports['hrrp-base']:LoggerInfo("Robbery",
                        string.format("%s %s (%s) Successfully Thermited Moneytruck", char:GetData("First"), char:GetData("Last"), char:GetData("SID")))
                      local peds = {}
                      ...
                      exports["hrrp-base"]:CallbacksClient(
                        source,
                      ...
                      exports['hrrp-base']:LoggerInfo("Robbery",
                        string.format("%s %s (%s) Failed Thermiting Moneytruck", char:GetData("First"), char:GetData("Last"), char:GetData("SID")))
                    end
                    entState.robberyInProgress = false
                  end)
                end
              else
                exports['hrrp-base']:ExecuteClient(source, "Notification", "Error", "This Truck Has Already Been Hit", 6000)
              end
            else
              exports['hrrp-base']:ExecuteClient(source, "Notification", "Error", "Someone Is Already Doing This", 6000)
            end
      ...
      then
        ...
        if #(_bobcatLocations.vaultDoor.coords - myPos) <= 3.5 then
          ...
          if not _bcInUse.useC4 then
            ...
            if Inventory.Items:RemoveSlot(itemData.Owner, itemData.Name, 1, itemData.Slot, itemData.invType) then
              exports['hrrp-base']:LoggerInfo("Robbery",
                string.format("%s %s (%s) Started Breaching Bobcat Vault", char:GetData("First"), char:GetData("Last"), char:GetData("SID")))
              exports["hrrp-base"]:CallbacksClient(source, "Robbery:Games:Aim", {
                location = {
                ...
                if success then
                  exports['hrrp-base']:LoggerInfo("Robbery",
                    string.format("%s %s (%s) Successfully Breached Bobcat Vault", char:GetData("First"), char:GetData("Last"), char:GetData("SID")))
                  ...
                  exports['hrrp-base']:LoggerInfo("Robbery",
                    string.format("%s %s (%s) Failed Breaching Bobcat Vault", char:GetData("First"), char:GetData("Last"), char:GetData("SID")))
      ...
      then
        if #(_bobcatLocations.securedDoor.coords - myCoords) <= 1.5 then
          ...
          if not _bcInUse.securedDoor then
            ...
            exports['hrrp-base']:LoggerInfo("Robbery",
              string.format("%s %s (%s) Started Hacking Bobcat Doors", char:GetData("First"), char:GetData("Last"), char:GetData("SID")))
            exports["hrrp-base"]:CallbacksClient(source, "Robbery:Games:Laptop", {
              location = {
              ...
              if success then
                exports['hrrp-base']:LoggerInfo("Robbery",
                  string.format("%s %s (%s) Successfully Hacked Bobcat Doors", char:GetData("First"), char:GetData("Last"), char:GetData("SID")))
                GlobalState["Bobcat:SecuredDoor"] = true
                GlobalState["BobcatInProgress"] = true

                _bobcatPeds = SpawnPeds(source)
                exports["hrrp-base"]:CallbacksClient(source, "Robbery:Bobcat:SetupPeds", {
                  peds = _bobcatPeds,
                  isBobcat = true,
                  skipLeaveVeh = true,
                }, function() end)
                exports['hrrp-doors']:SetLock("bobcat_inner", false)
                exports['hrrp-base']:ExecuteClient(source, "Notification", "Success", "Doorlock Disengaged", 6000)
                ...
                exports['hrrp-base']:LoggerInfo("Robbery",
                  string.format("%s %s (%s) Failed Hacking Bobcat Doors", char:GetData("First"), char:GetData("Last"), char:GetData("SID")))
                exports['hrrp-doors']:SetLock("bobcat_inner", true)
      ...
      if plyr ~= nil then
        ...
        if char ~= nil then
          ...
          if not netId then
            ...
            exports['hrrp-base']:LoggerInfo("Robbery",
              string.format("%s %s (%s) Used Money Truck GPS Tracker", char:GetData("First"), char:GetData("Last"), char:GetData("SID")))
            exports["hrrp-base"]:CallbacksClient(source, "Robbery:MoneyTruck:MarkTruck", netId, function(r)
              if r then
                Inventory.Items:RemoveSlot(slot.Owner, slot.Name, 1, slot.Slot, 1)
                exports['hrrp-base']:ExecuteClient(
                  source,
      ...
      if plyr ~= nil then
        ...
        if char ~= nil then
          ...
          if not netId then
            ...
            exports['hrrp-base']:LoggerInfo("Robbery",
              string.format("%s %s (%s) Used Fleeca Money Truck GPS Tracker", char:GetData("First"), char:GetData("Last"), char:GetData("SID")))
            exports["hrrp-base"]:CallbacksClient(source, "Robbery:MoneyTruck:MarkTruck", netId, function(r)
              if r then
                Inventory.Items:RemoveSlot(slot.Owner, slot.Name, 1, slot.Slot, 1)
                exports['hrrp-base']:ExecuteClient(
      ...
      if plyr ~= nil then
        ...
        if char ~= nil then
          ...
          if not netId then
            ...
            exports['hrrp-base']:LoggerInfo("Robbery",
              string.format("%s %s (%s) Used Bobcat Money Truck GPS Tracker", char:GetData("First"), char:GetData("Last"), char:GetData("SID")))
            exports["hrrp-base"]:CallbacksClient(source, "Robbery:MoneyTruck:MarkTruck", netId, function(r)
              if r then
                Inventory.Items:RemoveSlot(slot.Owner, slot.Name, 1, slot.Slot, 1)
                exports['hrrp-base']:ExecuteClient(
  ...
  exports['hrrp-base']:CallbacksRegisterServer("Robbery:Bobcat:PickupC4", function(source, data, cb)
    local plyr = exports['hrrp-base']:FetchSource(source)
    if plyr ~= nil then
      local char = plyr:GetData("Character")
      if char ~= nil then
  ...
  exports['hrrp-base']:CallbacksRegisterServer("Robbery:DoThermiteFx", function(source, data, cb)
    TriggerClientEvent("Robbery:Client:ThermiteFx", -1, data.delay or 13000, data.netId)
  end)

  exports['hrrp-base']:CallbacksRegisterServer("Robbery:DoBombFx", function(source, data, cb)
    TriggerClientEvent("Robbery:Client:BombFx", -1, data)
  end)

  exports['hrrp-base']:CallbacksRegisterServer("Robbery:Bobcat:CheckLoot", function(source, data, cb)
    local pState = Player(source).state
  ...
  exports['hrrp-base']:CallbacksRegisterServer("Robbery:Bobcat:CancelLoot", function(source, data, cb)
    local pState = Player(source).state
  ...
  exports['hrrp-base']:CallbacksRegisterServer("Robbery:Bobcat:Loot", function(source, data, cb)
    local pState = Player(source).state
      ...
      if _bcInUse.loot[data.id] == source then
        ...
        if actualData.data.type == data.type then
          ...
          if plyr ~= nil then
            ...
            if char ~= nil then
              exports['hrrp-base']:LoggerInfo("Robbery",
                string.format("%s %s (%s) Looted Bobcat Loot Crate #%s", char:GetData("First"), char:GetData("Last"), char:GetData("SID"), data.id))
  ...
  exports['hrrp-base']:CallbacksRegisterServer("Robbery:Bobcat:Secure", function(source, data, cb)
    local pState = Player(source).state
    local plyr = exports['hrrp-base']:FetchSource(source)
    if plyr ~= nil then
      local char = plyr:GetData("Character")
      if char ~= nil then
        if pState.onDuty == "police" then
          exports['hrrp-base']:LoggerInfo("Robbery",
            string.format("%s %s (%s) Secured Bobcat Security", char:GetData("First"), char:GetData("Last"), char:GetData("SID")))
          SecureBobcat()
          exports['hrrp-base']:ExecuteClient(source, "Notification", "Success", "Building Secure", 6000)
        end
      end
    end
  end)

  exports['hrrp-base']:CallbacksRegisterServer("Robbery:Bobcat:CheckFrontPC", function(source, data, cb)
  ...
  exports['hrrp-base']:CallbacksRegisterServer("Robbery:Bobcat:FrontPCResults", function(source, data, cb)
  ...
  -- exports['hrrp-base']:CallbacksRegisterServer("Robbery:Bobcat:CheckSecurityPC", function(source, data, cb)
  ...
  -- exports['hrrp-base']:CallbacksRegisterServer("Robbery:Bobcat:SecurityPCResults", function(source, data, cb)
  ...
  exports['hrrp-base']:CallbacksRegisterServer("Robbery:Bobcat:LeftBuilding", function(source, data, cb)
    cb(RemoveC4(source))
  end)
end)
...
function ResetBobcat()
  exports['hrrp-doors']:SetLock("bobcat_extr", true)
  exports['hrrp-doors']:SetLock("bobcat_front", true)
  exports['hrrp-doors']:SetLock("bobcat_inner", true)
...
function SpawnPeds(source)
  ...
  for k, v in ipairs(_bobcatPedLocs) do
    local p = CreatePed(5, GetHashKey("s_m_m_armoured_02"), v[1], v[2], v[3], v[4], true, true)
    local w = _bobcatWeapons[math.random(#_bobcatWeapons)]
    Entity(p).state.crimePed = true
