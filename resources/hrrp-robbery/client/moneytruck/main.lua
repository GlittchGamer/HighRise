...
AddEventHandler("Robbery:Client:Setup", function()
	exports["hrrp-base"]:CallbacksRegisterClient("Robbery:Moneytruck:CheckForTruck", function(data, cb)
    ...
    exports["hrrp-base"]:CallbacksRegisterClient("Robbery:Moneytruck:Thermite:Door", function(data, cb)
    ...
    exports["hrrp-base"]:CallbacksRegisterClient("Robbery:Moneytruck:Spawn:Get", function(data, cb)
	...
	exports["hrrp-base"]:CallbacksRegisterClient("Robbery:MoneyTruck:CreatePeds", function(data, cb)
	...
	exports["hrrp-base"]:CallbacksRegisterClient("Robbery:MoneyTruck:MarkTruck", function(data, cb)
...
AddEventHandler("Robbery:Client:MoneyTruck:GrabLoot", function(entity, data)
	exports["hrrp-base"]:CallbacksServer('Robbery:MoneyTruck:CheckLoot', VehToNet(entity.entity), function(s)
		if s then
			Progress:Progress({
				...
				if not status then
					exports["hrrp-base"]:CallbacksServer('Robbery:MoneyTruck:Loot', VehToNet(entity.entity), function(s2) end)
				else
					exports["hrrp-base"]:CallbacksServer('Robbery:MoneyTruck:CancelLoot', VehToNet(entity.entity), function(s2) end)
				end
			end)
		end
	end)
