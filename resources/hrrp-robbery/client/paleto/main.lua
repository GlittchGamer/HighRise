...
function PaletoNeedsReset()
  ...
  for k, v in ipairs(_pbDoorIds) do
    if not exports['hrrp-doors']:IsLocked(v) then
      return true
    end
  end
...
AddEventHandler("Robbery:Client:Setup", function()
  exports['hrrp-polyzone']:PolyZoneCreatePoly("bank_paleto", {
  ...
  exports['hrrp-polyzone']:PolyZoneCreateBox("paleto_hack_access", vector3(-107.04, 6474.16, 31.63), 1.8, 1.2, {
    heading = 315,
    --debugPoly=true,
    minZ = 30.63,
    maxZ = 32.63,
  ...
  for k, v in ipairs(_pbKillZones) do
    exports['hrrp-polyzone']:PolyZoneCreateBox(string.format("pb_killzone_%s", k), v.coords, v.length, v.width, v.options, v.data)
  end
  ...
  exports['ox_target']:TargetingZonesAddBox("paleto_secure", "shield-keyhole", vector3(-109.57, 6461.51, 31.64), 0.6, 0.4, {
    heading = 315,
    --debugPoly=true,
    minZ = 31.24,
    maxZ = 32.84,
  ...
  exports['ox_target']:TargetingZonesAddBox("paleto_security", "shield-keyhole", vector3(-91.76, 6464.78, 31.63), 1.4, 0.8, {
    heading = 315,
    --debugPoly=true,
    minZ = 30.63,
    maxZ = 32.43,
  }, {
    {
      ...
      isEnabled = function(data, entity)
        return IsPaletoExploitInstalled() and not exports['hrrp-doors']:IsLocked("bank_savings_paleto_security")
      end,
    },
  }, 3.0, true)

  exports['ox_target']:TargetingZonesAddBox("paleto_hack_workstation", "terminal", vector3(-106.12, 6473.87, 31.63), 1.2, 0.6, {
    heading = 315,
    --debugPoly=true,
    minZ = 31.03,
    maxZ = 32.43,
    ...
    Lasers:Create(
      ...
      function(playerBeingHit, hitPos)
        if playerBeingHit then
          exports["hrrp-base"]:CallbacksServer("Robbery:Paleto:TriggeredLaser")
        end
      end
    )
  end
      ...
      {
        {
          ...
          isEnabled = function(data, entity)
            return IsPaletoExploitInstalled()
                and not exports['hrrp-doors']:IsLocked("bank_savings_paleto_vault")
                and (
  ...
  exports['ox_target']:TargetingZonesAddBox("paleto_office_safe", "vault", vector3(-105.27, 6480.67, 31.63), 0.8, 0.6, {
    heading = 45,
    --debugPoly=true,
    minZ = 31.43,
    maxZ = 32.83,
  }, {
    {
      ...
      isEnabled = function(data, entity)
        return IsPaletoExploitInstalled()
            and not exports['hrrp-doors']:IsLocked("bank_savings_paleto_office_3")
      ...
      {
        {
          ...
          isEnabled = function(data, entity)
            return IsPaletoExploitInstalled()
                and not exports['hrrp-doors']:IsLocked(data.door)
                and (
...
AddEventHandler("Polyzone:Enter", function(id, testedPoint, insideZones, data)
  ...
  elseif id == "paleto_hack_access" and not exports['hrrp-doors']:IsLocked("bank_savings_paleto_gate") then
  ...
  elseif data.pcId ~= nil then
    exports['ox_target']:TargetingAddObject(GetHashKey("xm_prop_base_staff_desk_02"), "computer", {
      {
        text = "Upload Exploit",
        icon = "terminal",
...
AddEventHandler("Polyzone:Exit", function(id, testedPoint, insideZones, data)
  ...
  elseif data.pcId ~= nil then
    exports['ox_target']:TargetingRemoveObject(GetHashKey("xm_prop_base_staff_desk_02"))
  end
end)
...
AddEventHandler("Robbery:Client:Paleto:ElectricBox:Hack", function(entity, data)
  exports["hrrp-base"]:CallbacksServer("Robbery:Paleto:ElectricBox:Hack", data, function() end)
end)

AddEventHandler("Robbery:Client:Paleto:Upload", function(entity, data)
  exports["hrrp-base"]:CallbacksServer("Robbery:Paleto:PC:Hack", data, function() end)
end)

AddEventHandler("Robbery:Client:Paleto:Workstation", function(entity, data)
  exports["hrrp-base"]:CallbacksServer("Robbery:Paleto:Workstation", data, function() end)
end)

AddEventHandler("Robbery:Client:Paleto:OfficeHack", function(entity, data)
  exports["hrrp-base"]:CallbacksServer("Robbery:Paleto:OfficeHack", data, function() end)
end)

AddEventHandler("Robbery:Client:Paleto:Drill", function(entity, data)
  exports["hrrp-base"]:CallbacksServer("Robbery:Paleto:Drill", data.drillId, function() end)
end)

AddEventHandler("Robbery:Client:Paleto:Search", function(entity, data)
  exports["hrrp-base"]:CallbacksServer("Robbery:Paleto:Search", data, function() end)
end)

AddEventHandler("Robbery:Client:Paleto:Safe", function(entity, data)
  exports["hrrp-base"]:CallbacksServer("Robbery:Paleto:StartSafe", {}, function(s)
    if s then
...
AddEventHandler("Robbery:Client:Paleto:SafeInput", function(values, data)
  exports["hrrp-base"]:CallbacksServer("Robbery:Paleto:Safe", {
    code = values.code,
    data = data,
  }, function() end)
end)
...
AddEventHandler("Robbery:Client:Paleto:VaultTerminal", function()
  Progress:Progress({
    ...
    if not status then
      exports["hrrp-base"]:CallbacksServer("Robbery:Paleto:VaultTerminal", {})
    end
  end)
end)
...
AddEventHandler("Robbery:Client:Paleto:Door", function(data)
  if data.officeId ~= nil then
    ...
    exports["hrrp-base"]:CallbacksServer("Robbery:Paleto:UnlockDoor", {
      data = data,
    })
  end
end)
...
AddEventHandler("Robbery:Client:Paleto:Doors", function(entity, data)
  exports["hrrp-base"]:CallbacksServer("Robbery:Paleto:GetDoors", {}, function(menu)
    local menu = {
      main = {
...
AddEventHandler("Robbery:Client:Paleto:StartSecuring", function(entity, data)
  Progress:Progress({
    ...
    if not status then
      exports["hrrp-base"]:CallbacksServer("Robbery:Paleto:SecureBank", {})
    end
  end)
end)
...
AddEventHandler("Robbery:Client:Paleto:DisableAlarm", function(entity, data)
  Progress:Progress({
    ...
    if not status then
      exports["hrrp-base"]:CallbacksServer("Robbery:Paleto:DisableAlarm", {})
    end
  end)
end)
