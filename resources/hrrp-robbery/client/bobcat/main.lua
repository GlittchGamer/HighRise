...
AddEventHandler("Robbery:Client:Setup", function()
  ...
  exports['hrrp-polyzone']:PolyZoneCreatePoly("bobcat", {
  ...
  exports["hrrp-base"]:CallbacksRegisterClient("Robbery:Bobcat:SetupPeds", function(data, cb)
...
AddEventHandler("Robbery:Client:Bobcat:StartSecuring", function(entity, data)
  Progress:Progress({
    ...
    if not status then
      exports["hrrp-base"]:CallbacksServer("Robbery:Bobcat:Secure", {})
    end
  end)
end)

-- AddEventHandler("Robbery:Client:Bobcat:HackFrontPC", function(entity, t)
-- 	exports["hrrp-base"]:CallbacksServer("Robbery:Bobcat:CheckFrontPC", {}, function(data)
-- 		if data then
-- 			_capPass = 1
-- 			DoCaptcha(data.passes, data.config, data.data, function(isSuccess, extra)
-- 				exports["hrrp-base"]:CallbacksServer("Robbery:Bobcat:FrontPCResults", {
-- 					state = isSuccess,
-- 				}, function() end)
-- 			end)
-- 		end
...
-- 	exports["hrrp-base"]:CallbacksServer("Robbery:Bobcat:CheckSecurityPC", {}, function(data)
-- 		if data then
-- 			_capPass = 1
-- 			DoCaptcha(data.passes, data.config, data.data, function(isSuccess, extra)
-- 				exports["hrrp-base"]:CallbacksServer("Robbery:Bobcat:SecurityPCResults", {
-- 					state = isSuccess,
-- 				}, function() end)
-- 			end)
-- 		end
...
AddEventHandler("Robbery:Client:Bobcat:GrabC4", function()
  Progress:Progress({
    ...
    if not status then
      exports["hrrp-base"]:CallbacksServer('Robbery:Bobcat:PickupC4', {}, function(s)
...
AddEventHandler("Robbery:Client:Bobcat:GrabLoot", function(entity, data)
  exports["hrrp-base"]:CallbacksServer('Robbery:Bobcat:CheckLoot', data, function(s)
    if s then
      Progress:Progress({
        name = "bobcat_loot",
        ...
        if not status then
          exports["hrrp-base"]:CallbacksServer('Robbery:Bobcat:Loot', data, function(s2) end)
        else
          exports["hrrp-base"]:CallbacksServer('Robbery:Bobcat:CancelLoot', data, function(s2) end)
        end
      end)
    end
  end)
...
AddEventHandler("Polyzone:Exit", function(id, point, insideZone, data)
  if id == "bobcat" then
    ...
    exports["hrrp-base"]:CallbacksServer("Robbery:Bobcat:LeftBuilding", {}, function() end)
  end
end)
