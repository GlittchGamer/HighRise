...
AddEventHandler("Robbery:Client:Setup", function()
  exports['hrrp-polyzone']:PolyZoneCreatePoly("bank_mazebank", {
  ...
  exports['ox_target']:TargetingZonesAddBox("mazebanK_secure", "shield-keyhole", vector3(-1301.14, -826.27, 16.78), 1.4, 0.6, {
    heading = 37,
    --debugPoly = true,
    minZ = 15.78,
    maxZ = 17.38,
...
AddEventHandler("Robbery:Client:MazeBank:StartSecuring", function(entity, data)
  Progress:Progress({
    ...
    if not status then
      exports["hrrp-base"]:CallbacksServer("Robbery:MazeBank:SecureBank", {})
    end
  end)
end)

AddEventHandler("Robbery:Client:MazeBank:ElectricBox:Hack", function(entity, data)
  exports["hrrp-base"]:CallbacksServer("Robbery:MazeBank:ElectricBox:Hack", data, function() end)
end)

AddEventHandler("Robbery:Client:MazeBank:ElectricBox:Thermite", function(entity, data)
  exports["hrrp-base"]:CallbacksServer("Robbery:MazeBank:ElectricBox:Thermite", data, function() end)
end)

AddEventHandler("Robbery:Client:MazeBank:Drill", function(entity, data)
  exports["hrrp-base"]:CallbacksServer("Robbery:MazeBank:Drill", data.id, function() end)
end)

AddEventHandler("Robbery:Client:MazeBank:PC:Hack", function(entity, data)
  exports["hrrp-base"]:CallbacksServer("Robbery:MazeBank:PC:Hack", data, function() end)
end)
