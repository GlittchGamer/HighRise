function StartUsingMicrophone(withRange)
  if PLAYER_CONNECTED and (not CALL_CHANNEL or CALL_CHANNEL <= 0) and not RADIO_TALKING and not USING_MEGAPHONE then
    Citizen.CreateThread(function()
      exports['hrrp-base']:LoggerInfo('VOIP', 'Microphone On')
...
function StopUsingMicrophone()
  if USING_MICROPHONE then
    exports['hrrp-base']:LoggerInfo('VOIP', 'Microphone Off')
...
function CreateMicrophonePolyzones()
  exports['hrrp-polyzone']:PolyZoneCreateBox('microphone_rockford_records_stage', vector3(-1006.03, -254.44, 39.47), 9.4, 2.6, {
    heading = 325,
    --debugPoly=true,
    minZ = 38.47,
    maxZ = 42.07
  ...
  exports['hrrp-polyzone']:PolyZoneCreateBox('microphone_unicorn_dj', vector3(120.51, -1281.51, 29.48), 3.2, 1.8, {
    heading = 30,
    --debugPoly=true,
    minZ = 28.48,
    maxZ = 31.48
  ...
  exports['hrrp-polyzone']:PolyZoneCreateBox('microphone_triad_stage', vector3(-840.07, -718.52, 28.28), 6.0, 4.6, {
    heading = 320,
    --debugPoly=true,
    minZ = 27.28,
    maxZ = 29.68
  ...
  exports['hrrp-polyzone']:PolyZoneCreateBox('microphone_tequila_stage', vector3(-551.23, 284.04, 82.98), 8.0, 3.0, {
    heading = 355,
    --debugPoly=true,
    minZ = 81.98,
    maxZ = 85.18
  ...
  exports['hrrp-polyzone']:PolyZoneCreateBox('microphone_rockford_records_booth1', vector3(-1001.02, -282.4, 44.8), 2, 2, {
    heading = 324,
    --debugPoly=true,
    minZ = 43.8,
    maxZ = 46.6
  ...
  exports['hrrp-polyzone']:PolyZoneCreateBox('microphone_rockford_records_booth2', vector3(-1006.51, -289.22, 44.8), 1.6, 2, {
    heading = 28,
    --debugPoly=true,
    minZ = 43.8,
    maxZ = 46.4
  ...
  exports['hrrp-polyzone']:PolyZoneCreateBox('microphone_rockford_records_booth3', vector3(-1007.51, -294.11, 44.8), 4.2, 6.4, {
    heading = 27,
    --debugPoly=true,
    minZ = 43.8,
    maxZ = 47.2
  ...
  exports['hrrp-polyzone']:PolyZoneCreateBox('microphone_vinewoodbowl', vector3(685.97, 576.13, 130.46), 18.0, 18.2, {
    heading = 340,
    --debugPoly=true,
    minZ = 129.46,
    maxZ = 133.46
  ...
  exports['hrrp-polyzone']:PolyZoneCreateBox('microphone_triad_studio', vector3(-813.82, -719.33, 32.34), 6.6, 5.2, {
    heading = 0,
    --debugPoly=true,
    minZ = 31.34,
    maxZ = 34.74
