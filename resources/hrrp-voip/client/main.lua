...
setupEvent = AddEventHandler("Core:Shared:Ready", function()
  exports["hrrp-base"]:RequestDependencies("VOIP", {
    "Callbacks",
    "Notification",
    "Logger",
    "Hud",
    ...
    exports['hrrp-keybinds']:Add("voip_cycleproximity", "Z", "keyboard", "Voice - Cycle Proximity", function()
      if _characterLoaded and PLAYER_CONNECTED then
        VOIP:Cycle()
      end
    end)

    exports['hrrp-keybinds']:Add("voip_radio", "CAPITAL", "keyboard", "Voice - Radio - Push to Talk", function()
      if _characterLoaded and PLAYER_CONNECTED then
        RadioKeyDown()
      end
    end, function()
...
AddEventHandler("Characters:Client:Spawn", function()
  ...
  exports['hrrp-hud']:VOIP(PLAYER_TALKING, CURRENT_VOICE_MODE, RADIO_TALKING)
...
AddEventHandler("Characters:Client:Logout", function()
  ...
  exports['hrrp-base']:LoggerInfo("VOIP", "Disconnecting From Mumble (Character Logging Out)")
end)

AddEventHandler("VOIP:Client:ConnectionState", function(state)
  if state then
    exports['hrrp-base']:LoggerInfo("VOIP", "Connected to Mumble Server")
    ...
    exports['hrrp-base']:LoggerWarn("VOIP", "Disconnected from Mumble Server")
    StopUsingMegaphone()
  end
...
_fuckingVOIP = {
  Cycle = function(self, num)
    ...
    exports['hrrp-base']:LoggerTrace("VOIP", "New Voice Range: " .. CURRENT_VOICE_MODE)
  end,
...
AddEventHandler("Proxy:Shared:RegisterReady", function()
  exports["hrrp-base"]:RegisterComponent("VOIP", _fuckingVOIP)
end)
