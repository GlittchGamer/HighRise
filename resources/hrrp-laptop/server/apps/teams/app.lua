...
AddEventHandler("Laptop:Server:RegisterCallbacks", function()
  exports['hrrp-base']:CallbacksRegisterServer("Laptop:Teams:Get", function(source, data, cb)
    cb(Laptop.Teams:GetAll())
  end)

  exports['hrrp-base']:CallbacksRegisterServer("Laptop:Teams:GetRequests", function(source, data, cb)
    cb(Laptop.Teams.Requests:Get(source))
  end)

  exports['hrrp-base']:CallbacksRegisterServer("Laptop:Teams:Create", function(source, data, cb)
    cb(Laptop.Teams:Create(source, data.Name))
  end)

  exports['hrrp-base']:CallbacksRegisterServer("Laptop:Teams:Delete", function(source, data, cb)
    local char = exports['hrrp-base']:FetchSource(source):GetData("Character")
    if char then
  ...
  exports['hrrp-base']:CallbacksRegisterServer("Laptop:Teams:Members:Invite", function(source, data, cb)
    local char = exports['hrrp-base']:FetchSource(source):GetData("Character")
  ...
  exports['hrrp-base']:CallbacksRegisterServer("Laptop:Teams:Members:Remove", function(source, data, cb)
    local char = exports['hrrp-base']:FetchSource(source):GetData("Character")
  ...
  exports['hrrp-base']:CallbacksRegisterServer("Laptop:Teams:ActionRequest", function(source, data, cb)
    local char = exports['hrrp-base']:FetchSource(source):GetData("Character")
  ...
  exports['hrrp-base']:CallbacksRegisterServer("Laptop:Teams:RequestInvite", function(source, data, cb)
    local char = exports['hrrp-base']:FetchSource(source):GetData("Character")
    if char and data and not char:GetData("Team") then
      ...
      if team and team.State == 0 then
        ...
        local req = Laptop.Teams.Requests:Add(
          ...
          "New Join Request",
          string.format("Request to join your team from %s %s (%s).", char:GetData("First"), char:GetData("Last"),
            char:GetData("SID")),
          {
            request = true,
            team = team.ID,
