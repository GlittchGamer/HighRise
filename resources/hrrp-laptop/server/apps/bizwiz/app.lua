...
function CheckBusinessPermissions(source, permission)
  local onDuty = exports['hrrp-jobs']:JobsDutyGet(source)
  if onDuty and onDuty.Id and bizWizJobs[onDuty.Id] then
    if (not permission) or exports['hrrp-jobs']:JobsPermissionsHasPermissionInJob(source, onDuty.Id, permission) then
      return onDuty.Id
    end
  end
  return false
...
AddEventHandler("Laptop:Server:RegisterCallbacks", function()
  exports['hrrp-base']:CallbacksRegisterServer("Laptop:BizWiz:EmployeeSearch", function(source, data, cb)
  ...
  exports['hrrp-base']:CallbacksRegisterServer("Laptop:BizWiz:GetTwitterProfile", function(source, data, cb)
  ...
  exports['hrrp-base']:CallbacksRegisterServer("Laptop:BizWiz:SetTwitterProfile", function(source, data, cb)
    local job = CheckBusinessPermissions(source, "JOB_MANAGEMENT")
    if job then
  ...
  exports['hrrp-base']:CallbacksRegisterServer("Laptop:BizWiz:SendTweet", function(source, data, cb)
  ...
  exports['hrrp-base']:CallbacksRegisterServer("Laptop:BizWiz:ViewVehicleFleet", function(source, data, cb)
  ...
  exports['hrrp-base']:CallbacksRegisterServer("Laptop:BizWiz:TrackFleetVehicle", function(source, data, cb)
    local job = CheckBusinessPermissions(source, "FLEET_MANAGEMENT")
    if job then
