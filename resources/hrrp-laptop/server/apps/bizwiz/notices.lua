AddEventHandler("Laptop:Server:RegisterCallbacks", function()
  ...
  exports['hrrp-base']:LoggerTrace("Laptop", "[BizWiz] Loaded ^2" .. #fetchBusinessNotices .. "^7 Business Notices", { console = true })
  ...
  exports['hrrp-base']:CallbacksRegisterServer("Laptop:BizWiz:Notice:Create", function(source, data, cb)
  ...
  exports['hrrp-base']:CallbacksRegisterServer("Laptop:BizWiz:Notice:Delete", function(source, data, cb)
...
LAPTOP.BizWiz.Notices = {
  Create = function(self, source, job, data)
    ...
    if char then
      ...
      local jobDutyData = exports['hrrp-jobs']:JobsDutyGetDutyData(job)
