...
AddEventHandler("Laptop:Server:RegisterCallbacks", function()
  exports['hrrp-base']:CallbacksRegisterServer("Laptop:BizWiz:Document:Search", function(source, data, cb)
  ...
  exports['hrrp-base']:CallbacksRegisterServer("Laptop:BizWiz:Document:Create", function(source, data, cb)
  ...
  exports['hrrp-base']:CallbacksRegisterServer("Laptop:BizWiz:Document:Update", function(source, data, cb)
    local char = exports['hrrp-base']:FetchSource(source):GetData("Character")
    local job = CheckBusinessPermissions(source, 'TABLET_CREATE_DOCUMENT')
  ...
  exports['hrrp-base']:CallbacksRegisterServer("Laptop:BizWiz:Document:Delete", function(source, data, cb)
  ...
  exports['hrrp-base']:CallbacksRegisterServer("Laptop:BizWiz:Document:View", function(source, data, cb)
    local job = CheckBusinessPermissions(source, 'TABLET_VIEW_DOCUMENT')
    if job then
