RegisterNUICallback("PDMGetDealerData", function(data, cb)
	exports["hrrp-base"]:CallbacksServer("Dealerships:GetDealershipData", { dealerId = LocalPlayer.state.onDuty }, cb)
end)

RegisterNUICallback("PDMSaveDealerData", function(data, cb)
	exports["hrrp-base"]:CallbacksServer("Dealerships:UpdateDealershipData", {
...
RegisterNUICallback("DealershipStartTestDrive", function(data, cb)
	exports["hrrp-base"]:CallbacksServer("Dealerships:Sales:TestDrive", {
...
RegisterNUICallback("PDMStartSale", function(data, cb)
	exports["hrrp-base"]:CallbacksServer("Dealerships:Sales:StartSale", {
		dealership = LocalPlayer.state.onDuty,
		type = data.type,
		data = {
			vehicle = data.vehicle,
...
RegisterNUICallback("PDMGetHistory", function(data, cb)
	exports["hrrp-base"]:CallbacksServer("Dealerships:FetchHistory", {
		dealership = LocalPlayer.state.onDuty,
		term = data.value,
