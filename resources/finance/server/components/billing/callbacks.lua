AddEventHandler('Finance:Server:Startup', function()
    exports['core']:CallbacksRegisterServer('Billing:DismissBill', function(source, data, cb)
    ...
    exports['core']:CallbacksRegisterServer('Billing:AcceptBill', function(source, data, cb)
        if data and data.bill then
    ...
    exports['core']:CallbacksRegisterServer('Billing:CreateBill', function(source, data, cb)
