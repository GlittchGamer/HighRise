...
setupEvent = AddEventHandler("Core:Shared:Ready", function()
  exports['core']:RequestDependencies("Crypto", {
    "Fetch",
    "Utils",
    "Execute",
    "Chat",
    ...
    if #error > 0 then
      exports['core']:FetchComponent("Logger"):Critical("Crypto", "Failed To Load All Dependencies")
      return
    end
  ...
  Exchange = {
    ...
    Buy = function(self, coin, target, amount)
      if Crypto.Exchange:IsListed(coin) then
        local plyr = exports['core']:FetchSID(target)
        if plyr ~= nil then
          local char = plyr:GetData("Character")
          if char ~= nil then
    ...
    Transfer = function(self, coin, sender, target, amount)
      local plyr = exports['core']:FetchSID(sender)
      if plyr then
        local char = plyr:GetData("Character")
        if char then
...
AddEventHandler("Proxy:Shared:RegisterReady", function()
  exports['core']:RegisterComponent("Crypto", _CRYPTO)
end)
