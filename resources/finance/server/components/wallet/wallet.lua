AddEventHandler("Finance:Server:Startup", function()
  exports['core']:CallbacksRegisterServer("Wallet:GetCash", function(source, data, cb)
    cb(Wallet:Get(source))
  end)

  exports['core']:CallbacksRegisterServer("Wallet:GiveCash", function(source, data, cb)
    local char = exports['core']:FetchSource(source):GetData("Character")
    local targetChar = exports['core']:FetchSID(data.target)
  ...
  Chat:RegisterCommand("givecash", function(source, args, rawCommand)
    ...
    if target and target > 0 then
      local char = exports['core']:FetchSource(source):GetData("Character")
      local targetChar = exports['core']:FetchSID(target)
