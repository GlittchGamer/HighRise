...
AddEventHandler("Businesses:Client:Startup", function()
  for k, v in ipairs(_sellers) do
    exports['pedinteraction']:Add(string.format('SAGMASeller%s', k), v.model, v.coords, v.heading, 25.0, {
      {
        icon = 'ring',
        text = 'Sell Gems',
...
AddEventHandler("SAGMA:Client:Sell", function()
  exports['core']:CallbacksServer("Businesses:SAGMA:Sell", {})
end)
...
function ActivateTable(tableId, color, quality, item)
  ...
  exports['hud']:GemTableOpen(quality)
