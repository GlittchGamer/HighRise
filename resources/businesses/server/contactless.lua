...
AddEventHandler("Businesses:Server:Startup", function()
  exports['core']:CallbacksRegisterServer("Contactless:Create", function(source, data, cb)
  ...
  exports['core']:CallbacksRegisterServer("Contactless:Clear", function(source, data, cb)
    local char = exports['core']:FetchSource(source):GetData("Character")
  ...
  exports['core']:CallbacksRegisterServer("Contactless:Pay", function(source, data, cb)
    local char = exports['core']:FetchSource(source):GetData("Character")
    if char and data and data.terminalId and _pendingContactless[data.terminalId] and GlobalState[string.format("PendingContactless:%s", data.terminalId)] then
      ...
      if wSuccess then
        ...
        exports['core']:ExecuteClient(pData.billerSource, "Notification", "Success", "Contactless Payment Received")
        ...
        exports['core']:ExecuteClient(pData.billerSource, "Notification", "Error", "Contactless Payment Failed")
