...
setupEvent = AddEventHandler("Core:Shared:Ready", function()
  exports['hrrp-base']:RequestDependencies('MenuExample', {
    'Menu',
  }, function(error)
...
AddEventHandler('Menu:Client:Test', function()
  local menu = exports['hrrp-menu']:Create('menu1', 'Menu 1')
  ...
  local root = exports['hrrp-menu']:Create('root', 'Root Menu', function(id, back)
