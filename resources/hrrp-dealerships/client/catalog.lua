...
function OpenCatalogMenu(catalogName)
  catalogMenu = exports['hrrp-menu']:Create('dealerCatalog', catalogName .. ' Vehicle Catalog', function()
  ...
  for _, cat in ipairs(orderedCategories) do
    if catalogData.sorted[cat] and #catalogData.sorted[cat] > 0 then
      ...
      catalogSubMenus[cat] = exports['hrrp-menu']:Create('dealerCatalogSub-' .. cat, catalogName .. ' Catalog - ' .. _catalogCategories[cat] .. ' Vehicles')
