...
function CreatePDZones()
  -- exports['ox_target']:TargetingZonesAddBox("pd-clockinoff-mrpd", "siren-on", vector3(450.38, -984.09, 30.69), 0.8, 0.4, {
  --   heading = 0,
  --   minZ = 30.69,
  --   maxZ = 31.29
  -- }, policeDutyPoint, 1.0, true)

  exports['ox_target']:TargetingZonesAddBox("pd-clockinoff-sandy", "siren-on", vector3(1833.55, 3678.69, 34.19), 1.0, 3.0, {
    heading = 30,
    --debugPoly=true,
    minZ = 33.79,
    maxZ = 35.59
  ...
  exports['ox_target']:TargetingZonesAddBox("pd-clockinoff-pbpd", "siren-on", vector3(-447.18, 6013.36, 32.29), 0.8, 1.6, {
    heading = 45,
    minZ = 32.29,
    maxZ = 32.89,
  }, policeDutyPoint, 1.0, true)

  exports['ox_target']:TargetingZonesAddBox("pd-clockinoff-davis", "siren-on", vector3(381.37, -1595.84, 30.05), 2.0, 1.0, {
    heading = 320,
    minZ = 29.85,
    maxZ = 31.05,
  }, policeDutyPoint, 1.0, true)

  exports['ox_target']:TargetingZonesAddBox("pd-clockinoff-lamesa", "siren-on", vector3(837.23, -1289.2, 28.24), 0.8, 2.2, {
    heading = 0,
    --debugPoly=true,
    minZ = 27.24,
    maxZ = 29.04,
  ...
  exports['ox_target']:TargetingZonesAddBox("pd-clockinoff-courthouse", "siren-on", vector3(-528.46, -189.44, 38.23), 1.0, 1.0, {
    heading = 30,
    --debugPoly=true,
    minZ = 37.63,
    maxZ = 39.23
  ...
  for k, v in ipairs(_pdStationPolys) do
    ...
    exports['polyzonehandler']:PolyZoneCreatePoly(v.options.name, v.points, v.options, v.data)
  end


  exports['ox_target']:TargetingZonesAddBox("prison-clockinoff", "clipboard", vector3(1838.94, 2578.14, 46.01), 2.0, 0.8, {
    heading = 305,
    --debugPoly=true,
    minZ = 45.81,
    maxZ = 46.61,
  ...
  exports['ox_target']:TargetingZonesAddBox("mrpd-male-lockers-1", "siren-on", vector3(480.52, -1007.07, 30.69), 0.6, 5.3, {
    heading = 0,
    --debugPoly=true,
    minZ = 30.09,
    maxZ = 31.89
  ...
  exports['ox_target']:TargetingZonesAddBox("mrpd-male-lockers-2", "siren-on", vector3(484.18, -1009.49, 30.69), 0.6, 5.3, {
    heading = 270,
    --debugPoly=true,
    minZ = 30.09,
    maxZ = 31.89
  ...
  exports['ox_target']:TargetingZonesAddBox("mrpd-male-lockers-3", "siren-on", vector3(480.51, -1015.49, 30.69), 0.6, 5.3, {
    heading = 180,
    --debugPoly=true,
    minZ = 30.09,
    maxZ = 31.89
  ...
  exports['ox_target']:TargetingZonesAddBox("mrpd-male-lockers-3", "siren-on", vector3(480.73, -1012.5, 30.69), 2.8, 1.7, {
    heading = 180,
    --debugPoly=true,
    minZ = 30.09,
    maxZ = 31.89
  ...
  -- exports['ox_target']:TargetingZonesAddBox("police-shitty-locker", "siren-on", vector3(461.59, -1000.0, 30.69), 1.0, 3.8, {
  --   heading = 0,
  --   --debugPoly=true,
  --   minZ = 29.69,
  --   maxZ = 32.69,
  ...
  -- exports['ox_target']:TargetingZonesAddBox("police-shitty-locker-2", "siren-on", vector3(1841.51, 3682.08, 34.19), 2.0, 1, {
  --   heading = 30,
  --   --debugPoly=true,
  --   minZ = 33.19,
  --   maxZ = 35.59
  ...
  -- exports['ox_target']:TargetingZonesAddBox("police-shitty-locker-3", "siren-on", vector3(-436.32, 6009.79, 37.0), 0.2, 2.2, {
  --   heading = 45,
  --   --debugPoly=true,
  --   minZ = 36.3,
  --   maxZ = 38.1,
  ...
  -- exports['ox_target']:TargetingZonesAddBox("police-shitty-locker-4", "siren-on", vector3(360.08, -1592.9, 25.45), 0.5, 2.8, {
  --   heading = 50,
  --   --debugPoly=true,
  --   minZ = 24.45,
  --   maxZ = 27.45,
  ...
  -- exports['ox_target']:TargetingZonesAddBox("police-shitty-locker-5", "siren-on", vector3(844.8, -1286.55, 28.24), 2.0, 1.2, {
  --   heading = 0,
  --   --debugPoly=true,
  --   minZ = 27.24,
  --   maxZ = 29.84,
  ...
  exports['ox_target']:TargetingZonesAddBox("ems-shitty-locker-2", "siren-on", vector3(-439.04, -309.88, 34.91), 0.8, 0.8, {
    heading = 20,
    --debugPoly=true,
    minZ = 33.71,
    maxZ = 36.11,
