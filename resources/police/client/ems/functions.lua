...
function BuildTreatmentMenu(id)
  exports['core']:CallbacksServer("Damage:GetLimbDamage", id, function(menu)
    local options = {}
    ...
    if targetState.isDead then
      if exports['jobs']:JobsPermissionsHasJob("ems") then
        table.insert(options, {
      ...
      print(exports['jobs']:JobsPermissionsHasJob("ems"))
      if exports['jobs']:JobsPermissionsHasJob("ems") then
