...
setupEvent = AddEventHandler("Core:Shared:Ready", function()
  exports['core']:RequestDependencies("Police", {
    ...
    exports['pedinteraction']:Add("govt-services", `a_f_m_eastsa_02`, vector3(-552.412, -202.760, 37.239), 337.363, 25.0,
    ...
    exports['polyzonehandler']:PolyZoneCreateBox("courtroom", vector3(-571.17, -207.02, 38.77), 18.2, 19.6, {
      heading = 30,
      --debugPoly=true,
      minZ = 36.97,
      maxZ = 47.37
...
RegisterNetEvent("Characters:Client:Spawn", function()
  exports['blips']:Add('courthouse', "Courthouse", vector3(-538.916, -214.852, 37.650), 419, 0, 0.9)
end)
...
RegisterNetEvent("Government:Client:Gavel", function()
  ...
  if exports['polyzonehandler']:PolyZoneIsCoordsInZone(coords, "courtroom") then
