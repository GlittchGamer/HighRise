...
function RunBankingStartup()
  ...
  if info and info.total then
    exports['hrrp-base']:LoggerInfo("Banking", string.format("Total Balance Across %s Accounts: ^2$%s^7", info.accounts, info.total))
  end

  exports['hrrp-base']:LoggerInfo("Banking", "Loaded State Government Account - Balance: ^2$" .. stateAccount.balance .. "^7")
  ...
  if d.affectedRows > 0 then
    exports['hrrp-base']:LoggerInfo("Banking", "Cleared ^2" .. d.affectedRows .. "^7" .. " Old Bank Transactions")
  end
end
...
function CreateOrganizationBankAccounts()
  ...
  if created > 0 then
    exports['hrrp-base']:LoggerTrace("Banking", "Created ^2" .. created .. "^7 Default Organization Accounts")
  end
end
