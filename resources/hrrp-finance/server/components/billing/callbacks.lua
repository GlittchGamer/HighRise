AddEventHandler('Finance:Server:Startup', function()
    exports['hrrp-base']:CallbacksRegisterServer('Billing:DismissBill', function(source, data, cb)
    ...
    exports['hrrp-base']:CallbacksRegisterServer('Billing:AcceptBill', function(source, data, cb)
        if data and data.bill then
    ...
    exports['hrrp-base']:CallbacksRegisterServer('Billing:CreateBill', function(source, data, cb)
