...
setupEvent = AddEventHandler("Core:Shared:Ready", function()
  exports["hrrp-base"]:RequestDependencies("Finance", {
    ...
    exports['hrrp-pedinteraction']:Add("paycheck", `ig_bankman`, vector3(253.193, 216.434, 105.282), 339.578, 25.0, {
      {
    ...
    exports['hrrp-pedinteraction']:Add("paycheck-2", `ig_bankman`, vector3(17.568, -927.223, 28.903), 111.958, 25.0, {
      {
        icon = "hand-holding-dollar",
        text = "Get Paycheck",
        event = "Finance:Client:Paycheck",
    ...
    exports['hrrp-pedinteraction']:Add("paycheck-3", `ig_bankman`, vector3(-108.997, 6471.589, 30.634), 224.685, 25.0, {
      {
        icon = "hand-holding-dollar",
        text = "Get Paycheck",
        event = "Finance:Client:Paycheck",
...
AddEventHandler("Finance:Client:Paycheck", function(entity, data)
  exports["hrrp-base"]:CallbacksServer("Finance:Paycheck", {}, function(s)
    if s.total > 0 then
      exports['hrrp-hud']:NotificationSuccess(string.format("You Received $%s For %s Total Minutes Worked", s.total, s.minutes))
    else
      exports['hrrp-hud']:NotificationError("You Need To Work To Earn A Paycheck")
    end
  end)
end)
