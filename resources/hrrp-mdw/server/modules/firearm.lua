...
AddEventHandler("MDT:Server:RegisterCallbacks", function()
  exports['hrrp-base']:CallbacksRegisterServer("MDT:Search:firearm", function(source, data, cb)
  ...
  exports['hrrp-base']:CallbacksRegisterServer("MDT:View:firearm", function(source, data, cb)
    if CheckMDTPermissions(source, false) then
  ...
  exports['hrrp-base']:CallbacksRegisterServer("MDT:Create:firearm-flag", function(source, data, cb)
  ...
  exports['hrrp-base']:CallbacksRegisterServer("MDT:Delete:firearm-flag", function(source, data, cb)
    if CheckMDTPermissions(source, false) then
