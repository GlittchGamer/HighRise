...
AddEventHandler("MDT:Server:RegisterCallbacks", function()
  exports['hrrp-base']:CallbacksRegisterServer("MDT:AddLibraryDocument", function(source, data, cb)
  ...
  exports['hrrp-base']:CallbacksRegisterServer("MDT:RemoveLibraryDocument", function(source, data, cb)
    if CheckMDTPermissions(source, true) then
  ...
  exports['hrrp-base']:CallbacksRegisterServer("MDT:GetLibraryDocuments", function(source, data, cb)
