...
AddEventHandler("MDT:Server:RegisterCallbacks", function()
  exports['hrrp-base']:CallbacksRegisterServer("MDT:Search:warrant", function(source, data, cb)
    cb(MDT.Warrants:Search(data.term, data.page, data.perPage))
  end)

  exports['hrrp-base']:CallbacksRegisterServer("MDT:View:warrant", function(source, data, cb)
    cb(MDT.Warrants:View(data))
  end)

  exports['hrrp-base']:CallbacksRegisterServer("MDT:Update:warrant", function(source, data, cb)
