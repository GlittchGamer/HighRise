...
AddEventHandler("MDT:Server:RegisterCallbacks", function()
  exports['hrrp-base']:CallbacksRegisterServer("MDT:Create:BOLO", function(source, data, cb)
  ...
  exports['hrrp-base']:CallbacksRegisterServer("MDT:Delete:BOLO", function(source, data, cb)
    if CheckMDTPermissions(source, false, 'police') then
  ...
  exports['hrrp-base']:CallbacksRegisterServer("MDT:Create:charge", function(source, data, cb)
  ...
  exports['hrrp-base']:CallbacksRegisterServer("MDT:Update:charge", function(source, data, cb)
    if CheckMDTPermissions(source, true) then
  ...
  exports['hrrp-base']:CallbacksRegisterServer("MDT:Delete:charge", function(source, data, cb)
    if CheckMDTPermissions(source, true) then
  ...
  exports['hrrp-base']:CallbacksRegisterServer("MDT:Create:notice", function(source, data, cb)
    local char = exports['hrrp-base']:FetchSource(source)
  ...
  exports['hrrp-base']:CallbacksRegisterServer("MDT:View:notice", function(source, data, cb)
    cb(MDT.Misc.View:Notice(data))
  end)

  exports['hrrp-base']:CallbacksRegisterServer("MDT:Delete:notice", function(source, data, cb)
