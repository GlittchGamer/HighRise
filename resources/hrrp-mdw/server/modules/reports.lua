...
AddEventHandler("MDT:Server:RegisterCallbacks", function()
  exports['hrrp-base']:CallbacksRegisterServer("MDT:Search:report", function(source, data, cb)
  ...
  exports['hrrp-base']:CallbacksRegisterServer("MDT:Search:report-evidence", function(source, data, cb)
  ...
  exports['hrrp-base']:CallbacksRegisterServer("MDT:Create:report", function(source, data, cb)
    local char = exports['hrrp-base']:FetchSource(source):GetData("Character")
    if CheckMDTPermissions(source, false) then
      data.doc.author = {
  ...
  exports['hrrp-base']:CallbacksRegisterServer("MDT:Update:report", function(source, data, cb)
    local char = exports['hrrp-base']:FetchSource(source):GetData("Character")
  ...
  exports['hrrp-base']:CallbacksRegisterServer("MDT:Delete:report", function(source, data, cb)
  ...
  exports['hrrp-base']:CallbacksRegisterServer("MDT:View:report", function(source, data, cb)
    local char = exports['hrrp-base']:FetchSource(source):GetData("Character")
