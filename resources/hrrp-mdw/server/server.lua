...
setupEvent = AddEventHandler("Core:Shared:Ready", function()
  exports["hrrp-base"]:RequestDependencies("MDT", {
    "Fetch",
...
AddEventHandler("Proxy:Shared:RegisterReady", function()
  exports["hrrp-base"]:RegisterComponent("MDT", _MDT)
end)
...
AddEventHandler('Job:Server:DutyAdd', function(dutyData, source, SID)
  if governmentJobs[dutyData.Id] then
    local job = exports['hrrp-jobs']:JobsPermissionsHasJob(source, dutyData.Id)
    if job then
      _onDutyUsers[source] = job.Id
      local permissions = exports['hrrp-jobs']:JobsPermissionsGetPermissionsFromJob(source, job.Id)
...
AddEventHandler('Jobs:Server:JobUpdate', function(source)
  local dutyData = exports['hrrp-jobs']:JobsDutyGet(source)
...
function CheckMDTPermissions(source, permission, jobId)
  ...
  if mdtUser and (not jobId or jobId == mdtUser or (type(jobId) == 'table' and jobId[mdtUser])) then
    ...
    if type(permission) == 'string' then
      local hasPerm = exports['hrrp-jobs']:JobsPermissionsHasPermissionInJob(source, mdtUser, permission)
      if hasPerm then
        return true, mdtUser
      end
    elseif type(permission) == 'table' then
      local jobPermissions = exports['hrrp-jobs']:JobsPermissionsGetPermissionsFromJob(source, mdtUser)
...
RegisterNetEvent('MDT:Server:OpenPublicRecords', function()
  local src = source
  local dutyData = exports['hrrp-jobs']:JobsDutyGet(src)
...
AddEventHandler("MDT:Server:RegisterCallbacks", function()
  exports['hrrp-base']:CallbacksRegisterServer("MDT:GetHomeData", function(source, data, cb)
  ...
  exports['hrrp-base']:CallbacksRegisterServer("MDT:IssueWarrant", function(source, data, cb)
    local player = exports['hrrp-base']:FetchSource(source)
    local char = player:GetData("Character")
  ...
  exports['hrrp-base']:CallbacksRegisterServer("MDT:SentencePlayer", function(source, data, cb)
    local player = exports['hrrp-base']:FetchSource(source)
    local char = player:GetData("Character")
    ...
    if CheckMDTPermissions(source, false) and data.report and not data.data.sentenced then
      ...
      if data.data.SID and not sentencedSuspects[data.report][data.data.SID] then
        ...
        if data.sentence.revoke or data.points > 0 then
          ...
          local targetPly = exports['hrrp-base']:FetchSID(fetchUser.SID)
          if targetPly then
  ...
  exports['hrrp-base']:CallbacksRegisterServer("MDT:OverturnSentence", function(source, data, cb)
    local player = exports['hrrp-base']:FetchSource(source)
    local char = player:GetData("Character")
  ...
  exports['hrrp-base']:CallbacksRegisterServer("MDT:RosterView", function(source, data, cb)
    print(data.job)
    local query = [[
      SELECT
        Mugshot,
  ...
  exports['hrrp-base']:CallbacksRegisterServer("MDT:FleetDriverFetchOfficers", function(source, data, cb)
  ...
  exports['hrrp-base']:CallbacksRegisterServer("MDT:RosterSelect", function(source, data, cb)
  ...
  exports['hrrp-base']:CallbacksRegisterServer("MDT:RevokeLicenseSuspension", function(source, data, cb)
    local player = exports['hrrp-base']:FetchSource(source)
    local char = player:GetData("Character")
  ...
  exports['hrrp-base']:CallbacksRegisterServer("MDT:RemoveLicensePoints", function(source, data, cb)
    local player = exports['hrrp-base']:FetchSource(source)
    local char = player:GetData("Character")
  ...
  exports['hrrp-base']:CallbacksRegisterServer("MDT:ClearCriminalRecord", function(source, data, cb)
    local player = exports['hrrp-base']:FetchSource(source)
    local char = player:GetData("Character")
  ...
  exports['hrrp-base']:CallbacksRegisterServer("MDT:OpenEvidenceLocker", function(source, caseNum, cb)
  ...
  exports['hrrp-base']:CallbacksRegisterServer("MDT:OpenPersonalLocker", function(source, data, cb)
    local player = exports['hrrp-base']:FetchSource(source)
    local char = player:GetData("Character")
    if char and (exports['hrrp-jobs']:JobsPermissionsHasJob(source, 'police') or exports['hrrp-jobs']:JobsPermissionsHasJob(source, 'ems') or exports['hrrp-jobs']:JobsPermissionsHasJob(source, 'prison')) then
      cb(true)
  ...
  exports['hrrp-base']:CallbacksRegisterServer("MDT:DOCGetPrisoners", function(source, data, cb)
    cb(Jail:GetPrisoners())
  end)

  exports['hrrp-base']:CallbacksRegisterServer("MDT:DOCReduceSentence", function(source, data, cb)
    local player = exports['hrrp-base']:FetchSource(source)
    local char = player:GetData("Character")
    if char and CheckMDTPermissions(source, 'DOC_REDUCTION') and data.reduction then
      local target = exports['hrrp-base']:FetchSID(data.SID)
      if target then
  ...
  local vCooldowns = {}
  exports['hrrp-base']:CallbacksRegisterServer("MDT:DOCRequestVisitation", function(source, data, cb)
    local player = exports['hrrp-base']:FetchSource(source)
    local char = player:GetData("Character")
    if char and (vCooldowns[source] == nil or vCooldowns[source] <= os.time()) and data.SID then
      ...
      if target then
        ...
        if jailed and not jailed.Released then
          local dutyData = exports['hrrp-jobs']:JobsDutyGetDutyData("prison")
