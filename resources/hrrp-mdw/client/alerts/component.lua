...
setupEvent = AddEventHandler("Core:Shared:Ready", function()
  exports["hrrp-base"]:RequestDependencies("MDT", {
    ...
    RegisterCallbacks()
    exports['hrrp-keybinds']:Add("emergency_alerts_toggle", "GRAVE", "keyboard", "Police - Toggle Alerts Panel", function()
...
function RegisterCallbacks()
  exports["hrrp-base"]:CallbacksRegisterClient("EmergencyAlerts:GetStreetName", function(data, cb)
