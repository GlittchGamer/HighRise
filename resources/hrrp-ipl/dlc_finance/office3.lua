...
FinanceOffice3 = {
    ...
    Safe = {
        ...
        Open = function(doorSide)
            ...
            elseif (doorSide:lower() == "right") then FinanceOffice3.Safe.isRightDoorOpen = true
                ...
                Citizen.Trace("[hrrp-ipl] Warning: " .. doorSide .. " is not a correct value. Valid values are:")
        ...
        SetDoorState = function(doorSide, open)
            ...
            if (doorHandle == 0) then
                Citizen.Trace("[hrrp-ipl] Warning: " .. doorSide .. " safe door handle is 0")
                return
            end
    ...
    LoadDefault = function()
        ...
        --FinanceOffice3.Safe.SetDoorState("right", true)

        -- FinanceOffice3.Swag.Enable(FinanceOffice3.Swag.Painting, false, true)
        -- FinanceOffice3.Swag.Enable(FinanceOffice3.Swag.Electronic, false, true)
    end
}
