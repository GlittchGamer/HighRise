function RegisterCallbacks()
  exports['hrrp-base']:CallbacksRegisterServer("Apartment:Validate", function(source, data, cb)
  ...
  exports['hrrp-base']:CallbacksRegisterServer("Apartment:SpawnInside", function(source, data, cb)
    local char = exports['hrrp-base']:FetchSource(source):GetData("Character")
    cb(Apartment:Enter(source, char:GetData("Apartment"), -1, true))
  end)

  exports['hrrp-base']:CallbacksRegisterServer("Apartment:Enter", function(source, data, cb)
    cb(Apartment:Enter(source, data.tier, data.id))
  end)

  exports['hrrp-base']:CallbacksRegisterServer("Apartment:Exit", function(source, data, cb)
    cb(Apartment:Exit(source))
  end)

  exports['hrrp-base']:CallbacksRegisterServer("Apartment:GetVisitRequests", function(source, data, cb)
    cb(Apartment.Reqeusts:Get(source))
  end)

  exports['hrrp-base']:CallbacksRegisterServer("Apartment:Visit", function(source, data, cb)
    cb(Apartment:Enter(source, data.tier, data.id))
  end)
end
