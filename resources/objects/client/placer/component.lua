...
AddEventHandler("exports['objects']:Shared:DependencyUpdate", RetrieveComponents)
...
setupEvent = AddEventHandler("Core:Shared:Ready", function()
  exports['core']:RequestDependencies("ObjectPlacer", {
    "Notification",
    "ObjectPlacer",
  }, function(error)
    if #error > 0 then
      exports['core']:FetchComponent("Logger"):Critical("ObjectPlacer", "Failed To Load All Dependencies")
      return
    end
    RetrieveComponents()
...
_PLACER = {
  ...
  End = function(self)
    ...
    if isValid then
      ...
      exports['hud']:NotificationError("Invalid Object Placement")
    end
  ...
  Cancel = function(self, skipNotification, skipEvent)
    ...
    if not skipNotification then
      exports['hud']:NotificationError("Object Placement Cancelled")
    end
...
AddEventHandler("Proxy:Shared:RegisterReady", function()
  exports['core']:RegisterComponent("ObjectPlacer", _PLACER)
end)
