...
setupEvent = AddEventHandler("Core:Shared:Ready", function()
  exports['core']:RequestDependencies("Objects", {
    ...
    exports['core']:LoggerTrace("Objects", string.format("Restored ^2%s^7 Persistant Props From Database", restored))
    ...
    Chat:RegisterAdminCommand("addobj", function(source, args, rawCommand)
      exports['core']:CallbacksClient(source, "Objects:StartPlacement", {
