...
function LoadTracks(updateClients)
  exports['core']:LoggerTrace('Phone:Redline', 'Loading Race Tracks')
  local fetchRaceTracks = MySQL.query.await('SELECT * FROM `tracks`', {})
  if #fetchRaceTracks == 0 then
    exports['core']:LoggerTrace('Phone:Redline', 'No have been loaded for PD Tracks.')
    fetchedTracks = true
    goto continue
  end
  ...
  exports['core']:LoggerInfo("Phone:Red", string.format("Loading ^2%s^7 PD Racing Tracks", #_tracks))
...
function FinishRace(id)
  ...
  for k, v in pairs(Fetch:All()) do
    ...
    if c ~= nil then
      local dutyData = exports['jobs']:JobsDutyGet(v:GetData("Source"))
...
AddEventHandler("Phone:Server:RegisterCallbacks", function()
  exports['core']:CallbacksRegisterServer("Phone:Redline:GetTrack", function(src, data, cb)
  ...
  exports['core']:CallbacksRegisterServer("Phone:Redline:SaveTrack", function(src, data, cb)
    local char = exports['core']:FetchSource(src):GetData("Character")
    local alias = char:GetData("Alias").redline
  ...
  exports['core']:CallbacksRegisterServer("Phone:Redline:SaveLaptimes", function(src, data, cb)
  ...
  exports['core']:CallbacksRegisterServer("Phone:Redline:DeleteTrack", function(src, data, cb)
    local char = exports['core']:FetchSource(src):GetData("Character")
    local alias = char:GetData("Alias").redline
    if alias ~= nil then
  ...
  exports['core']:CallbacksRegisterServer("Phone:Redline:ResetTrackHistory", function(src, data, cb)
    local char = exports['core']:FetchSource(src):GetData("Character")
    local alias = char:GetData("Alias").redline
    if alias ~= nil then
  ...
  exports['core']:CallbacksRegisterServer("Phone:Redline:CreateRace", function(src, data, cb)
    local char = exports['core']:FetchSource(src):GetData("Character")
  ...
  exports['core']:CallbacksRegisterServer("Phone:Redline:CancelRace", function(src, data, cb)
    local char = exports['core']:FetchSource(src):GetData("Character")
  ...
  exports['core']:CallbacksRegisterServer("Phone:Redline:StartRace", function(src, data, cb)
    local char = exports['core']:FetchSource(src):GetData("Character")
    if
        _races[tonumber(data)].host_id == char:GetData("ID")
        and hasValue(char:GetData("States") or {}, "RACE_DONGLE")
  ...
  exports['core']:CallbacksRegisterServer("Phone:Redline:EndRace", function(src, data, cb)
    local char = exports['core']:FetchSource(src):GetData("Character")
  ...
  exports['core']:CallbacksRegisterServer("Phone:Redline:JoinRace", function(src, data, cb)
    local char = exports['core']:FetchSource(src):GetData("Character")
    local alias = char:GetData("Alias").redline
  ...
  exports['core']:CallbacksRegisterServer("Phone:Redline:LeaveRace", function(src, data, cb)
    local char = exports['core']:FetchSource(src):GetData("Character")
    local alias = char:GetData("Alias").redline
