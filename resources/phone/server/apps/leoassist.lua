...
AddEventHandler("Phone:Server:RegisterCallbacks", function()
  exports['core']:CallbacksRegisterServer("Phone:LEOAsist:SearchPeople", function(source, data, cb)
    cb(MDT.People.Search:People(data))
  end)

  exports['core']:CallbacksRegisterServer("Phone:LEOAsist:SearchVehicles", function(source, data, cb)
