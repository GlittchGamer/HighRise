  ...
  End = function(self, source)
    if _calls[source] ~= nil then
      ...
      if _calls[source].target ~= nil and _calls[_calls[source].target] ~= nil then
        exports['core']:LoggerTrace("Phone", string.format("%s Ending Call With %s", source, _calls[source].target))
...
AddEventHandler("Phone:Server:RegisterCallbacks", function()
  exports['core']:CallbacksRegisterServer("Phone:Phone:CreateCall", function(src, data, cb)
      ...
      if tplyr ~= nil then
        ...
        if target ~= nil and hasValue(target:GetData("States"), "PHONE") then
          if _calls[target:GetData("Source")] == nil then
            ...
            exports['core']:LoggerTrace("Phone", string.format("%s Starting Call With %s", src, tplyr:GetData("Source")))
  ...
  exports['core']:CallbacksRegisterServer("Phone:Phone:AcceptCall", function(src, data, cb)
    local char = exports['core']:FetchSource(src):GetData("Character")
  ...
  exports['core']:CallbacksRegisterServer("Phone:Phone:EndCall", function(src, data, cb)
    Phone.Call:End(src)
  end)

  exports['core']:CallbacksRegisterServer("Phone:Phone:ReadCalls", function(src, data, cb)
    local char = exports['core']:FetchSource(src):GetData("Character")
