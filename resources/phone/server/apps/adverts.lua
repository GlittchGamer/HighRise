...
AddEventHandler("Phone:Server:RegisterCallbacks", function()
	exports['core']:CallbacksRegisterServer("Phone:Adverts:Create", function(source, data, cb)
		Phone.Adverts:Create(source, data)
	end)
	exports['core']:CallbacksRegisterServer("Phone:Adverts:Update", function(source, data, cb)
		Phone.Adverts:Update(source, data)
	end)
	exports['core']:CallbacksRegisterServer("Phone:Adverts:Delete", function(source, data, cb)
