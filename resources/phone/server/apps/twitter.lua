...
AddEventHandler("Phone:Server:RegisterCallbacks", function()
  exports['core']:CallbacksRegisterServer("Phone:Twitter:CreateTweet", function(source, data, cb)
    local src = source
    local char = exports['core']:FetchSource(src):GetData("Character")
    data.source = src
    data._id = #_tweets + 1
  ...
  exports['core']:CallbacksRegisterServer("Phone:Twitter:Favorite", function(source, data, cb)
    local src = source
    local char = exports['core']:FetchSource(src):GetData("Character")
