PHONE.Email = {
  ...
  Send = function(self, serverId, sender, time, subject, body, flags)
    local plyr = exports['core']:FetchSource(serverId)
    if plyr ~= nil then
...
AddEventHandler("Phone:Server:RegisterCallbacks", function()
  ...
  exports['core']:CallbacksRegisterServer("Phone:Email:Read", function(source, data, cb)
    local src = source
    local char = exports['core']:FetchSource(src):GetData("Character")
    cb(Phone.Email:Read(char:GetData("Phone"), data))
  end)

  exports['core']:CallbacksRegisterServer("Phone:Email:Delete", function(source, data, cb)
    local src = source
    local char = exports['core']:FetchSource(src):GetData("Character")
    cb(Phone.Email:Delete(char:GetData("ID"), data))
  end)

  exports['core']:CallbacksRegisterServer("Phone:Email:DeleteExpired", function(source, data, cb)
    local src = source
