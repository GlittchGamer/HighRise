...
function LoadPDTracks(updateClients)
  exports['core']:LoggerTrace('Phone:Blueline', 'Loading PD Tracks')
  local fetchRaceTracks = MySQL.query.await('SELECT * FROM `tracks_pd`', {})
  if #fetchRaceTracks == 0 then
    exports['core']:LoggerTrace('Phone:Blueline', 'No have been loaded for PD Tracks.')
    fetchedTracks = true
    goto continue
  end
  ...
  exports['core']:LoggerInfo("Phone:Blueline", string.format("Loading ^2%s^7 PD Racing Tracks", #_tracks))
...
AddEventHandler("Phone:Server:RegisterCallbacks", function()
  exports['core']:CallbacksRegisterServer("Phone:Blueline:GetTrack", function(src, data, cb)
    for k, v in ipairs(_tracks) do
      if v._id == data then
        cb(v)
        return
  ...
  exports['core']:CallbacksRegisterServer("Phone:Blueline:SaveTrack", function(src, data, cb)
    local char = exports['core']:FetchSource(src):GetData("Character")
    local alias = tostring(char:GetData("Callsign"))
  ...
  exports['core']:CallbacksRegisterServer("Phone:Blueline:SaveLaptimes", function(src, data, cb)
  ...
  exports['core']:CallbacksRegisterServer("Phone:Blueline:DeleteTrack", function(src, data, cb)
    local char = exports['core']:FetchSource(src):GetData("Character")
    local alias = tostring(char:GetData("Callsign"))
    if alias ~= nil then
  ...
  exports['core']:CallbacksRegisterServer("Phone:Blueline:ResetTrackHistory", function(src, data, cb)
    local char = exports['core']:FetchSource(src):GetData("Character")
    local alias = tostring(char:GetData("Callsign"))
    if alias ~= nil then
  ...
  exports['core']:CallbacksRegisterServer("Phone:Blueline:CreateRace", function(src, data, cb)
    local char = exports['core']:FetchSource(src):GetData("Character")
    if exports['jobs']:JobsPermissionsHasJob(src, "police", false, false, false, false, "PD_MANAGE_TRIALS") then
  ...
  exports['core']:CallbacksRegisterServer("Phone:Blueline:CancelRace", function(src, data, cb)
    local char = exports['core']:FetchSource(src):GetData("Character")
  ...
  exports['core']:CallbacksRegisterServer("Phone:Blueline:StartRace", function(src, data, cb)
    local char = exports['core']:FetchSource(src):GetData("Character")
    if _races[tonumber(data)].host_id == char:GetData("ID") then
  ...
  exports['core']:CallbacksRegisterServer("Phone:Blueline:EndRace", function(src, data, cb)
    local char = exports['core']:FetchSource(src):GetData("Character")
  ...
  exports['core']:CallbacksRegisterServer("Phone:Blueline:JoinRace", function(src, data, cb)
    local char = exports['core']:FetchSource(src):GetData("Character")
    local alias = tostring(char:GetData("Callsign"))
    ...
    if exports['jobs']:JobsPermissionsHasJob(src, "police") and alias ~= nil and _races[tonumber(data)].state == 0 then
      _races[tonumber(data)].racers[alias] = {
        source = src,
        sid = char:GetData("SID"),
        Lap = 1,
  ...
  exports['core']:CallbacksRegisterServer("Phone:Blueline:LeaveRace", function(src, data, cb)
    local char = exports['core']:FetchSource(src):GetData("Character")
    local alias = tostring(char:GetData("Callsign"))
