...
AddEventHandler("Phone:Server:RegisterCallbacks", function()
  exports['core']:CallbacksRegisterServer("Phone:Messages:SendMessage", function(source, data, cb)
    local src = source
  ...
  exports['core']:CallbacksRegisterServer("Phone:Messages:ReadConvo", function(source, data, cb)
    local src = source
    local char = exports['core']:FetchSource(src):GetData("Character")
    Phone.Messages:Read(char:GetData("Phone"), data)
  end)

  exports['core']:CallbacksRegisterServer("Phone:Messages:DeleteConvo", function(source, data, cb)
    local src = source
    local char = exports['core']:FetchSource(src):GetData("Character")
