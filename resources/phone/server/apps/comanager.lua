...
PHONE.CoManager = {
  FetchAllAccessibleRosters = function(self, source)
    local playersJobs = exports['jobs']:JobsPermissionsGetJobs(source)
  ...
  FetchTimeWorked = function(self, source, jobId)
    if exports['jobs']:JobsPermissionsHasJob(source, jobId, false, false, false, false, "JOB_MANAGEMENT") then
      local onlineCharacters = {}
...
AddEventHandler("Phone:Server:RegisterCallbacks", function()
  exports['core']:CallbacksRegisterServer("Phone:CoManager:QuitJob", function(source, data, cb)
    local jobId = data.JobId

    if jobId and not hasValue(_blacklistedJobs, jobId) then
      if exports['jobs']:JobsPermissionsIsOwner(source, jobId) then
  ...
  exports['core']:CallbacksRegisterServer("Phone:CoManager:FetchRoster", function(source, data, cb)
  ...
  exports['core']:CallbacksRegisterServer("Phone:CoManager:FetchTimeWorked", function(source, data, cb)
    cb(Phone.CoManager:FetchTimeWorked(source, data))
  end)

  exports['core']:CallbacksRegisterServer("Phone:CoManager:RenameCompany", function(source, data, cb)
  ...
  exports['core']:CallbacksRegisterServer("Phone:CoManager:HireEmployee", function(source, data, cb)
    ...
    if (not workplace or (workplace and workplace.Id)) and grade and grade.Id and Jobs:DoesExist(jobId, (workplace and workplace.Id or false), grade.Id) then
      local playerJobData = exports['jobs']:JobsPermissionsHasJob(source, jobId)
      local playerJobPerms = exports['jobs']:JobsPermissionsGetPermissionsFromJob(source, jobId)
      local playerIsOwner = exports['jobs']:JobsPermissionsIsOwner(source, jobId)
  ...
  exports['core']:CallbacksRegisterServer("Phone:CoManager:FireEmployee", function(source, data, cb)
  ...
  exports['core']:CallbacksRegisterServer("Phone:CoManager:UpdateEmployee", function(source, data, cb)
    local stateId, jobId, workplace, grade = math.tointeger(data.SID), data.Job.Id, data.Job.Workplace, data.Job.Grade
    if (not workplace or (workplace and workplace.Id) and grade and grade.Id) and Jobs:DoesExist(jobId, (workplace and workplace.Id or false), grade.Id) then
      local job = Jobs:Get(jobId)
      local playerJobData = exports['jobs']:JobsPermissionsHasJob(source, jobId)
  ...
  exports['core']:CallbacksRegisterServer("Phone:CoManager:EditWorkplace", function(source, data, cb)
  ...
  exports['core']:CallbacksRegisterServer("Phone:CoManager:CreateGrade", function(source, data, cb)
  ...
  exports['core']:CallbacksRegisterServer("Phone:CoManager:EditGrade", function(source, data, cb)
  ...
  exports['core']:CallbacksRegisterServer("Phone:CoManager:DeleteGrade", function(source, data, cb)
  ...
  exports['core']:CallbacksRegisterServer("Phone:CoManager:PurchaseUpgrade", function(source, data, cb)
    -- TODO
    cb({ success = false, code = "ERROR" })
  end)

  exports['core']:CallbacksRegisterServer("Phone:CoManager:AcceptHire", function(source, data, cb)
  ...
  exports['core']:CallbacksRegisterServer("Phone:CoManager:DeclineHire", function(source, data, cb)
    local player = exports['core']:FetchSource(source)
    if player then
      local char = player:GetData("Character")
      if char then
  ...
  exports['core']:CallbacksRegisterServer("Phone:CoManager:DisbandCompany", function(source, data, cb)
    -- ! Disabled
    cb({ success = false, code = "ERROR" })
  end)

  -- TODO
  -- exports['core']:CallbacksRegisterServer("Phone:CoManager:BeginTransfer", function(source, data, cb)
  -- 	local plyr = exports['core']:FetchSource(source)
  -- 	local char = plyr:GetData("Character")
  ...
  -- exports['core']:CallbacksRegisterServer("Phone:CoManager:AcceptXfer", function(source, data, cb)
  -- 	local plyr = exports['core']:FetchSource(source)
  -- 	local char = plyr:GetData("Character")
  ...
  -- exports['core']:CallbacksRegisterServer("Phone:CoManager:DeclineXfer", function(source, data, cb)
  -- 	local plyr = exports['core']:FetchSource(source)
  -- 	local char = plyr:GetData("Character")
  -- 	local xfer = _pendingXfers[char:GetData("ID")]
