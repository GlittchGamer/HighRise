AddEventHandler("Phone:Server:RegisterCallbacks", function()
  exports['core']:CallbacksRegisterServer("Phone:Home:CreateDigiKey", function(source, data, cb)
      ...
      if property ~= nil then
        ...
        if mykey ~= nil and mykey.Owner then
          if data.updating then
            ...
            local tplyr = exports['core']:FetchSID(data.target)
            if tplyr ~= nil then
  ...
  exports['core']:CallbacksRegisterServer("Phone:Home:RevokeDigiKey", function(source, data, cb)
    local char = exports['core']:FetchSource(source):GetData("Character")
    if char ~= nil then
      local property = Properties:Get(data.id)
      if property ~= nil then
  ...
  exports['core']:CallbacksRegisterServer("Phone:Home:RemoveMyKey", function(source, data, cb)
    local char = exports['core']:FetchSource(source):GetData("Character")
    if char ~= nil then
      local property = Properties:Get(data.id)
      if property ~= nil then
  ...
  exports['core']:CallbacksRegisterServer("Phone:Home:LockProperty", function(source, data, cb)
    local char = exports['core']:FetchSource(source):GetData("Character")
    if char ~= nil then
      local property = Properties:Get(data.id)
      if property ~= nil then
