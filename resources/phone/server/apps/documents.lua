...
AddEventHandler("Phone:Server:RegisterCallbacks", function()
  exports['core']:CallbacksRegisterServer("Phone:Documents:Create", function(source, data, cb)
    cb(Phone.Documents:Create(source, data))
  end)

  exports['core']:CallbacksRegisterServer("Phone:Documents:Edit", function(source, data, cb)
    cb(Phone.Documents:Edit(source, data.id, data.data))
  end)

  exports['core']:CallbacksRegisterServer("Phone:Documents:Delete", function(source, data, cb)
    cb(Phone.Documents:Delete(source, data))
  end)

  exports['core']:CallbacksRegisterServer("Phone:Documents:Refresh", function(source, data, cb)
    local char = exports['core']:FetchSource(source):GetData("Character")
    exports.oxmysql:execute(
      'SELECT * FROM character_documents WHERE owner = ? OR JSON_CONTAINS(sharedWith, JSON_OBJECT("ID", ?))',
      { char:GetData("ID"), char:GetData("ID") },
  ...
  exports['core']:CallbacksRegisterServer("Phone:Documents:Share", function(source, data, cb)
  ...
  exports['core']:CallbacksRegisterServer("Phone:Documents:RecieveShare", function(source, data, cb)
    if data then
      if data.isCopy then
  ...
  exports['core']:CallbacksRegisterServer("Phone:Documents:Sign", function(source, data, cb)
    local char = exports['core']:FetchSource(source):GetData("Character")
    if char then
      exports.oxmysql:execute(
