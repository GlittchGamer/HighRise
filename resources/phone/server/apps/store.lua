...
AddEventHandler("Phone:Server:RegisterCallbacks", function()
  exports['core']:CallbacksRegisterServer("Phone:Store:Install:Check", function(src, data, cb)
    local char = exports['core']:FetchSource(src):GetData("Character")
    Citizen.CreateThread(function()
      cb(Phone.Store.Install:Check(data))
    end)
  end)
  exports['core']:CallbacksRegisterServer("Phone:Store:Install:Do", function(src, data, cb)
    local char = exports['core']:FetchSource(src):GetData("Character")
    Citizen.CreateThread(function()
  ...
  exports['core']:CallbacksRegisterServer("Phone:Store:Uninstall:Check", function(src, data, cb)
    local char = exports['core']:FetchSource(src):GetData("Character")
    Citizen.CreateThread(function()
      cb(Phone.Store.Uninstall:Check(data))
    end)
  end)
  exports['core']:CallbacksRegisterServer("Phone:Store:Uninstall:Do", function(src, data, cb)
    local char = exports['core']:FetchSource(src):GetData("Character")
    Citizen.CreateThread(function()
