AddEventHandler("Phone:Server:RegisterCallbacks", function()
  exports['core']:CallbacksRegisterServer("Phone:PingEm:SendPing", function(source, data, cb)
    local char = exports['core']:FetchSource(source):GetData("Character")
    local tPlayer = exports['core']:FetchSID(tonumber(data.target))
  ...
  exports['core']:CallbacksRegisterServer("Phone:PingEm:GetFeedback", function(source, data, cb)
    if data.result then
