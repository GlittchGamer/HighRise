...
RegisterNUICallback("GetIRCMessages", function(data, cb)
	exports['core']:CallbacksServer("Phone:IRC:GetMessages", data, cb)
end)
RegisterNUICallback("SendIRCMessage", function(data, cb)
	cb("OK")
	exports['core']:CallbacksServer("Phone:IRC:SendMessage", data)
end)
RegisterNUICallback("JoinIRCChannel", function(data, cb)
	exports['core']:CallbacksServer("Phone:IRC:JoinChannel", data, cb)
end)
RegisterNUICallback("LeaveIRCChannel", function(data, cb)
	cb("OK")
	exports['core']:CallbacksServer("Phone:IRC:LeaveChannel", data)
end)
