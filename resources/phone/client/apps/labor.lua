...
RegisterNUICallback("CreateWorkgroup", function(data, cb)
	exports['core']:CallbacksServer("Phone:Labor:CreateWorkgroup", data, cb)
end)

RegisterNUICallback("JoinWorkgroup", function(data, cb)
	exports['core']:CallbacksServer("Phone:Labor:JoinWorkgroup", data, cb)
end)

RegisterNUICallback("DisbandWorkgroup", function(data, cb)
	exports['core']:CallbacksServer("Phone:Labor:DisbandWorkgroup", data, cb)
end)

RegisterNUICallback("LeaveWorkgroup", function(data, cb)
	exports['core']:CallbacksServer("Phone:Labor:LeaveWorkgroup", data, cb)
end)

RegisterNUICallback("StartLaborJob", function(data, cb)
	exports['core']:CallbacksServer("Phone:Labor:StartLaborJob", data, cb)
end)

RegisterNUICallback("QuitLaborJob", function(data, cb)
	exports['core']:CallbacksServer("Phone:Labor:QuitLaborJob", data, cb)
end)
