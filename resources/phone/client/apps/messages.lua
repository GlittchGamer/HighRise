...
RegisterNUICallback("SendMessage", function(data, cb)
	cb("OK")
	exports['core']:CallbacksServer("Phone:Messages:SendMessage", data)
end)
RegisterNUICallback("ReadConvo", function(data, cb)
	cb("OK")
	exports['core']:CallbacksServer("Phone:Messages:ReadConvo", data)
end)
RegisterNUICallback("DeleteConvo", function(data, cb)
	cb("OK")
	exports['core']:CallbacksServer("Phone:Messages:DeleteConvo", data)
end)
