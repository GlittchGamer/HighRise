...
-- 		while _loggedIn do
-- 			exports['core']:CallbacksServer("Phone:Email:DeleteExpired", {}, function(ids)
...
RegisterNUICallback("ReadEmail", function(data, cb)
  cb("OK")
  exports['core']:CallbacksServer("Phone:Email:Read", data)
end)

RegisterNUICallback("DeleteEmail", function(data, cb)
  cb("OK")
  exports['core']:CallbacksServer("Phone:Email:Delete", data, function(res)
    cb(res)
  end)
end)
