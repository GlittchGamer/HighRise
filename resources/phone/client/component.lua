          ...
          and (
            ...
            or (
              (
                ...
                and exports['jobs']:JobsPermissionsHasJob(
                  appdata.restricted.job,
              ...
              or (appdata.restricted.jobPermission and exports['jobs']:JobsPermissionsHasJob(
                appdata.restricted.job,
                appdata.restricted.workplace,
                appdata.restricted.grade,
                nil,
...
AddEventHandler("Proxy:Shared:RegisterReady", function()
  exports['core']:RegisterComponent("Phone", PHONE)
end)
