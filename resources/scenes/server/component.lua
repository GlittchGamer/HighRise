...
setupEvent = AddEventHandler("Core:Shared:Ready", function()
  exports['core']:RequestDependencies('Scenes', {
    ...
    if #error > 0 then
      exports['core']:FetchComponent('Logger'):Critical('Scenes', 'Failed To Load All Dependencies')
      return
    end
    RetrieveComponents()
    ...
    exports['core']:CallbacksRegisterServer('Scenes:Create', function(source, data, cb)
    ...
    exports['core']:CallbacksRegisterServer('Scenes:Delete', function(source, sceneId, cb)
      local player = exports['core']:FetchSource(source)
    ...
    exports['core']:CallbacksRegisterServer('Scenes:CanEdit', function(source, sceneId, cb)
      local player = exports['core']:FetchSource(source)
      local scene = _loadedScenes[sceneId]
      local timeStamp = GetGameTimer()
    ...
    exports['core']:CallbacksRegisterServer('Scenes:Edit', function(source, data, cb)
      local player = exports['core']:FetchSource(source)
