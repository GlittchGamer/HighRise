-- AddEventHandler("Characters:Client:Spawn", function() --!This is poorly optimized
-- 	Citizen.CreateThread(function()
-- 		while _loggedIn do
-- 			exports["hrrp-base"]:CallbacksServer("Phone:Email:DeleteExpired", {}, function(ids)
...
RegisterNUICallback("ReadEmail", function(data, cb)
  cb("OK")
  exports["hrrp-base"]:CallbacksServer("Phone:Email:Read", data)
end)

RegisterNUICallback("DeleteEmail", function(data, cb)
  cb("OK")
  exports["hrrp-base"]:CallbacksServer("Phone:Email:Delete", data, function(res)
    cb(res)
  end)
end)
