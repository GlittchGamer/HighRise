...
PHONE.Call = {
	Create = function(self, data)
		...
		exports["hrrp-base"]:CallbacksServer("Phone:Phone:CreateCall", data, function(status)
			if status then
				_call = {
					id = 1,
					state = 0,
	...
	Accept = function(self)
		...
		exports["hrrp-base"]:CallbacksServer("Phone:Phone:AcceptCall", _call)
	end,
	End = function(self)
		_calling = false
		fucksound()
		exports["hrrp-base"]:CallbacksServer("Phone:Phone:EndCall")
	end,
	Read = function(self)
		exports["hrrp-base"]:CallbacksServer("Phone:Phone:ReadCalls")
	end,
