...
AddEventHandler("Phone:Client:CoManager:AcceptHire", function()
	exports["hrrp-base"]:CallbacksServer("Phone:CoManager:AcceptHire", {}, function(time, state)
		if state then
...
AddEventHandler("Phone:Client:CoManager:DeclineHire", function()
	exports["hrrp-base"]:CallbacksServer("Phone:CoManager:DeclineHire", {}, function(time)
...
AddEventHandler("Phone:Client:CoManager:AcceptXfer", function()
	exports["hrrp-base"]:CallbacksServer("Phone:CoManager:AcceptXfer", {}, function(time, state)
		if state then
...
AddEventHandler("Phone:Client:CoManager:DeclineXfer", function()
	exports["hrrp-base"]:CallbacksServer("Phone:CoManager:DeclineXfer", {}, function(time)
...
RegisterNUICallback("QuitJob", function(data, cb)
	exports["hrrp-base"]:CallbacksServer("Phone:CoManager:QuitJob", data, cb)
end)

RegisterNUICallback("FetchRoster", function(data, cb)
	exports["hrrp-base"]:CallbacksServer("Phone:CoManager:FetchRoster", data, cb)
end)

RegisterNUICallback("FetchTimeWorked", function(data, cb)
	exports["hrrp-base"]:CallbacksServer("Phone:CoManager:FetchTimeWorked", data, cb)
end)

RegisterNUICallback("RenameCompany", function(data, cb)
	exports["hrrp-base"]:CallbacksServer("Phone:CoManager:RenameCompany", data, cb)
end)

RegisterNUICallback("HireEmployee", function(data, cb)
	exports["hrrp-base"]:CallbacksServer("Phone:CoManager:HireEmployee", data, cb)
end)

RegisterNUICallback("FireEmployee", function(data, cb)
	exports["hrrp-base"]:CallbacksServer("Phone:CoManager:FireEmployee", data, cb)
end)

RegisterNUICallback("UpdateEmployee", function(data, cb)
	exports["hrrp-base"]:CallbacksServer("Phone:CoManager:UpdateEmployee", data, cb)
end)

RegisterNUICallback("EditWorkplace", function(data, cb)
	exports["hrrp-base"]:CallbacksServer("Phone:CoManager:EditWorkplace", data, cb)
end)

RegisterNUICallback("CreateGrade", function(data, cb)
	exports["hrrp-base"]:CallbacksServer("Phone:CoManager:CreateGrade", data, cb)
end)

RegisterNUICallback("EditGrade", function(data, cb)
	exports["hrrp-base"]:CallbacksServer("Phone:CoManager:EditGrade", data, cb)
end)

RegisterNUICallback("DeleteGrade", function(data, cb)
	exports["hrrp-base"]:CallbacksServer("Phone:CoManager:DeleteGrade", data, cb)
end)

RegisterNUICallback("PurchaseUpgrade", function(data, cb)
	exports["hrrp-base"]:CallbacksServer("Phone:CoManager:PurchaseUpgrade", data, cb)
end)

RegisterNUICallback("DisbandCompany", function(data, cb)
	exports["hrrp-base"]:CallbacksServer("Phone:CoManager:DisbandCompany", data, cb)
end)

RegisterNUICallback("TransferCompany", function(data, cb)
	exports["hrrp-base"]:CallbacksServer("Phone:CoManager:TransferCompany", data, cb)
end)
