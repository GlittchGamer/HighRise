...
RegisterNUICallback("Home:CreateDigiKey", function(data, cb)
	exports["hrrp-base"]:CallbacksServer("Phone:Home:CreateDigiKey", data, cb)
end)

RegisterNUICallback("Home:RevokeDigiKey", function(data, cb)
	exports["hrrp-base"]:CallbacksServer("Phone:Home:RevokeDigiKey", data, cb)
end)

RegisterNUICallback("Home:RemoveMyKey", function(data, cb)
	exports["hrrp-base"]:CallbacksServer("Phone:Home:RemoveMyKey", data, cb)
end)

RegisterNUICallback("Home:LockProperty", function(data, cb)
	exports["hrrp-base"]:CallbacksServer("Phone:Home:LockProperty", data, cb)
end)
...
RegisterNUICallback("PurchasePropertyInterior", function(data, cb)
	-- data.int
	exports["hrrp-base"]:CallbacksServer("Properties:ChangeInterior", data, cb)
end)

RegisterNUICallback("PurchasePropertyUpgrade", function(data, cb)
	-- data.upgrade
	exports["hrrp-base"]:CallbacksServer("Properties:Upgrade", data, cb)
end)
