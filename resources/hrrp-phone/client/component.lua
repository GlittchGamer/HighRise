          ...
          and (
            ...
            or (
              (
                ...
                and exports['hrrp-jobs']:JobsPermissionsHasJob(
                  appdata.restricted.job,
              ...
              or (appdata.restricted.jobPermission and exports['hrrp-jobs']:JobsPermissionsHasJob(
                appdata.restricted.job,
                appdata.restricted.workplace,
                appdata.restricted.grade,
                nil,
...
AddEventHandler("Proxy:Shared:RegisterReady", function()
  exports["hrrp-base"]:RegisterComponent("Phone", PHONE)
end)
