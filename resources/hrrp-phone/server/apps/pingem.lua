AddEventHandler("Phone:Server:RegisterCallbacks", function()
  exports['hrrp-base']:CallbacksRegisterServer("Phone:PingEm:SendPing", function(source, data, cb)
    local char = exports['hrrp-base']:FetchSource(source):GetData("Character")
    local tPlayer = exports['hrrp-base']:FetchSID(tonumber(data.target))
  ...
  exports['hrrp-base']:CallbacksRegisterServer("Phone:PingEm:GetFeedback", function(source, data, cb)
    if data.result then
