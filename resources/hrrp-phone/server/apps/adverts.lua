...
AddEventHandler("Phone:Server:RegisterCallbacks", function()
	exports['hrrp-base']:CallbacksRegisterServer("Phone:Adverts:Create", function(source, data, cb)
		Phone.Adverts:Create(source, data)
	end)
	exports['hrrp-base']:CallbacksRegisterServer("Phone:Adverts:Update", function(source, data, cb)
		Phone.Adverts:Update(source, data)
	end)
	exports['hrrp-base']:CallbacksRegisterServer("Phone:Adverts:Delete", function(source, data, cb)
