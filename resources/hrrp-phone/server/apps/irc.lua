...
AddEventHandler("Phone:Server:RegisterCallbacks", function()
  exports['hrrp-base']:CallbacksRegisterServer("Phone:IRC:GetMessages", function(source, data, cb)
    local src = source
  ...
  exports['hrrp-base']:CallbacksRegisterServer("Phone:IRC:SendMessage", function(source, data, cb)
    local src = source
    local char = exports['hrrp-base']:FetchSource(src):GetData("Character")
  ...
  exports['hrrp-base']:CallbacksRegisterServer("Phone:IRC:JoinChannel", function(source, data, cb)
    local src = source
    local char = exports['hrrp-base']:FetchSource(src):GetData("Character")
    local data2 = {
      slug = data.slug,
  ...
  exports['hrrp-base']:CallbacksRegisterServer("Phone:IRC:LeaveChannel", function(source, data, cb)
    local src = source
    local char = exports['hrrp-base']:FetchSource(src):GetData("Character")
