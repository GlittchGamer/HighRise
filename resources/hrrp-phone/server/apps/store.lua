...
AddEventHandler("Phone:Server:RegisterCallbacks", function()
  exports['hrrp-base']:CallbacksRegisterServer("Phone:Store:Install:Check", function(src, data, cb)
    local char = exports['hrrp-base']:FetchSource(src):GetData("Character")
    Citizen.CreateThread(function()
      cb(Phone.Store.Install:Check(data))
    end)
  end)
  exports['hrrp-base']:CallbacksRegisterServer("Phone:Store:Install:Do", function(src, data, cb)
    local char = exports['hrrp-base']:FetchSource(src):GetData("Character")
    Citizen.CreateThread(function()
  ...
  exports['hrrp-base']:CallbacksRegisterServer("Phone:Store:Uninstall:Check", function(src, data, cb)
    local char = exports['hrrp-base']:FetchSource(src):GetData("Character")
    Citizen.CreateThread(function()
      cb(Phone.Store.Uninstall:Check(data))
    end)
  end)
  exports['hrrp-base']:CallbacksRegisterServer("Phone:Store:Uninstall:Do", function(src, data, cb)
    local char = exports['hrrp-base']:FetchSource(src):GetData("Character")
    Citizen.CreateThread(function()
