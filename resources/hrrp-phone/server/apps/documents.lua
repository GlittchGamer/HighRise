...
AddEventHandler("Phone:Server:RegisterCallbacks", function()
  exports['hrrp-base']:CallbacksRegisterServer("Phone:Documents:Create", function(source, data, cb)
    cb(Phone.Documents:Create(source, data))
  end)

  exports['hrrp-base']:CallbacksRegisterServer("Phone:Documents:Edit", function(source, data, cb)
    cb(Phone.Documents:Edit(source, data.id, data.data))
  end)

  exports['hrrp-base']:CallbacksRegisterServer("Phone:Documents:Delete", function(source, data, cb)
    cb(Phone.Documents:Delete(source, data))
  end)

  exports['hrrp-base']:CallbacksRegisterServer("Phone:Documents:Refresh", function(source, data, cb)
    local char = exports['hrrp-base']:FetchSource(source):GetData("Character")
    exports.oxmysql:execute(
      'SELECT * FROM character_documents WHERE owner = ? OR JSON_CONTAINS(sharedWith, JSON_OBJECT("ID", ?))',
      { char:GetData("ID"), char:GetData("ID") },
  ...
  exports['hrrp-base']:CallbacksRegisterServer("Phone:Documents:Share", function(source, data, cb)
  ...
  exports['hrrp-base']:CallbacksRegisterServer("Phone:Documents:RecieveShare", function(source, data, cb)
    if data then
      if data.isCopy then
  ...
  exports['hrrp-base']:CallbacksRegisterServer("Phone:Documents:Sign", function(source, data, cb)
    local char = exports['hrrp-base']:FetchSource(source):GetData("Character")
    if char then
      exports.oxmysql:execute(
