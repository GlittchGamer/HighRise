local _services = {
  {
    ...
    Disclaimer =
    "You may not purchase this if you already own a company.<br /><br />You will be able to name your company via the Company Management app after purchasing this service.",
  },
}

AddEventHandler("Phone:Server:RegisterCallbacks", function()
  exports['hrrp-base']:CallbacksRegisterServer("Phone:Govt:PurchaseService", function(source, data, cb)
    local char = exports['hrrp-base']:FetchSource(source):GetData("Character")

    if data == 1 then
      -- TODO: Add Billing

      if exports['hrrp-jobs']:JobsPermissionsIsOwnerOfCompany(source) then
