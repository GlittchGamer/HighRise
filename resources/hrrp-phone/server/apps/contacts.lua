...
AddEventHandler("Phone:Server:RegisterCallbacks", function()
  exports['hrrp-base']:CallbacksRegisterServer("Phone:Contacts:Create", function(source, data, cb)
    local char = exports['hrrp-base']:FetchSource(source):GetData("Character")
    if char ~= nil then
  ...
  exports['hrrp-base']:CallbacksRegisterServer("Phone:Contacts:Update", function(source, data, cb)
    if data.id == nil then
      return cb(nil)
    end
  ...
  exports['hrrp-base']:CallbacksRegisterServer("Phone:Contacts:Delete", function(source, data, cb)
    local char = exports['hrrp-base']:FetchSource(source):GetData("Character")
    if char ~= nil then
      local sid = char:GetData("ID")
