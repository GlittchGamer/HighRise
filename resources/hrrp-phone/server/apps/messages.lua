...
AddEventHandler("Phone:Server:RegisterCallbacks", function()
  exports['hrrp-base']:CallbacksRegisterServer("Phone:Messages:SendMessage", function(source, data, cb)
    local src = source
  ...
  exports['hrrp-base']:CallbacksRegisterServer("Phone:Messages:ReadConvo", function(source, data, cb)
    local src = source
    local char = exports['hrrp-base']:FetchSource(src):GetData("Character")
    Phone.Messages:Read(char:GetData("Phone"), data)
  end)

  exports['hrrp-base']:CallbacksRegisterServer("Phone:Messages:DeleteConvo", function(source, data, cb)
    local src = source
    local char = exports['hrrp-base']:FetchSource(src):GetData("Character")
