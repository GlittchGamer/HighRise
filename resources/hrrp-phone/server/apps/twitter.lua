...
AddEventHandler("Phone:Server:RegisterCallbacks", function()
  exports['hrrp-base']:CallbacksRegisterServer("Phone:Twitter:CreateTweet", function(source, data, cb)
    local src = source
    local char = exports['hrrp-base']:FetchSource(src):GetData("Character")
    data.source = src
    data._id = #_tweets + 1
  ...
  exports['hrrp-base']:CallbacksRegisterServer("Phone:Twitter:Favorite", function(source, data, cb)
    local src = source
    local char = exports['hrrp-base']:FetchSource(src):GetData("Character")
