...
function RetrieveComponents()
  ...
  Player = exports['core']:FetchComponent('Player')
...
setupEvent = AddEventHandler("Core:Shared:Ready", function()
  exports['core']:RequestDependencies('Radar', {
    ...
    exports['keybinds']:Add('radar_lock', 'MULTIPLY', 'keyboard', 'Radar - Toggle Fast Lock', function()
    ...
    exports['keybinds']:Add('radar_remote', 'DIVIDE', 'keyboard', 'Radar - Open Menu/Remote', function()
      OpenRadarRemote()
    end)

    exports['keybinds']:Add('radar_toggle', 'SUBTRACT', 'keyboard', 'Radar - Show/Hide', function()
      ToggleRadarIsDisabled()
    end)

    exports['keybinds']:Add('heli_toggle', 'E', 'keyboard', 'Heli Camera - Toggle', function()
      StartHeliCamera()
    end)

    exports['keybinds']:Add('heli_lock', 'SPACE', 'keyboard', 'Heli Camera - Lock On/Off', function()
      LockOnHeliCamera()
    end)

    exports['keybinds']:Add('heli_camera', 'MOUSE_RIGHT', 'MOUSE_BUTTON', 'Heli Camera - Change Mode', function()
      ChangeVision()
    end)
