...
function RetrieveComponents()
  ...
  Player = exports['hrrp-base']:FetchComponent('Player')
...
setupEvent = AddEventHandler("Core:Shared:Ready", function()
  exports['hrrp-base']:RequestDependencies('Radar', {
    ...
    exports['hrrp-keybinds']:Add('radar_lock', 'MULTIPLY', 'keyboard', 'Radar - Toggle Fast Lock', function()
    ...
    exports['hrrp-keybinds']:Add('radar_remote', 'DIVIDE', 'keyboard', 'Radar - Open Menu/Remote', function()
      OpenRadarRemote()
    end)

    exports['hrrp-keybinds']:Add('radar_toggle', 'SUBTRACT', 'keyboard', 'Radar - Show/Hide', function()
      ToggleRadarIsDisabled()
    end)

    exports['hrrp-keybinds']:Add('heli_toggle', 'E', 'keyboard', 'Heli Camera - Toggle', function()
      StartHeliCamera()
    end)

    exports['hrrp-keybinds']:Add('heli_lock', 'SPACE', 'keyboard', 'Heli Camera - Lock On/Off', function()
      LockOnHeliCamera()
    end)

    exports['hrrp-keybinds']:Add('heli_camera', 'MOUSE_RIGHT', 'MOUSE_BUTTON', 'Heli Camera - Change Mode', function()
      ChangeVision()
    end)
