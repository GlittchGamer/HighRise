...
setupEvent = AddEventHandler("Core:Shared:Ready", function()
  exports["hrrp-base"]:RequestDependencies("Island", {
    "Utils",
    "Callbacks",
    "Logger",
    "Polyzone",
    ...
    exports['hrrp-polyzone']:PolyZoneCreateCircle('cayo_perico', vector3(4965.17, -5693.89, 200.86), 2500.0, {})

    exports['hrrp-polyzone']:PolyZoneCreatePoly(
      'cayo_perico_weather',
      {
...
AddEventHandler('Polyzone:Enter', function(id, point, insideZone, data)
  if id == 'cayo_perico' and not inCayoPerico then
    ...
    exports['hrrp-base']:LoggerTrace('Island', 'Entering Island Zone')
  end
end)
...
AddEventHandler('Polyzone:Exit', function(id, point, insideZone, data)
  if id == 'cayo_perico' and inCayoPerico then
    ...
    inCayoPerico = false
    exports['hrrp-base']:LoggerTrace('Island', 'Leaving Island Zone')
