...
--                 return exports['hrrp-hud']:NotificationError('You can\'t lockpick this door, it\'s too strong')
--             elseif Doors:IsAuthorized(doorData) then
--                 return exports['hrrp-hud']:NotificationError('You can\'t lockpick a door that you have the keys for...')
--             elseif not IsAbleToLockpick(showingDoorInfo) then
--                 return exports['hrrp-hud']:NotificationError('You have already tried lockpicking this door multiple times, it doesn\'t work...')
--             end
...
--                             exports["hrrp-base"]:CallbacksServer('Inventory:Server:RemoveItem', { item = item }, function(done)
--                                 exports['hrrp-hud']:NotificationError('Your lockpick broke trying to pick that lock')
--                             end)
--                         else
--                             exports['hrrp-hud']:NotificationError('You were unable to pick that lock')
--                         end
--                     end)
--                 end
...
--                 }, function(status)
--                     if not status then
--                         exports["hrrp-base"]:CallbacksServer('Doors:ToggleLock', { doorId = showingDoorInfo, state = false, bylockpick = true }, function(success, newState)
--                             if success and not newState then
--                                 exports['hrrp-hud']:NotificationSuccess('You lockpicked the door, it is now open')
--                             end
--                         end)
--                     end
--                 end)
