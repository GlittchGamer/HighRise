    ...
    Citizen.CreateThread(function()
      while creationHelper do
        if creationHelperEntity and creationHelperEntityCoords then
          DrawMarker(28, creationHelperEntityCoords.x, creationHelperEntityCoords.y, creationHelperEntityCoords.z, 0.0, 0.0, 0.0, 0.0, 180.0, 0.0, 0.6, 0.6, 0.6,
            255, 0, 0, 100, false, true, 2, nil, nil, false)
        else
          Citizen.Wait(1000)
        end
        Citizen.Wait(5)
...
AddEventHandler('Keybinds:Client:KeyUp:primary_action', function()
  if creationHelper and creationHelperEntity then
    ...
    exports['hrrp-hud']:NotificationSuccess('Saved Door To File')
    creationHelper = false
  end
end)
