...
setupEvent = AddEventHandler("Core:Shared:Ready", function()
  exports['hrrp-base']:RequestDependencies('Fuel', {
    'Callbacks',
        ...
        while true do
          ...
          if bankAcc then
            if depositData.amount > 0 then
              exports['hrrp-base']:LoggerTrace("Fuel", string.format("Depositing ^2$%s^7 To ^3%s^7", math.abs(depositData.amount), bankAcc))
...
function RegisterCallbacks()
  exports['hrrp-base']:CallbacksRegisterServer('Fuel:CompleteFueling', function(source, data, cb)
  ...
  exports['hrrp-base']:CallbacksRegisterServer('Fuel:CompleteJerryFueling', function(source, data, cb)
    local char = exports['hrrp-base']:FetchSource(source):GetData('Character')
  ...
  exports['hrrp-base']:CallbacksRegisterServer("Fuel:FillCan", function(source, data, cb)
