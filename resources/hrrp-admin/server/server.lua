...
function RegisterChatCommands()
  ...
  Chat:RegisterStaffCommand("lookup", function(source, args, rawCommand)
    if tonumber(args[1]) then
      ...
      local target = exports['hrrp-base']:FetchSID(tonumber(args[1]))
      if target ~= nil then
  ...
  Chat:RegisterStaffCommand("cpcoords", function(source, args, rawCommand)
    ...
    exports['hrrp-base']:ExecuteClient(source, "Notification", "Success", "Copied Coordinates")
  end, {
  ...
  Chat:RegisterAdminCommand("cpproperty", function(source, args, rawCommand)
    ...
    if nearProperty?.propertyId then
      exports['hrrp-base']:ExecuteClient(source, "Admin", "CopyClipboard", nearProperty?.propertyId)
      exports['hrrp-base']:ExecuteClient(source, "Notification", "Success", "Copied Property ID")
    end
  end, {
