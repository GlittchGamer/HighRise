...
--     _menuOpen = true
--     exports["hrrp-base"]:CallbacksServer('Admin:GetMenuData', {}, function(isAdmin, data)
...
--         if data then
--             adminSubMenus = {}
--             adminMenu = exports['hrrp-menu']:Create('adminMenu', 'Admin Menu', function(id, back)
--                 _menuOpen = true
--             end, function()
--                 _menuOpen = false
--                 Citizen.Wait(100)
...
--                 adminSubMenus['activePlayers'] = exports['hrrp-menu']:Create('adminActivePlayers', 'Player Management')
...
--                         adminSubMenus[playerMenuId] = exports['hrrp-menu']:Create(playerMenuId, string.format('Viewing Player: [%s] %s', player.Source, player.Name))

--                         -- PUNISH MENU
--                         adminSubMenus[playerMenuId.. '-punish'] = exports['hrrp-menu']:Create('adminActivePlayersPunish-' .. player.Source, string.format('Punish Player: [%s] %s', player.Source, player.Name))
...
--                             exports["hrrp-base"]:CallbacksServer('Admin:PlayerTeleportAction', {
--                                 action = 'GOTO',
--                                 target = player.Source,
--                             }, function(success)
--                                 if success then
--                                     exports['hrrp-hud']:NotificationSuccess('Successfully Teleported to '.. player.Name)
--                                 else
--                                     exports['hrrp-hud']:NotificationError('Failed to Teleport to '.. player.Name)
--                                 end
--                             end)
--                         end)
...
--                             }, function(success)
--                                 if success then
--                                     exports['hrrp-hud']:NotificationSuccess('Successfully Brought '.. player.Name)
--                                 else
--                                     exports['hrrp-hud']:NotificationError('Failed to Bring '.. player.Name)
--                                 end
--                             end)
--                         end)
...
--                                 AdminStopAttach()
--                             else
--                                 exports["hrrp-base"]:CallbacksServer('Admin:AttachToPlayer', player.Source, function(targetCoords)
...
--                         if player.Character then
--                             adminSubMenus[playerMenuId.. '-phone-perms'] = exports['hrrp-menu']:Create('adminPhonePerms-' .. player.Source, 'Update Phone Permissions')
...
--                                         exports["hrrp-base"]:CallbacksServer('Admin:UpdatePhonePerms', {
--                                             target = player.Source,
--                                             app = appKey,
--                                             perm = permKey,
...
--             adminSubMenus['recentDisconnects'] = exports['hrrp-menu']:Create('adminRecentDisconnects', 'Recent Disconnects')
...
--                         adminSubMenus[playerMenuId] = exports['hrrp-menu']:Create(playerMenuId, string.format('Disconnected Player: [%s] %s', player.Source, player.Name))
...
--             -- Teleportation
--             adminSubMenus['teleportationUtils'] = exports['hrrp-menu']:Create('adminTeleportUtils', 'Teleport')
--             if data.spawnLocations then
--                 local spawnLocations = exports['hrrp-menu']:Create('adminSpawnLocations', 'Spawn Locations')
...
--             adminSubMenus['developerUtilities'] = exports['hrrp-menu']:Create('adminDevUtils', 'Developer Utilities')
...
--                 adminSubMenus['vehicleUtilities'] = exports['hrrp-menu']:Create('adminVehUtils', 'Vehicle Utilities')
...
--                         exports['hrrp-hud']:NotificationSuccess('Repaired Vehicle')
--                     end
--                 end)
...
--                         exports['hrrp-hud']:NotificationSuccess('Repaired Vehicle Fully')
--                     end
--                 end)
