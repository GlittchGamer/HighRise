...
setupEvent = AddEventHandler("Core:Shared:Ready", function()
  exports["hrrp-base"]:RequestDependencies("Sync", {
    "Callbacks",
    "Fetch",
    "Utils",
    "Chat",
...
function StartThreads()
  ...
  if not GlobalState.IsProduction then
    _weather = "EXTRASUNNY"
    _weatherFrozen = true
    exports['hrrp-base']:LoggerTrace("Sync", "Freezing Weather (Non Production Server)")
  end
  ...
  exports['hrrp-base']:LoggerTrace("Sync", string.format("Started Time and Weather Sync Threads With Weather: %s and Time: %02d:%02d", _weather, _timeHour, _timeMinute),
    { console = true })
...
SYNC = {
  ...
  FreezeWeather = function(self, state)
    ...
    exports['hrrp-base']:LoggerInfo("Sync", "Weather Was: ^5" .. (_weatherFrozen and 'Frozen' or 'Unfrozen') .. "^7", { console = true })
  end,
  FreezeTime = function(self, state)
    ...
    exports['hrrp-base']:LoggerInfo("Sync", "Time Was: ^5" .. (_timeFrozen and 'Frozen' or 'Unfrozen') .. "^7", { console = true })
  end,
  Set = {
    Blackout = function(self, state)
      ...
      exports['hrrp-base']:LoggerInfo("Sync", "Blackout Was: ^5" .. (_blackoutState and 'Enabled' or 'Disabled') .. "^7", { console = true })
    end,
    Weather = function(self, wtype)
      _weather = string.upper(wtype)
      GlobalState['Sync:Weather'] = _weather
      TriggerEvent('Sync:Server:WeatherChange', _weather)
      exports['hrrp-base']:LoggerInfo("Sync", "Weather Manually Updated: ^5" .. _weather .. "^7", { console = true })
    end,
    ...
    Time = function(self, hour, minute)
      ...
      exports['hrrp-base']:LoggerInfo("Sync", "Time Manually Set: ^5" .. string.format('%02d:%02d', _timeHour, _timeMinute) .. "^7", { console = true })
    end,
  },
  NextWeatherStage = function(self)
    ...
    GlobalState['Sync:Weather'] = _weather
    TriggerEvent('Sync:Server:WeatherChange', _weather)
    exports['hrrp-base']:LoggerInfo("Sync", "Weather Updated: ^5" .. _weather .. "^7", { console = true })
  end,
}

AddEventHandler("Proxy:Shared:RegisterReady", function(component)
  exports["hrrp-base"]:RegisterComponent("Sync", SYNC)
end)
