...
QUEUE.Connect = function(self, source, playerName, setKickReason, deferrals)
  ...
  Citizen.CreateThread(function()
    ...
    local roles = exports['discord']:getRoles(source)
    if not roles then
    ...
    deferrals.presentCard(card, function(pData, pRawData)
      if pData.submitId == 'submit_join' then
        -- exports['core']:UtilsPrint(pRawData)
...
AddEventHandler("Proxy:Shared:RegisterReady", function()
  exports['core']:RegisterComponent("Queue", QUEUE)
end)
...
function RetrieveComponents()
  ...
  Queue = exports['core']:FetchComponent("Queue")
  Convar = exports['core']:FetchComponent("Convar")
...
setupEvent = AddEventHandler("Core:Shared:Ready", function()
  exports['core']:RequestDependencies("Queue", {
    "Config",
    ...
    Chat:RegisterAdminCommand("tempwl", function(source, args, rawCommand)
      ...
      if accountID then
        if not _tempWhitelist[accountID] then
          ...
          exports['core']:ExecuteClient(source, "Notification", "Success", "Temp Whitelist Added For ID: " .. accountID)
        else
          _tempWhitelist[accountID] = false
          exports['core']:ExecuteClient(source, "Notification", "Error", "Temp Whitelist Revoked For ID: " .. accountID)
        end
      end
    end, {
    ...
    Chat:RegisterAdminCommand("tempwlgroup", function(source, args, rawCommand)
      ...
      if group then
        if not _tempWhitelistGroup[group] then
          ...
          exports['core']:ExecuteClient(source, "Notification", "Success", "Temp Whitelist Added For Group: " .. group)
        else
          _tempWhitelistGroup[group] = false
          exports['core']:ExecuteClient(source, "Notification", "Error", "Temp Whitelist Revoked For Group: " .. group)
        end
      end
    end, {
...
Citizen.CreateThread(function()
  ...
  if not exports['core']:FetchComponent("WebAPI").Enabled then
