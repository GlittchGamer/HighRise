Racing = {
  ...
  StartRace = function(self)
    ...
    repeat
      ...
      exports['hrrp-sounds']:PlayFrontEnd(-1, "5_SEC_WARNING", "HUD_MINI_GAME_SOUNDSET")
    ...
    CreateThread(function()
      ...
      exports['hrrp-sounds']:PlayFrontEnd(-1, "GO", "HUD_MINI_GAME_SOUNDSET")
        ...
        if dist <= checkpoint.size or Racing.safeCheckpoint == -1 then
          ...
          if Racing.currentCheckpoint == 1 and #Racing.completedCheckpoints == #Racing.ActiveRace.trackData.Checkpoints and Racing.ActiveRace.trackData.Type ~= "p2p" then
            ...
            if Racing.currentLap <= tonumber(Racing.ActiveRace.laps) then
              exports['hrrp-hud']:NotificationInfo(string.format("Lap %s", Racing.currentLap))
              exports['hrrp-sounds']:PlayFrontEnd(-1, "CHECKPOINT_PERFECT", "HUD_MINI_GAME_SOUNDSET")
              SendNUIMessage({
                type = "RACE_LAP",
              })
          ...
          if Racing.safeCheckpoint ~= -1 then
            ...
            exports['hrrp-sounds']:PlayFrontEnd(-1, "CHECKPOINT_NORMAL", "HUD_MINI_GAME_SOUNDSET")
          ...
          if Racing.ActiveRace.trackData.Type == "p2p" and #Racing.completedCheckpoints == #Racing.ActiveRace.trackData.Checkpoints or Racing.currentLap > tonumber(Racing.ActiveRace.laps) then
            ...
            Cleanup()
            exports['hrrp-sounds']:PlayFrontEnd(-1, "FIRST_PLACE", "HUD_MINI_GAME_SOUNDSET")
            SendNUIMessage({
              type = "RACE_END",
            })
            SendNUIMessage({
