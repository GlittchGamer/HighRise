...
function OpenCatalogMenu(catalogName)
  catalogMenu = exports['menu']:Create('dealerCatalog', catalogName .. ' Vehicle Catalog', function()
  ...
  for _, cat in ipairs(orderedCategories) do
    if catalogData.sorted[cat] and #catalogData.sorted[cat] > 0 then
      ...
      catalogSubMenus[cat] = exports['menu']:Create('dealerCatalogSub-' .. cat, catalogName .. ' Catalog - ' .. _catalogCategories[cat] .. ' Vehicles')
