...
function RegisterVehicleSaleCallbacks()
  exports['core']:CallbacksRegisterServer('Dealerships:Sales:StartSale', function(source, saleData, cb)
    ...
    if dealership and type and data then
      ...
      if char and dealerData and customerStateId and vehicle and exports['jobs']:JobsPermissionsHasPermissionInJob(source, dealerData.id, 'dealership_sell') then
        local targetPlayer = exports['core']:FetchSID(customerStateId)
                  ...
                  Billing:Create(targetSrc, dealerData.abbreviation .. ' - Sales', salePrice, '',
                    function(wasPayed, withAccount)
                      if wasPayed then
                          ...
                          Vehicles.Owned:AddToCharacter(targetCharacter:GetData('SID'),
                            GetHashKey(saleVehicleData.vehicle), 0, {
                              ...
                              if success and vehicleData then
                                ...
                                exports['core']:ExecuteClient(source, 'Notification', 'Success',
                                ...
                                exports['core']:ExecuteClient(source, 'Notification', 'Error', 'Error Completing Vehicle Sale', 5000,
                                  'car-building')
                                exports['core']:ExecuteClient(targetSrc, 'Notification', 'Error', 'Error Completing Vehicle Sale', 5000,
                                  'car-building')
                              end
                        ...
                        exports['core']:ExecuteClient(source, 'Notification', 'Error', 'Payment Failed', 5000, 'car-building')
                      end
                    end)
                        ...
                        if loanData.maxBorrowable >= salePriceAfterDown then
                          SendPendingLoanEmail({
                            ...
                            salePriceAfterDown, function()
                              exports['core']:ExecuteClient(source, 'Notification', 'Info',
                                ...
                                function(wasPayed, withAccount)
                                  if wasPayed then
                                    ...
                                    if not loanSuccess then
                                      exports['core']:ExecuteClient(source, 'Notification', 'Error',
                                        ...
                                        GetHashKey(saleVehicleData.vehicle), 0, {
                                          ...
                                          if success and vehicleData then
                                            ...
                                            exports['core']:ExecuteClient(source, 'Notification', 'Error',
                                              ...
                                              5000, 'car-building')
                                            exports['core']:ExecuteClient(targetSrc, 'Notification', 'Error',
                                              'Error Completing Vehicle Sale', 5000, 'car-building')
                                          end
                                        end, false, dealerData.storage, preGenerateVIN)
                                    end
                                  else
                                    exports['core']:ExecuteClient(source, 'Notification', 'Error', 'Loan Downpayment Failed', 5000,
                                      'car-building')
                                  end
                                end
                              )
