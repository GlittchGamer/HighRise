...
function RegisterCallbacks()
  exports['core']:CallbacksRegisterServer('Dealerships:GetDealerStock', function(source, dealerId, cb)
  ...
  exports['core']:CallbacksRegisterServer('Dealerships:ShowroomManagement:FetchData', function(source, dealerId, cb)
    if _dealerships[dealerId] and exports['jobs']:JobsPermissionsHasPermissionInJob(source, dealerId, 'dealership_showroom') then
  ...
  exports['core']:CallbacksRegisterServer('Dealerships:StockViewing:FetchData', function(source, dealerId, cb)
    if _dealerships[dealerId] and exports['jobs']:JobsPermissionsHasPermissionInJob(source, dealerId, 'dealership_stock') or exports['jobs']:JobsPermissionsHasPermissionInJob(source, dealerId, 'dealership_sell') then
  ...
  exports['core']:CallbacksRegisterServer('Dealerships:Sales:FetchData', function(source, dealerId, cb)
    if _dealerships[dealerId] and exports['jobs']:JobsPermissionsHasPermissionInJob(source, dealerId, 'dealership_stock') or exports['jobs']:JobsPermissionsHasPermissionInJob(source, dealerId, 'dealership_sell') then
  ...
  exports['core']:CallbacksRegisterServer('Dealerships:ShowroomManagement:SetPosition', function(source, data, cb)
    local char = exports['core']:FetchSource(source):GetData("Character")
    if data and data.dealerId and type(data.position) == 'number' and exports['jobs']:JobsPermissionsHasPermissionInJob(source, data.dealerId, 'dealership_showroom') then
  ...
  exports['core']:CallbacksRegisterServer('BikeStand:Purchase', function(source, data, cb)
  ...
  exports['core']:CallbacksRegisterServer('Dealerships:CheckPersonsCredit', function(source, data, cb)
    local char = exports['core']:FetchSource(source):GetData("Character")

    local stateId = math.tointeger(data.SID)

    if data and data.dealerId and stateId and exports['jobs']:JobsPermissionsHasPermissionInJob(source, data.dealerId, 'dealership_sell') then
      local target = exports['core']:FetchSID(stateId)
      if target then
  ...
  exports['core']:CallbacksRegisterServer('Dealerships:GetDealershipData', function(source, data, cb)
    if data and data.dealerId and _dealerships[data.dealerId] and exports['jobs']:JobsPermissionsHasPermissionInJob(source, data.dealerId, 'dealership_manage') then
  ...
  exports['core']:CallbacksRegisterServer('Dealerships:UpdateDealershipData', function(source, data, cb)
    if data and data.dealerId and _dealerships[data.dealerId] and data.updating and exports['jobs']:JobsPermissionsHasPermissionInJob(source, data.dealerId, 'dealership_manage') then
  ...
  exports['core']:CallbacksRegisterServer('Dealerships:FetchHistory', function(source, dealerId, cb)
    if dealerId and _dealerships[dealerId] and exports['jobs']:JobsPermissionsHasPermissionInJob(source, dealerId, 'dealership_manage') then
  ...
  exports['core']:CallbacksRegisterServer('Dealerships:FetchCurrentOwner', function(source, data, cb)
    if data and data.dealerId and _dealerships[data.dealerId] and exports['jobs']:JobsPermissionsHasPermissionInJob(source, data.dealerId, 'dealership_manage') then
  ...
  exports['core']:CallbacksRegisterServer('Dealerships:BuyBackStart', function(source, data, cb)
    local char = exports['core']:FetchSource(source):GetData("Character")
    if data and data.dealerId and data.netId and _dealerships[data.dealerId] and exports['jobs']:JobsPermissionsHasPermissionInJob(source, data.dealerId, 'dealership_buyback') then
  ...
  exports['core']:CallbacksRegisterServer('Dealerships:BuyBack', function(source, data, cb)
    local char = exports['core']:FetchSource(source):GetData("Character")
    if data and data.dealerId and data.netId and _dealerships[data.dealerId] and exports['jobs']:JobsPermissionsHasPermissionInJob(source, data.dealerId, 'dealership_buyback') then
      local veh = NetworkGetEntityFromNetworkId(data.netId)
          ...
          if vehModel then
            ...
            if stockInfo and stockInfo.data and vehStrikes and not remainingLoan then
              ...
              if vehicle and vehicle:GetData('Owner')?.Type == 0 then
                local owner = exports['core']:FetchSID(vehicle:GetData('Owner').Id)
                if owner then
