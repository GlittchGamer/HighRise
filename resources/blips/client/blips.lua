...
setupEvent = AddEventHandler("Core:Shared:Ready", function()
  exports['core']:RequestDependencies('Blips', {
    'Logger',
    'Blips',
  }, function(error)
    if #error > 0 then
...
AddEventHandler('Proxy:Shared:RegisterReady', function() --! Completed
  exports['core']:RegisterComponent('Blips', BLIPS)
end)
