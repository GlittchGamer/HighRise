...
function RetrieveComponents()
  ...
  Spawn = exports['core']:FetchComponent("Spawn")
    ...
    Interaction:ShowMenu({
      {
        ...
        action = function()
          exports['core']:CallbacksServer("Ped:RemoveMask")
          Interaction:Hide()
        end,
      },
      {
        ...
        action = function()
          exports['core']:CallbacksServer("Ped:RemoveHat")
          Interaction:Hide()
        end,
      },
      {
...
PED = {
  ...
  Creator = {
    ...
    End = function(self)
      ...
      exports['core']:CallbacksServer("Apartment:SpawnInside", {})
    end,
  },
  Customization = {
    ...
    Save = function(self, cb)
      FROZEN = false
      exports['core']:CallbacksServer("Ped:MakePayment", {
        type = _currentState,
        ...
        if status then
          ...
          Ped:ApplyToPed(LocalPed)
          exports['core']:CallbacksServer("Ped:SavePed", {
            ped = LocalPed,
          }, function(saved)
            if _currentState == "CREATOR" then
              ...
              Ped.Customization:Hide()
              exports['hud']:NotificationSuccess(string.format("You Paid $%s", paid))
            end
          end)
        else
          exports['hud']:NotificationError("You Don't Have Enough Cash")
        end
        cb(status)
      end)
    end,
