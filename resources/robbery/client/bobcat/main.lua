...
AddEventHandler("Robbery:Client:Setup", function()
  ...
  exports['polyzonehandler']:PolyZoneCreatePoly("bobcat", {
  ...
  exports['core']:CallbacksRegisterClient("Robbery:Bobcat:SetupPeds", function(data, cb)
...
AddEventHandler("Robbery:Client:Bobcat:StartSecuring", function(entity, data)
  Progress:Progress({
    ...
    if not status then
      exports['core']:CallbacksServer("Robbery:Bobcat:Secure", {})
    end
  end)
end)

-- AddEventHandler("Robbery:Client:Bobcat:HackFrontPC", function(entity, t)
-- 	exports['core']:CallbacksServer("Robbery:Bobcat:CheckFrontPC", {}, function(data)
-- 		if data then
-- 			_capPass = 1
-- 			DoCaptcha(data.passes, data.config, data.data, function(isSuccess, extra)
-- 				exports['core']:CallbacksServer("Robbery:Bobcat:FrontPCResults", {
-- 					state = isSuccess,
-- 				}, function() end)
-- 			end)
-- 		end
...
-- 	exports['core']:CallbacksServer("Robbery:Bobcat:CheckSecurityPC", {}, function(data)
-- 		if data then
-- 			_capPass = 1
-- 			DoCaptcha(data.passes, data.config, data.data, function(isSuccess, extra)
-- 				exports['core']:CallbacksServer("Robbery:Bobcat:SecurityPCResults", {
-- 					state = isSuccess,
-- 				}, function() end)
-- 			end)
-- 		end
...
AddEventHandler("Robbery:Client:Bobcat:GrabC4", function()
  Progress:Progress({
    ...
    if not status then
      exports['core']:CallbacksServer('Robbery:Bobcat:PickupC4', {}, function(s)
...
AddEventHandler("Robbery:Client:Bobcat:GrabLoot", function(entity, data)
  exports['core']:CallbacksServer('Robbery:Bobcat:CheckLoot', data, function(s)
    if s then
      Progress:Progress({
        name = "bobcat_loot",
        ...
        if not status then
          exports['core']:CallbacksServer('Robbery:Bobcat:Loot', data, function(s2) end)
        else
          exports['core']:CallbacksServer('Robbery:Bobcat:CancelLoot', data, function(s2) end)
        end
      end)
    end
  end)
...
AddEventHandler("Polyzone:Exit", function(id, point, insideZone, data)
  if id == "bobcat" then
    ...
    exports['core']:CallbacksServer("Robbery:Bobcat:LeftBuilding", {}, function() end)
  end
end)
