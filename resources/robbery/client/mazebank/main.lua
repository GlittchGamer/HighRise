...
AddEventHandler("Robbery:Client:Setup", function()
  exports['polyzonehandler']:PolyZoneCreatePoly("bank_mazebank", {
...
AddEventHandler("Robbery:Client:MazeBank:StartSecuring", function(entity, data)
  Progress:Progress({
    ...
    if not status then
      exports['core']:CallbacksServer("Robbery:MazeBank:SecureBank", {})
    end
  end)
end)

AddEventHandler("Robbery:Client:MazeBank:ElectricBox:Hack", function(entity, data)
  exports['core']:CallbacksServer("Robbery:MazeBank:ElectricBox:Hack", data, function() end)
end)

AddEventHandler("Robbery:Client:MazeBank:ElectricBox:Thermite", function(entity, data)
  exports['core']:CallbacksServer("Robbery:MazeBank:ElectricBox:Thermite", data, function() end)
end)

AddEventHandler("Robbery:Client:MazeBank:Drill", function(entity, data)
  exports['core']:CallbacksServer("Robbery:MazeBank:Drill", data.id, function() end)
end)

AddEventHandler("Robbery:Client:MazeBank:PC:Hack", function(entity, data)
  exports['core']:CallbacksServer("Robbery:MazeBank:PC:Hack", data, function() end)
end)
