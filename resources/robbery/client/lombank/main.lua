function LBNeedsReset()
  for k, v in pairs(lbThermPoints) do
    if not exports['doors']:IsLocked(v.door) then
      return true
    end
  end
...
AddEventHandler("Robbery:Client:Setup", function()
  exports['polyzonehandler']:PolyZoneCreatePoly("dumbcunt", {
  ...
  exports['polyzonehandler']:PolyZoneCreatePoly("bank_lombank", {
  ...
  exports['polyzonehandler']:PolyZoneCreatePoly("lombank_power", {
  ...
  exports['polyzonehandler']:PolyZoneCreateBox("lombank_death", vector3(24.86, -921.78, 25.74), 7.4, 7.8, {
    heading = 340,
    --debugPoly=true,
    minZ = 24.74,
    maxZ = 28.74,
  ...
  for k, v in ipairs(_lombankRooms) do
    exports['polyzonehandler']:PolyZoneCreateBox(string.format("lombank_room_%s", v.roomId), v.coords, v.length, v.width, v.options, {
      isLombankRoom = true,
      roomId = v.roomId,
    })
  end
...
AddEventHandler("Polyzone:Enter", function(id, testedPoint, insideZones, data)
  if type(data) == "table" then
    if data.isDeath then
      if not data.door or exports['doors']:IsLocked(data.door) then
      ...
      exports['ox_target']:TargetingAddObject(v, "treasure-chest", {
        {
          ...
          isEnabled = function(d, entity)
            ...
            return not exports['doors']:IsLocked("lombank_lower_gate")
                and not exports['doors']:IsLocked("lombank_lower_vault")
                and not exports['doors']:IsLocked(string.format("lombank_lower_room_%s", data.roomId))
...
AddEventHandler("Robbery:Client:Lombank:StartSecuring", function(entity, data)
  Progress:Progress({
    ...
    if not status then
      exports['core']:CallbacksServer("Robbery:Lombank:SecureBank", {})
    end
  end)
end)

AddEventHandler("Robbery:Client:Lombank:ElectricBox:Hack", function(entity, data)
  exports['core']:CallbacksServer("Robbery:Lombank:ElectricBox:Hack", data, function() end)
end)

AddEventHandler("Robbery:Client:Lombank:ElectricBox:Thermite", function(entity, data)
  exports['core']:CallbacksServer("Robbery:Lombank:ElectricBox:Thermite", data, function() end)
end)

AddEventHandler("Robbery:Client:Lombank:Drill", function(entity, data)
  exports['core']:CallbacksServer("Robbery:Lombank:Drill", data.id, function() end)
end)
