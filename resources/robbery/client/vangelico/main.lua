...
AddEventHandler("Robbery:Client:Setup", function()
  exports['polyzonehandler']:PolyZoneCreatePoly("vangelico", {
...
AddEventHandler("Robbery:Client:Vangelico:SecureStore", function(entity, data)
  Progress:Progress({
    ...
    if not status then
      exports['core']:CallbacksServer("Robbery:Vangelico:SecureStore")
    end
  end)
end)
  ...
  then
    ...
    Progress:ProgressWithTickEvent({
      ...
      if not cancelled then
        exports['core']:CallbacksServer("Robbery:Vangelico:BreakCase", data.index)
      end
    end)
  end
end)
