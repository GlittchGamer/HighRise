...
AddEventHandler("Robbery:Client:Setup", function()
	exports['core']:CallbacksRegisterClient("Robbery:Moneytruck:CheckForTruck", function(data, cb)
    ...
    exports['core']:CallbacksRegisterClient("Robbery:Moneytruck:Thermite:Door", function(data, cb)
    ...
    exports['core']:CallbacksRegisterClient("Robbery:Moneytruck:Spawn:Get", function(data, cb)
	...
	exports['core']:CallbacksRegisterClient("Robbery:MoneyTruck:CreatePeds", function(data, cb)
	...
	exports['core']:CallbacksRegisterClient("Robbery:MoneyTruck:MarkTruck", function(data, cb)
...
AddEventHandler("Robbery:Client:MoneyTruck:GrabLoot", function(entity, data)
	exports['core']:CallbacksServer('Robbery:MoneyTruck:CheckLoot', VehToNet(entity.entity), function(s)
		if s then
			Progress:Progress({
				...
				if not status then
					exports['core']:CallbacksServer('Robbery:MoneyTruck:Loot', VehToNet(entity.entity), function(s2) end)
				else
					exports['core']:CallbacksServer('Robbery:MoneyTruck:CancelLoot', VehToNet(entity.entity), function(s2) end)
				end
			end)
		end
	end)
