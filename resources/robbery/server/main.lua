...
setupEvent = AddEventHandler("Core:Shared:Ready", function()
  exports['core']:RequestDependencies("Robbery", {
    ...
    exports['core']:CallbacksRegisterServer("Robbery:Holdup:Do", function(source, data, cb)
      local pChar = exports['core']:FetchSource(source):GetData("Character")
    ...
    exports['core']:CallbacksRegisterServer("Robbery:Pickup", function(source, data, cb)
      ...
      if plyr ~= nil then
        ...
        if char ~= nil then
          if #(_pickups[char:GetData("SID")] or {}) > 0 then
            ...
            exports['core']:ExecuteClient(source, "Notification", "Success", "You've Picked Up All Available Items", 6000)
          else
            exports['core']:ExecuteClient(source, "Notification", "Error", "You Have Nothing To Pickup", 6000)
          end
        end
      end
    end)
...
_ROBBERY = {
  TriggerPDAlert = function(self, source, coords, code, title, blip, description, cameraGroup, isArea)
    exports['core']:CallbacksClient(source, "EmergencyAlerts:GetStreetName", coords, function(location)
