...
AddEventHandler("Robbery:Server:Setup", function()
  ...
  exports['core']:CallbacksRegisterServer("Robbery:MazeBank:SecureBank", function(source, data, cb)
  ...
  exports['core']:CallbacksRegisterServer("Robbery:MazeBank:ElectricBox:Hack", function(source, data, cb)
    local plyr = exports['core']:FetchSource(source)
    if plyr ~= nil then
      local char = plyr:GetData("Character")
      if char ~= nil then
  ...
  exports['core']:CallbacksRegisterServer("Robbery:MazeBank:ElectricBox:Thermite", function(source, data, cb)
    local plyr = exports['core']:FetchSource(source)
    if plyr ~= nil then
      local char = plyr:GetData("Character")
      if char ~= nil then
  ...
  exports['core']:CallbacksRegisterServer("Robbery:MazeBank:Drill", function(source, data, cb)
    local plyr = exports['core']:FetchSource(source)
    if plyr ~= nil then
      local char = plyr:GetData("Character")
      if char ~= nil then
  ...
  exports['core']:CallbacksRegisterServer("Robbery:MazeBank:PC:Hack", function(source, data, cb)
    local plyr = exports['core']:FetchSource(source)
    if plyr ~= nil then
      local char = plyr:GetData("Character")
      if char ~= nil then
          ...
          if not _mbInUse.officePcs[data.id] then
            ...
            if Inventory.Items:Has(char:GetData("SID"), 1, "adv_electronics_kit", 1) then
              ...
              if itemData ~= nil then
                ...
                exports['core']:CallbacksClient(source, "Robbery:Games:Progress", {
                  config = {
