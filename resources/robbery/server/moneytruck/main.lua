...
AddEventHandler("Robbery:Server:Setup", function()
  exports['core']:CallbacksRegisterServer("Robbery:MoneyTruck:EnteredTruck", function(source, data, cb)
  ...
  exports['core']:CallbacksRegisterServer("Robbery:MoneyTruck:CheckLoot", function(source, data, cb)
  ...
  exports['core']:CallbacksRegisterServer("Robbery:MoneyTruck:CancelLoot", function(source, data, cb)
    local pState = Player(source).state
    local ent = NetworkGetEntityFromNetworkId(data)
    if ent ~= 0 then
      local entState = Entity(ent).state
  ...
  exports['core']:CallbacksRegisterServer("Robbery:MoneyTruck:Loot", function(source, data, cb)
    local pState = Player(source).state
    local ent = NetworkGetEntityFromNetworkId(data)
    if ent ~= 0 then
      local entState = Entity(ent).state
