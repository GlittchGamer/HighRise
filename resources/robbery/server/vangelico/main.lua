...
AddEventHandler("Robbery:Server:Setup", function()
  ...
  exports['core']:CallbacksRegisterServer("Robbery:Vangelico:BreakCase", function(source, data, cb)
  ...
  exports['core']:CallbacksRegisterServer("Robbery:Vangelico:SecureStore", function(source, data, cb)
    local player = exports['core']:FetchSource(source)
    local char = player:GetData("Character")
    if _alerted ~= nil and _alerted >= os.time() then
      PutShittyThingsOnCD()
      GlobalState["Vangelico:State"] = 2
      exports['core']:ExecuteClient(source, "Notification", "Success", "Store Has Been Secure", 6000)
    else
      exports['core']:ExecuteClient(source, "Notification", "Error", "Unable To Secure Store, No Recent Crime Reported", 6000)
      exports['core']:LoggerInfo(
        "Robbery",
        string.format(
