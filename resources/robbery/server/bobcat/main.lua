...
AddEventHandler("Robbery:Server:Setup", function()
  ...
  Inventory.Items:RegisterUse("thermite", "BobcatRobbery", function(source, itemData)
    ...
    then
      ...
      if not _bcInUse.extrDoor then
        ...
        if Inventory.Items:RemoveSlot(itemData.Owner, itemData.Name, 1, itemData.Slot, itemData.invType) then
          ...
          exports['core']:CallbacksClient(source, "Robbery:Games:Thermite", {
            ...
            if success then
              ...
              exports['doors']:SetLock("bobcat_extr", false)
        ...
        exports['core']:ExecuteClient(source, "Notification", "Error", "Someone Is Already Doing This", 6000)
      end
    else
      if pState.inBobcat then
            ...
            if Inventory.Items:RemoveSlot(itemData.Owner, itemData.Name, 1, itemData.Slot, itemData.invType) then
              ...
              exports['core']:CallbacksClient(source, "Robbery:Games:Thermite", {
                ...
                if success then
                  ...
                  exports['doors']:SetLock("bobcat_front", false)
                  if not _alerted or os.time() > _alerted then
                    Robbery:TriggerPDAlert(
                      source,
                      vector3(879.020, -2263.657, 30.468),
        ...
        exports['core']:CallbacksClient(source, "Robbery:Moneytruck:CheckForTruck", {}, function(type, vNet)
          if type ~= nil then
            ...
            if not entState.robberyInProgress then
              ...
              if not entState.wasThermited then
                ...
                then
                  ...
                  exports['core']:CallbacksClient(source, "Robbery:Moneytruck:Thermite:Door", {
                    vNet = vNet,
                    passes = 1,
                    location = _bobcatLocations.startDoor,
                    duration = 3000,
                ...
                exports['core']:ExecuteClient(source, "Notification", "Error", "This Truck Has Already Been Hit", 6000)
              end
            else
              exports['core']:ExecuteClient(source, "Notification", "Error", "Someone Is Already Doing This", 6000)
            end
        ...
        if #(_bobcatLocations.vaultDoor.coords - myPos) <= 3.5 then
          ...
          if not _bcInUse.useC4 then
            ...
            if Inventory.Items:RemoveSlot(itemData.Owner, itemData.Name, 1, itemData.Slot, itemData.invType) then
              ...
              exports['core']:CallbacksClient(source, "Robbery:Games:Aim", {
                location = {
      ...
      then
        if #(_bobcatLocations.securedDoor.coords - myCoords) <= 1.5 then
          ...
          if not _bcInUse.securedDoor then
            ...
            exports['core']:CallbacksClient(source, "Robbery:Games:Laptop", {
              location = {
              ...
              if success then
                ...
                exports['core']:CallbacksClient(source, "Robbery:Bobcat:SetupPeds", {
                  peds = _bobcatPeds,
                  isBobcat = true,
                  skipLeaveVeh = true,
                }, function() end)
                exports['doors']:SetLock("bobcat_inner", false)
                exports['core']:ExecuteClient(source, "Notification", "Success", "Doorlock Disengaged", 6000)
                ...
                exports['doors']:SetLock("bobcat_inner", true)
      ...
      if plyr ~= nil then
        ...
        if char ~= nil then
          ...
          if not netId then
            ...
            exports['core']:CallbacksClient(source, "Robbery:MoneyTruck:MarkTruck", netId, function(r)
              if r then
                Inventory.Items:RemoveSlot(slot.Owner, slot.Name, 1, slot.Slot, 1)
                exports['core']:ExecuteClient(
                  source,
  ...
  exports['core']:CallbacksRegisterServer("Robbery:Bobcat:PickupC4", function(source, data, cb)
    local plyr = exports['core']:FetchSource(source)
    if plyr ~= nil then
      local char = plyr:GetData("Character")
      if char ~= nil then
  ...
  exports['core']:CallbacksRegisterServer("Robbery:DoThermiteFx", function(source, data, cb)
    TriggerClientEvent("Robbery:Client:ThermiteFx", -1, data.delay or 13000, data.netId)
  end)

  exports['core']:CallbacksRegisterServer("Robbery:DoBombFx", function(source, data, cb)
    TriggerClientEvent("Robbery:Client:BombFx", -1, data)
  end)

  exports['core']:CallbacksRegisterServer("Robbery:Bobcat:CheckLoot", function(source, data, cb)
    local pState = Player(source).state
  ...
  exports['core']:CallbacksRegisterServer("Robbery:Bobcat:CancelLoot", function(source, data, cb)
    local pState = Player(source).state
  ...
  exports['core']:CallbacksRegisterServer("Robbery:Bobcat:Loot", function(source, data, cb)
    local pState = Player(source).state
  ...
  exports['core']:CallbacksRegisterServer("Robbery:Bobcat:Secure", function(source, data, cb)
    local pState = Player(source).state
    local plyr = exports['core']:FetchSource(source)
    if plyr ~= nil then
      local char = plyr:GetData("Character")
      if char ~= nil then
        if pState.onDuty == "police" then
          ...
          SecureBobcat()
          exports['core']:ExecuteClient(source, "Notification", "Success", "Building Secure", 6000)
        end
      end
    end
  end)

  exports['core']:CallbacksRegisterServer("Robbery:Bobcat:CheckFrontPC", function(source, data, cb)
  ...
  exports['core']:CallbacksRegisterServer("Robbery:Bobcat:FrontPCResults", function(source, data, cb)
  ...
  -- exports['core']:CallbacksRegisterServer("Robbery:Bobcat:CheckSecurityPC", function(source, data, cb)
  ...
  -- exports['core']:CallbacksRegisterServer("Robbery:Bobcat:SecurityPCResults", function(source, data, cb)
  ...
  exports['core']:CallbacksRegisterServer("Robbery:Bobcat:LeftBuilding", function(source, data, cb)
    cb(RemoveC4(source))
  end)
end)
...
function ResetBobcat()
  exports['doors']:SetLock("bobcat_extr", true)
  exports['doors']:SetLock("bobcat_front", true)
  exports['doors']:SetLock("bobcat_inner", true)
