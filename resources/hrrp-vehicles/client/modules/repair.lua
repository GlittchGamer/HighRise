...
AddEventHandler('Proxy:Shared:ExtendReady', function(component)
  if component == 'Vehicles' then
    exports['hrrp-base']:ExtendComponent(component, _vehicleRepair)
  end
end)
...
AddEventHandler('Vehicles:Client:StartUp', function()
  exports["hrrp-base"]:CallbacksRegisterClient('Vehicles:RepairKit', function(type, cb)
    if LocalPlayer.state.loggedIn then
      ...
      if entity and entity.entity and CanRepairVehicle(entity.entity) then
        ...
        if Vehicles.Repair:NeedsKit(vehicle, type) then
            ...
            if not cancelled and CanRepairVehicle(vehicle) then
              ...
              if not success then
                if errorMessage then
                  ...
                  exports['hrrp-hud']:NotificationError('Repair Failed')
                end
              else
                exports['hrrp-hud']:NotificationSuccess('Repaired Successfully')
              end
            else
              cb(false)
            end
          ...
          exports['hrrp-hud']:NotificationError('Vehicle Doesn\'t Need Repair')
          cb(false)
        end
      else
        cb(false)
