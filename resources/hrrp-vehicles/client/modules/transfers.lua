AddEventHandler('Vehicles:Client:StartUp', function()
  exports["hrrp-base"]:CallbacksRegisterClient('Vehicles:Transfers:GetTarget', function(data, cb)
...
AddEventHandler('Vehicles:Transfers:Confirm', function(data)
  exports["hrrp-base"]:CallbacksServer('Vehicles:Tranfers:CompleteTransfer', data)
end)

AddEventHandler('Vehicles:Transfers:Deny', function(data)
  exports['hrrp-hud']:NotificationError('Vehicle Transfer Cancelled')
end)
