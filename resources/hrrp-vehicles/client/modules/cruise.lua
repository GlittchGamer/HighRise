...
AddEventHandler('Vehicles:Client:StartUp', function()
  exports['hrrp-keybinds']:Add('vehicle_cruise', '', 'keyboard', 'Vehicle - Toggle Cruise', function()
    if VEHICLE_INSIDE and not noCruise[VEHICLE_CLASS] then
      if cruiseControl then
        ...
        if speed >= 6.7 then
          ...
          exports['hrrp-hud']:NotificationInfo('Cruise Can Only Be Enabled Above 25MPH')
        end
      end
