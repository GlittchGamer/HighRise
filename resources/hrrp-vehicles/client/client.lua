...
setupEvent = AddEventHandler("Core:Shared:Ready", function()
  exports["hrrp-base"]:RequestDependencies("Vehicles", {
    ...
    exports['hrrp-keybinds']:Add("toggle_engine", "F9", "keyboard", "Vehicle - Toggle Engine", function()
        ...
        Interaction:ShowMenu({
          {
            ...
            action = function()
              ...
              if #fuckingSeats > 0 then
                ...
                exports['hrrp-hud']:NotificationError("No Seats Free")
              end
            end,
          },
          {
...
AddEventHandler("Vehicles:Client:Actions:SwitchSeat", function(seatNum)
  ...
  if GetPedInVehicleSeat(VEHICLE_INSIDE, seatNum) == 0 then
    ...
    exports['hrrp-hud']:NotificationError("Seat Occupied")
  end
end)
