function RegisterCallbacks()
  exports["hrrp-base"]:CallbacksRegisterClient('Vehicles:Admin:GetVehicleToDelete', function(data, cb)
  ...
  exports["hrrp-base"]:CallbacksRegisterClient('Vehicles:Admin:GetVehicleInsideData', function(data, cb)
    if LocalPlayer.state.loggedIn then
      if VEHICLE_INSIDE then
        return cb({
  ...
  exports["hrrp-base"]:CallbacksRegisterClient('Vehicles:Admin:GetVehicleSpawnData', function(model, cb)
