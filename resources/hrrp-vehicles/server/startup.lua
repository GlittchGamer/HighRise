...
function Startup()
  ...
  if results then
    ...
    exports['hrrp-base']:LoggerTrace('Vehicles', string.format('Loaded ^2%s^7 Character Owned Vehicles', count))
    return count
  else
    exports['hrrp-base']:LoggerTrace('Vehicles', 'Failed to load Character Owned Vehicles')
    return false
  end
  ...
  if results then
    ...
    exports['hrrp-base']:LoggerTrace('Vehicles', string.format('Loaded ^2%s^7 Fleet Owned Vehicles', count))
    return count
  else
    exports['hrrp-base']:LoggerTrace('Vehicles', 'Failed to load Fleet Owned Vehicles')
    return false
  end
  ...
  Citizen.CreateThread(function()
    ...
    while true do
      ...
      if #savingVINs > 0 then
        ...
        exports['hrrp-base']:LoggerInfo('Vehicles', 'Running Periodical Save For ' .. #savingVINs .. ' Vehicles')
