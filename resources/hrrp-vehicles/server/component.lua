...
function RegisterMiddleware()
  Middleware:Add('Characters:Spawning', function(source)
    local charId = exports['hrrp-base']:FetchSource(source):GetData('Character'):GetData('ID')
  ...
  Owned = {
      ...
      Vehicles.Owned:GetVIN(VIN, function(vehicle)
        if vehicle and not Vehicles.Owned:GetActive(VIN) then
          ...
          if spawnedVehicle then
            ...
            local vehicleStore = exports['hrrp-base']:DataStoreCreate('Vehicle', vehicle.VIN, vehicle)
    ...
    ForceSave = function(self, VIN)
      ...
      if vehicleData then
        ...
        if success then
          exports['hrrp-base']:LoggerInfo('Vehicles', 'Successfully Force Saved Vehicle: ' .. VIN)
        end
      end
    end,
...
AddEventHandler('entityRemoved', function(entity)
  if GetEntityType(entity) == 2 then
    ...
    if ent?.state?.VIN and (ent.state.Owned or ent.state.PleaseDoNotFuckingDelete) and not ent.state.Deleted then
      ...
      exports['hrrp-base']:LoggerWarn("Vehicles",
