...
setupEvent = AddEventHandler("Core:Shared:Ready", function()
  exports["hrrp-base"]:RequestDependencies("Picker", {
    "Inventory",
  }, function(error)
    if #error > 0 then
      exports['hrrp-base']:LoggerCritical("Picker", "Failed To Load All Dependencies")
      return
    end
    RetrieveComponents()
...
AddEventHandler('Ped:Server:GiveItemPick:SkinnyCunt', function()
  ...
  exports['hrrp-finance']:WalletModify(Char:GetData("Source"), amount, true)
  exports['hrrp-base']:ExecuteClient(Char:GetData("Source"), "Notification", "Success",
...
AddEventHandler('Ped:Server:GiveItemPick:FatCunt', function()
  ...
  exports['hrrp-base']:ExecuteClient(Char:GetData("Source"), "Notification", "Success", "Whyyyyy Thats my lunch, You managed to take a " .. randomItem)
end)
