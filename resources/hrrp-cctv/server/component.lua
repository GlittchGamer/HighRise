...
setupEvent = AddEventHandler("Core:Shared:Ready", function()
  exports["hrrp-base"]:RequestDependencies("CCTV", {
    "Callbacks",
    "Fetch",
    "Chat",
    "CCTV",
    ...
    exports['hrrp-base']:CallbacksRegisterServer("CCTV:PreviousInGroup", function(source, data, cb)
    ...
    exports['hrrp-base']:CallbacksRegisterServer("CCTV:NextInGroup", function(source, data, cb)
      local pState = Player(source).state
      if pState.inCCTVCam then
    ...
    exports['hrrp-base']:CallbacksRegisterServer("CCTV:ViewGroup", function(source, data, cb)
...
_CCTV = {
  View = function(self, source, camId)
    local pState = Player(source).state
    if Config.AllowedJobs[pState.onDuty] or exports['hrrp-base']:FetchSource(source).Permissions:IsAdmin() then
...
AddEventHandler("Proxy:Shared:RegisterReady", function(component)
  exports["hrrp-base"]:RegisterComponent("CCTV", _CCTV)
end)
