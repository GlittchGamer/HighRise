...
AddEventHandler("Labor:Client:Setup", function()
  exports['pedinteraction']:Add("GarbageJob", GetHashKey("s_m_y_garbage"), vector3(-348.940, -1570.224, 24.228), 340.561, 25.0, {
    {
      icon = "person",
      text = "Interact",
  ...
  exports['core']:CallbacksRegisterClient("Garbage:DoingSomeAction", function(item, cb)
...
RegisterNetEvent("Garbage:Client:OnDuty", function(joiner, time)
  ...
  _blip = exports['blips']:Add("GarbageStart", "Sanitation Foreman", { x = -348.940, y = -1570.224, z = 0 }, 480, 2, 1.4)
  ...
  eventHandlers["new-route"] = RegisterNetEvent(string.format("Garbage:Client:%s:NewRoute", joiner), function(r)
    ...
    if _blip ~= nil then
      exports['blips']:Remove("GarbageStart")
      RemoveBlip(_blip)
      _blip = nil
    end
  ...
  eventHandlers["gabrage-grab"] = AddEventHandler("Garbage:Client:TrashGrab", function(entity, data)
    ...
    exports['core']:CallbacksServer("Garbage:TrashGrab", ObjToNet(entity.entity), function(s)
      if s then
  ...
  eventHandlers["toss-gabrage"] = AddEventHandler("Garbage:Client:TossBag", function()
    exports['core']:CallbacksServer("Garbage:TrashPutIn", {}, function(s)
      if s then
  ...
  eventHandlers["spawn-truck"] = AddEventHandler("Garbage:Client:GarbageSpawn", function()
    exports['core']:CallbacksServer("Garbage:GarbageSpawn", {}, function(netId)
  ...
  eventHandlers["despawn-truck"] = AddEventHandler("Garbage:Client:GarbageSpawnRemove", function()
    exports['core']:CallbacksServer("Garbage:GarbageSpawnRemove", {})
  end)
  ...
  eventHandlers["turn-in"] = AddEventHandler("Garbage:Client:TurnIn", function()
    exports['core']:CallbacksServer("Garbage:TurnIn", _joiner)
  end)
end)

AddEventHandler("Garbage:Client:StartJob", function()
  exports['core']:CallbacksServer("Garbage:StartJob", _joiner, function(state)
    if not state then
...
AddEventHandler("Garbage:Client:Buy", function()
  exports['core']:CallbacksServer("Gabage:Pawn:Buy", {}, function(items)
    local itemList = {}
...
AddEventHandler("Garbage:Client:Pawn:BuyLimited", function(data)
  exports['core']:CallbacksServer("Garbage:Pawn:BuyLimited", data)
end)
