...
AddEventHandler("Labor:Server:Startup", function()
  ...
  exports['core']:CallbacksRegisterServer("CornerDealing:Enable", function(source, data, cb)
  ...
  exports['core']:CallbacksRegisterServer("CornerDealing:Disable", function(source, data, cb)
    local char = exports['core']:FetchSource(source):GetData("Character")
    local states = char:GetData("States") or {}
  ...
  exports['core']:CallbacksRegisterServer("CornerDealing:SyncPed", function(source, data, cb)
  ...
  exports['core']:CallbacksRegisterServer("CornerDealing:SyncEvent", function(source, data, cb)
    if _joiners[source] ~= nil then
      local plyr = exports['core']:FetchSource(source)
      if plyr ~= nil then
        local char = plyr:GetData("Character")
  ...
  exports['core']:CallbacksRegisterServer("CornerDealing:CheckCorner", function(source, data, cb)
    if _joiners[source] ~= nil then
      local plyr = exports['core']:FetchSource(source)
      if plyr ~= nil then
        local char = plyr:GetData("Character")
        if char ~= nil then
          for k, v in ipairs(_cornerCds) do
            if os.time() < v.expires and #(data.coords - v.coords) < 100.0 then
              exports['core']:ExecuteClient(source, "Notification", "Error", "Someone Has Recently Sold Around Here")
              return cb(false)
            end
          end
  ...
  exports['core']:CallbacksRegisterServer("CornerDealing:StartCornering", function(source, data, cb)
    if _joiners[source] ~= nil then
      local plyr = exports['core']:FetchSource(source)
      if plyr ~= nil then
        local char = plyr:GetData("Character")
  ...
  exports['core']:CallbacksRegisterServer("CornerDealing:StopCornering", function(source, data, cb)
    if _joiners[source] ~= nil then
      Labor.Offers:Fail(_joiners[source], _JOB)
    end
  end)

  exports['core']:CallbacksRegisterServer("CornerDealing:GetSaleMenu", function(source, data, cb)
    if _joiners[source] ~= nil then
      local plyr = exports['core']:FetchSource(source)
      if plyr ~= nil then
        local char = plyr:GetData("Character")
  ...
  exports['core']:CallbacksRegisterServer("CornerDealing:DoSale", function(source, data, cb)
    if _joiners[source] ~= nil then
      local plyr = exports['core']:FetchSource(source)
      if plyr ~= nil then
        local char = plyr:GetData("Character")
  ...
  exports['core']:CallbacksRegisterServer("CornerDealing:NoPeds", function(source, data, cb)
  ...
  -- exports['core']:CallbacksRegisterServer("CornerDealing:PedDied", function(source, data, cb)
  -- 	if _joiners[source] ~= nil then
  -- 		local plyr = exports['core']:FetchSource(source)
  -- 		if plyr ~= nil then
  -- 			local char = plyr:GetData("Character")
  ...
  exports['core']:CallbacksRegisterServer("CornerDealing:DestroyVehicle", function(source, data, cb)
    if _joiners[source] ~= nil then
      local plyr = exports['core']:FetchSource(source)
      if plyr ~= nil then
        local char = plyr:GetData("Character")
  ...
  exports['core']:CallbacksRegisterServer("CornerDealing:PedTimeout", function(source, data, cb)
    if _joiners[source] ~= nil then
      local plyr = exports['core']:FetchSource(source)
      if plyr ~= nil then
        local char = plyr:GetData("Character")
  ...
  exports['core']:CallbacksRegisterServer("CornerDealing:LeaveArea", function(source, data, cb)
    if _joiners[source] ~= nil then
      local plyr = exports['core']:FetchSource(source)
      if plyr ~= nil then
        local char = plyr:GetData("Character")
