...
AddEventHandler("Labor:Server:Startup", function()
  exports['core']:CallbacksRegisterServer("Farming:StartJob", function(source, data, cb)
  ...
  exports['core']:CallbacksRegisterServer("Farming:CompleteNode", function(source, data, cb)
  ...
  exports['core']:CallbacksRegisterServer("Farming:TurnIn", function(source, data, cb)
    local char = exports['core']:FetchSource(source):GetData("Character")
    if char:GetData("TempJob") == _JOB and _joiners[source] ~= nil and _farming[_joiners[source]] ~= nil then
