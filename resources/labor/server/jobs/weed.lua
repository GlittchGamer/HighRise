...
AddEventHandler("Labor:Server:Startup", function()
  ...
  exports['core']:CallbacksRegisterServer("WeedRun:Enable", function(source, data, cb)
  ...
  exports['core']:CallbacksRegisterServer("WeedRun:Disable", function(source, data, cb)
    local char = exports['core']:FetchSource(source):GetData("Character")
    local states = char:GetData("States") or {}
  ...
  exports['core']:CallbacksRegisterServer("WeedRun:StartDropoff", function(source, data, cb)
  ...
  exports['core']:CallbacksRegisterServer("WeedRun:DoDropoff", function(source, data, cb)
    if _joiners[source] ~= nil then
