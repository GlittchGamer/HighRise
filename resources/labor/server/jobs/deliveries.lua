...
AddEventHandler("Labor:Server:Startup", function()
  exports['core']:CallbacksRegisterServer("Deliveries:StartJob", function(source, data, cb)
  ...
  exports['core']:CallbacksRegisterServer("Deliveries:DeliveriesSpawn", function(source, data, cb)
  ...
  exports['core']:CallbacksRegisterServer("Deliveries:DeliveriesSpawnRemove", function(source, data, cb)
  ...
  exports['core']:CallbacksRegisterServer("Deliveries:PackageGrab", function(source, data, cb)
    if _joiners[source] ~= nil then
      exports['core']:CallbacksClient(source, "Deliveries:DoingSomeAction", "GRAB_BOX")
      cb(true)
    else
      cb(false)
    end
  ...
  exports['core']:CallbacksRegisterServer("Deliveries:DeliverPackage", function(source, data, cb)
  ...
  exports['core']:CallbacksRegisterServer("Deliveries:TurnIn", function(source, data, cb)
