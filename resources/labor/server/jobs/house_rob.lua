...
AddEventHandler("Labor:Server:Startup", function()
  ...
  exports['core']:CallbacksRegisterServer("HouseRobbery:Enable", function(source, data, cb)
    local char = exports['core']:FetchSource(source):GetData("Character")
  ...
  exports['core']:CallbacksRegisterServer("HouseRobbery:Disable", function(source, data, cb)
    local char = exports['core']:FetchSource(source):GetData("Character")
    local states = char:GetData("States") or {}
  ...
  exports['core']:CallbacksRegisterServer("HouseRobbery:ArrivedNear", function(source, data, cb)
  ...
  exports['core']:CallbacksRegisterServer("HouseRobbery:BreakIn", function(source, data, cb)
  ...
  exports['core']:CallbacksRegisterServer("HouseRobbery:Exit", function(source, data, cb)
    exports['pwnzor']:PwnzorPlayersTempPosIgnore(source)
    local intr = nil
  ...
  exports['core']:CallbacksRegisterServer("HouseRobbery:HackAlarm", function(source, data, cb)
    if
        _joiners[source] ~= nil
        and _robbers[_joiners[source]] ~= nil
  ...
  exports['core']:CallbacksRegisterServer("HouseRobbery:Search", function(source, data, cb)
    local char = exports['core']:FetchSource(source):GetData("Character")
    if
        char:GetData("TempJob") == _JOB
        and _joiners[source] ~= nil
...
AddEventHandler("HouseRobbery:Server:OnDuty", function(joiner, members, isWorkgroup)
  ...
  elseif isWorkgroup then
    if #members > 0 then
      for k, v in ipairs(members) do
        local gChar = exports['core']:FetchSource(v.ID):GetData("Character")
