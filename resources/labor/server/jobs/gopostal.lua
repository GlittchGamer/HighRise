...
AddEventHandler("Labor:Server:Startup", function()
  exports['core']:CallbacksRegisterServer("GoPostal:StartJob", function(source, data, cb)
  ...
  exports['core']:CallbacksRegisterServer("GoPostal:GoPostalSpawn", function(source, data, cb)
  ...
  exports['core']:CallbacksRegisterServer("GoPostal:GoPostalSpawnRemove", function(source, data, cb)
  ...
  exports['core']:CallbacksRegisterServer("GoPostal:PackageGrab", function(source, data, cb)
    if _joiners[source] ~= nil then
      exports['core']:CallbacksClient(source, "GoPostal:DoingSomeAction", "GRAB_BOX")
      cb(true)
    else
      cb(false)
    end
  ...
  exports['core']:CallbacksRegisterServer("GoPostal:DeliverPackage", function(source, data, cb)
  ...
  exports['core']:CallbacksRegisterServer("GoPostal:TurnIn", function(source, data, cb)
