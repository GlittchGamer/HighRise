...
AddEventHandler("Labor:Server:Startup", function()
  ...
  exports['core']:CallbacksRegisterServer("Coke:StartWork", function(source, data, cb)
        ...
        if Wallet:Has(source, 100000) then
          if not GlobalState["CokeRunActive"] and _active == nil then
            if not GlobalState["CokeRunCD"] or os.time() > GlobalState["CokeRunCD"] then
              ...
              exports['core']:ExecuteClient(source, "Notification", "Error", "Someone Has Already Done This Recently")
            end
          else
            exports['core']:ExecuteClient(source, "Notification", "Error", "Someone Else Is Already Doing This")
          end
        else
          exports['core']:ExecuteClient(source, "Notification", "Error", "You Don't Have Enough Cash, Come Back When You Do")
        end
      end
    end
  end)

  exports['core']:CallbacksRegisterServer("Coke:Abort", function(source, data, cb)
    local plyr = exports['core']:FetchSource(source)
    if plyr ~= nil then
      local char = plyr:GetData("Character")
      if char ~= nil then
        if _active ~= nil and _active.joiner == source then
          if _active.state == 0 then
            ...
            exports['core']:ExecuteClient(source, "Notification", "Error", "Too Late, You Cannot Cancel This Now")
          end
        end
      end
    end
  ...
  exports['core']:CallbacksRegisterServer("Coke:ArriveAtCayo", function(source, data, cb)
  ...
  exports['core']:CallbacksRegisterServer("Coke:StartHeist", function(source, data, cb)
  ...
  exports['core']:CallbacksRegisterServer("Coke:ArrivedAtPoint", function(source, data, cb)
  ...
  exports['core']:CallbacksRegisterServer("Coke:LeftCayo", function(source, data, cb)
  ...
  exports['core']:CallbacksRegisterServer("Coke:Finish", function(source, data, cb)
