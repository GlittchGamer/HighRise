...
AddEventHandler("Labor:Server:Startup", function()
  exports['core']:CallbacksRegisterServer("Garbage:StartJob", function(source, data, cb)
  ...
  exports['core']:CallbacksRegisterServer("Garbage:GarbageSpawn", function(source, data, cb)
  ...
  exports['core']:CallbacksRegisterServer("Garbage:GarbageSpawnRemove", function(source, data, cb)
  ...
  exports['core']:CallbacksRegisterServer("Garbage:TrashGrab", function(source, data, cb)
    if _joiners[source] ~= nil then
      exports['core']:CallbacksClient(source, "Garbage:DoingSomeAction", "grabTrash")
  ...
  exports['core']:CallbacksRegisterServer("Garbage:TrashPutIn", function(source, data, cb)
    ...
    if char:GetData("TempJob") == _JOB and _joiners[source] ~= nil and _Garbage[_joiners[source]] ~= nil then
      ...
      exports['core']:CallbacksClient(source, "Garbage:DoingSomeAction", "trashPutIn")
  ...
  exports['core']:CallbacksRegisterServer("Garbage:TurnIn", function(source, data, cb)
  ...
  exports['core']:CallbacksRegisterServer("Garbage:Pawn:Sell", function(source, data, cb)
    local char = exports['core']:FetchSource(source):GetData("Character")
    ...
    if repLvl > 0 then
      ...
      if money > 0 then
        ...
        exports['core']:ExecuteClient(source, "Notification", "Error", "You Have Nothing To Sell")
      end
    else
      exports['core']:ExecuteClient(source, "Notification", "Error", "You're Not Trusted Enough To Do This Yet")
    end
  end)

  -- exports['core']:CallbacksRegisterServer("Gabage:Pawn:Buy", function(source, data, cb)
  -- 	local char = exports['core']:FetchSource(source):GetData("Character")
  -- 	local repLvl = Reputation:GetLevel(source, _JOB)
  ...
  -- exports['core']:CallbacksRegisterServer("Garbage:Pawn:BuyLimited", function(source, data, cb)
  -- 	local char = exports['core']:FetchSource(source):GetData("Character")
  -- 	local repLvl = Reputation:GetLevel(source, _JOB)
  ...
  -- 			end
  -- 		else
  -- 			exports['core']:ExecuteClient(source, "Notification", "Error", "Item Not In Stock")
  -- 		end
  -- 	else
  -- 		exports['core']:ExecuteClient(source, "Notification", "Error", "You're Not Trusted Enough To Do This Yet")
  -- 	end
