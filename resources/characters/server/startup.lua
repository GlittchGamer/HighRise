...
function Startup()
  ...
  exports['core']:LoggerTrace('Characters', 'Loaded ^2' .. #results .. '^7 Spawn Locations', { console = true })
...
AddEventHandler('Locations:Server:Added', function(type, location)
  if type == 'spawn' then
    ...
    exports['core']:LoggerInfo('Characters', 'New Spawn Point Created: ^5' .. location.Name, { console = true })
  end
end)
