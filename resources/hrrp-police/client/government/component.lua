...
setupEvent = AddEventHandler("Core:Shared:Ready", function()
  exports["hrrp-base"]:RequestDependencies("Police", {
    ...
    exports['hrrp-pedinteraction']:Add("govt-services", `a_f_m_eastsa_02`, vector3(-552.412, -202.760, 37.239), 337.363, 25.0,
      govServices, "bell-concierge")
    -- exports['ox_target']:TargetingZonesAddBox("govt-services", "bell-concierge", vector3(-555.92, -186.01, 38.22), 2.0, 2.0, {
    --     heading = 28,
    --     --debugPoly=true,
    --     minZ = 37.22,
    --     maxZ = 39.62
    ...
    for k, v in ipairs(govDutyPoints) do
      exports['ox_target']:TargetingZonesAddBox("gov-info-" .. k, "gavel", v.center, v.length, v.width, v.options, {
        {
          icon = "clipboard-check",
          text = "Go On Duty",
          event = "Government:Client:OnDuty",
    ...
    exports['hrrp-polyzone']:PolyZoneCreateBox("courtroom", vector3(-571.17, -207.02, 38.77), 18.2, 19.6, {
      heading = 30,
      --debugPoly=true,
      minZ = 36.97,
      maxZ = 47.37
    ...
    exports['ox_target']:TargetingZonesAddBox("court-gavel", "gavel", vector3(-575.8, -210.3, 38.77), 0.8, 0.8, {
      heading = 30,
      --debugPoly=true,
      minZ = 37.77,
      maxZ = 39.37
...
RegisterNetEvent("Characters:Client:Spawn", function()
  exports['hrrp-blips']:Add('courthouse', "Courthouse", vector3(-538.916, -214.852, 37.650), 419, 0, 0.9)
end)
...
RegisterNetEvent("Government:Client:Gavel", function()
  ...
  if exports['hrrp-polyzone']:PolyZoneIsCoordsInZone(coords, "courtroom") then
