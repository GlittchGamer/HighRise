...
setupEvent = AddEventHandler("Core:Shared:Ready", function()
  exports["hrrp-base"]:RequestDependencies("EMS", {
    ...
    exports["hrrp-base"]:CallbacksRegisterClient("EMS:ApplyBandage", function(data, cb)
      SetEntityHealth(LocalPlayer.state.ped, GetEntityHealth(LocalPlayer.state.ped) + 10)
      cb(true)
    end)

    exports["hrrp-base"]:CallbacksRegisterClient("EMS:Heal", function(data, cb)
...
RegisterNetEvent("Characters:Client:Spawn", function()
  exports['hrrp-blips']:Add("mt_zonah", "Hospital", vector3(-457.019, -333.263, 69.521), 61, 42, 0.8)
end)
