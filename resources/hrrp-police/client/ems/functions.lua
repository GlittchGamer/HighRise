...
function BuildTreatmentMenu(id)
  exports["hrrp-base"]:CallbacksServer("Damage:GetLimbDamage", id, function(menu)
    local options = {}
    ...
    if targetState.isDead then
      if exports['hrrp-jobs']:JobsPermissionsHasJob("ems") then
        table.insert(options, {
      ...
      print(exports['hrrp-jobs']:JobsPermissionsHasJob("ems"))
      if exports['hrrp-jobs']:JobsPermissionsHasJob("ems") then
