function RegisterInteractions()
  ...
  Interaction:RegisterMenu("police-raid-biz", "Search Inventory", "magnifying-glass", function(data)
    ...
    Progress:ProgressWithTickEvent({
      ...
      if not cancelled then
        exports["hrrp-base"]:CallbacksServer("Inventory:Raid", LocalPlayer.state._inInvPoly.inventory, function(owner) end)
      end
    end)
  end, function()
  ...
  Interaction:RegisterMenu("pd-locked-veh", "Secured Compartment", "shield-keyhole", function(data)
    ...
    Progress:Progress({
      ...
      if not status then
        exports["hrrp-base"]:CallbacksServer("Police:AccessRifleRack")
      end
    end)
  end, function()
