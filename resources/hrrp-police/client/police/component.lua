...
setupEvent = AddEventHandler("Core:Shared:Ready", function()
  exports["hrrp-base"]:RequestDependencies("Police", {
    ...
    exports["hrrp-base"]:CallbacksRegisterClient("Police:Breach", function(data, cb)
      Progress:Progress({
        name = "breach_action",
        duration = 3000,
        label = "Breaching",
    ...
    local _cuffCd = false
    exports['hrrp-keybinds']:Add("pd_cuff", "LBRACKET", "keyboard", "Police - Cuff", function()
    ...
    exports['hrrp-keybinds']:Add("pd_uncuff", "RBRACKET", "keyboard", "Police - Uncuff", function()
      if LocalPlayer.state.Character ~= nil and LocalPlayer.state.onDuty == "police" then
        if not _cuffCd then
    ...
    -- exports['hrrp-keybinds']:Add("pd_toggle_cuff", "", "keyboard", "Police - Cuff / Uncuff", function()
    -- 	if LocalPlayer.state.Character ~= nil and LocalPlayer.state.onDuty == "police" then
    -- 		if not _cuffCd then
    ...
    exports['hrrp-keybinds']:Add("tackle", "", "keyboard", "Tackle", function()
    ...
    exports["hrrp-base"]:CallbacksRegisterClient("Police:DeploySpikes", function(data, cb)
...
AddEventHandler("Police:Client:DoApartmentBreach", function(values, data)
  exports["hrrp-base"]:CallbacksServer("Police:Breach", {
    type = "apartment",
...
RegisterNetEvent("Characters:Client:Spawn", function()
  for k, v in ipairs(policeStationBlips) do
    exports['hrrp-blips']:Add("police_station_" .. k, "Police Department", v, 137, 38, 0.6)
  end
end)
