...
function RegisterCallbacks()
  exports['hrrp-base']:CallbacksRegisterServer("hrrp-dj:server:songInfo", function(source, data, cb)
    cb(previousSongs)
  end)

  exports['hrrp-base']:CallbacksRegisterServer("hrrp-dj:server:playMusic", function(source, data, cb)
    local src = source
  ...
  exports['hrrp-base']:CallbacksRegisterServer("hrrp-dj:server:changeVolume", function(source, data, cb)
    local src = source
    local zoneNum = data.zoneNum
  ...
  exports['hrrp-base']:CallbacksRegisterServer("hrrp-dj:server:stopMusic", function(source, data, cb)
    local src = source
    ...
    TriggerClientEvent("hrrp-dj:client:playMusic", src, { zone = data.zoneNum })
  end)

  exports['hrrp-base']:CallbacksRegisterServer("hrrp-dj:server:pauseMusic", function(source, data, cb)
    local src = source
    local zoneLabel = data.zoneName
    if Config.Locations[data.zoneNum].playing then
      Config.Locations[data.zoneNum].playing = nil
  ...
  exports['hrrp-base']:CallbacksRegisterServer("hrrp-dj:server:resumeMusic", function(source, data, cb)
    local src = source
    local zoneLabel = data.zoneName
