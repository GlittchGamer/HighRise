...
INTERACTION = {
  ...
  Show = function(self)
    if not exports['hrrp-hud']:IsDisabledAllowDead() then
      ...
      SendNUIMessage({
        action = "SET_INTERACTION_MENU_ITEMS",
        data = {
          items = is,
        },
      })
...
AddEventHandler("Proxy:Shared:RegisterReady", function()
  exports["hrrp-base"]:RegisterComponent("Interaction", INTERACTION)
end)
