...
AddEventHandler('Proxy:Shared:ExtendReady', function(component)
  if component == 'Vehicles' then
    exports['core']:ExtendComponent(component, _vehicleRepair)
  end
end)
...
AddEventHandler('Vehicles:Client:StartUp', function()
  exports['core']:CallbacksRegisterClient('Vehicles:RepairKit', function(type, cb)
    if LocalPlayer.state.loggedIn then
      ...
      if entity and entity.entity and CanRepairVehicle(entity.entity) then
        ...
        if Vehicles.Repair:NeedsKit(vehicle, type) then
            ...
            if not cancelled and CanRepairVehicle(vehicle) then
              ...
              if not success then
                if errorMessage then
                  ...
                  exports['hud']:NotificationError('Repair Failed')
                end
              else
                exports['hud']:NotificationSuccess('Repaired Successfully')
              end
            else
              cb(false)
            end
          ...
          exports['hud']:NotificationError('Vehicle Doesn\'t Need Repair')
          cb(false)
        end
      else
        cb(false)
