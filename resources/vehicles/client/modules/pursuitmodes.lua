...
AddEventHandler("Characters:Client:Spawn", function()
  Citizen.Wait(500)
  exports['hud']:RegisterStatus("pursuit-modes", 0, 100, "gauge-circle-bolt", "#892020", true, false, {
    hideZero = true,
  })
end)
...
AddEventHandler('Vehicles:Client:StartUp', function()
  exports['keybinds']:Add('vehicle_pursuit_modes', '', 'keyboard', 'Vehicle - Pursuit Modes', function()
