...
AddEventHandler('Vehicles:Client:StartUp', function()
  exports['core']:CallbacksRegisterClient('Vehicles:Keys:GetVehicleToShare', function(data, cb)
  ...
  exports['keybinds']:Add('vehicle_lock', 'u', 'keyboard', 'Vehicle - Toggle Door Locks', function()
...
_vehicleKeysExtension = {
  ...
  SetLocks = function(self, veh, state)
    exports['core']:CallbacksServer('Vehicles:ToggleLocks', {
      ...
      if success then
        UnlockAnim()
        if newState then
          exports['hud']:NotificationError('Vehicle Locked')
          Sounds.Do.Play:One('central-locking.ogg', 0.2)
          DoVehicleLockShit(veh)
        else
          exports['hud']:NotificationSuccess('Vehicle Unlocked')
          Sounds.Do.Play:One('central-locking.ogg', 0.2)
...
AddEventHandler('Proxy:Shared:ExtendReady', function(component)
  if component == 'Vehicles' then
    exports['core']:ExtendComponent(component, _vehicleKeysExtension)
  end
end)
