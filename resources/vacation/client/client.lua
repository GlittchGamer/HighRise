...
setupEvent = AddEventHandler("Core:Shared:Ready", function()
  exports['core']:RequestDependencies("Island", {
    "Utils",
    "Callbacks",
    "Logger",
    "Polyzone",
    ...
    exports['polyzonehandler']:PolyZoneCreateCircle('cayo_perico', vector3(4965.17, -5693.89, 200.86), 2500.0, {})

    exports['polyzonehandler']:PolyZoneCreatePoly(
      'cayo_perico_weather',
      {
...
AddEventHandler('Polyzone:Enter', function(id, point, insideZone, data)
  if id == 'cayo_perico' and not inCayoPerico then
    ...
    exports['core']:LoggerTrace('Island', 'Entering Island Zone')
  end
end)
...
AddEventHandler('Polyzone:Exit', function(id, point, insideZone, data)
  if id == 'cayo_perico' and inCayoPerico then
    ...
    inCayoPerico = false
    exports['core']:LoggerTrace('Island', 'Leaving Island Zone')
