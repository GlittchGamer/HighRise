...
function CreateFurnitureCallbacks()
  exports['core']:CallbacksRegisterServer("Properties:PlaceFurniture", function(source, data, cb)
  ...
  exports['core']:CallbacksRegisterServer("Properties:MoveFurniture", function(source, data, cb)
    local char = exports['core']:FetchSource(source):GetData("Character")
    if char then
      local insideProperty = GlobalState[string.format("%s:Property", source)]
  ...
  exports['core']:CallbacksRegisterServer("Properties:DeleteFurniture", function(source, data, cb)
    local char = exports['core']:FetchSource(source):GetData("Character")
    if char then
      local insideProperty = GlobalState[string.format("%s:Property", source)]
