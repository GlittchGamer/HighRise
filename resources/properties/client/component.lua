...
setupEvent = AddEventHandler("Core:Shared:Ready", function()
  exports['core']:RequestDependencies("Properties", {
    ...
    Interaction:RegisterMenu("house-lock", "Lock", "lock", function(data)
      Interaction:Hide()
      exports['core']:CallbacksServer("Properties:ChangeLock", {
        id = data,
        state = true,
      }, function(state)
        if state then
          exports['hud']:NotificationSuccess("Property Locked")
        else
          exports['hud']:NotificationError("Unable to Lock Property")
        end
      end)
    end, function()
    ...
    Interaction:RegisterMenu("house-unlock", "Unlock", "unlock", function(data)
      ...
      exports['core']:CallbacksServer("Properties:ChangeLock", {
        ...
        if state then
          exports['hud']:NotificationSuccess("Property Unlocked")
        else
          exports['hud']:NotificationError("Unable to Unlock Property")
        end
      end)
    end, function()
      if _insideProperty and _insideInterior and _propertiesLoaded then
        ...
        if
            ...
            and (
              ...
              or (
                ...
                and exports['jobs']:JobsPermissionsHasPermissionInJob("realestate", "JOB_DOORS")
              )
            )
        then
          local interior = PropertyInteriors[_insideInterior]
    ...
    exports['keybinds']:Add("furniture_prev", "LEFT", "keyboard", "Furniture - Previous Item", function()
    ...
    exports['keybinds']:Add("furniture_next", "RIGHT", "keyboard", "Furniture - Next Item", function()
      if _placingFurniture then
        CycleFurniture(true)
      elseif _previewingInterior and not _previewingInteriorSwitching then
        NextPreview()
    ...
    isBackdoor and "Property Backdoor" or "Property", isBackdoor and "house-window" or "house", function(data)
      local pMenu = {
        {
          ...
          shouldShow = function()
            ...
            return ((prop.keys ~= nil and prop.keys[LocalPlayer.state.Character:GetData("ID")] ~= nil)
              or (not prop.sold and LocalPlayer.state.onDuty == "realestate" and exports['jobs']:JobsPermissionsHasPermissionInJob(
                "realestate",
                "JOB_DOORS"
              ))
        ...
        },
        {
          ...
          action = function()
            exports['hud']:NotificationError('This Property Has Been Foreclosed! This is why you should pay your property loans...',
              10000)
          end,
          shouldShow = function()
            if not _propertiesLoaded then
      ...
      if not isBackdoor then
        table.insert(pMenu, {
          ...
          label = "Ring Doorbell",
          action = function()
            exports['core']:CallbacksServer("Properties:RingDoorbell", data.propertyId, function()
        ...
        table.insert(pMenu, {
          ...
          label = "Request Agent",
          action = function()
            exports['core']:CallbacksServer("Properties:RequestAgent", data.propertyId, function(state)
              if state then
                exports['hud']:NotificationSuccess("Notification Sent")
              else
                exports['hud']:NotificationError("Unable To Send Notification")
              end
              Interaction:Hide()
            end)
          end,
...
PROPERTIES = {
  ...
  Extras = {
    Stash = function(self)
      exports['core']:CallbacksServer("Properties:Validate", {
  ...
  Furniture = {
    ...
    Place = function(self, model, category, metadata, blockBrowse, skipPhone)
      ...
      exports['objects']:Start(GetHashKey(model), "Furniture:Client:Place", metadata, true, "Furniture:Client:Cancel", true,
        fData.placeGround)
    ...
    Move = function(self, id, skipPhone)
      ...
      exports['objects']:Start(GetHashKey(furn.model), "Furniture:Client:Move", { id = id }, true,
    ...
    Delete = function(self, id)
      ...
      if fData.cat == "storage" and catCounts["storage"] < 1 then
        exports['hud']:NotificationError("You Are Required to Have At Least One Storage Container!")
        return false
      end

      local p = promise.new()

      exports['core']:CallbacksServer("Properties:DeleteFurniture", {
        id = id,
      }, function(success, furniture)
        if success then
          exports['hud']:NotificationSuccess("Deleted Item")
          ...
          p:resolve(false)
          exports['hud']:NotificationError("Error")
        end
      end)
