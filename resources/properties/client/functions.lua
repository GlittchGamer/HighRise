...
function EnterProperty(data, backdoor)
  exports['core']:CallbacksServer("Properties:EnterProperty", data.propertyId, function(state, pId, int)
    if state then
      Interaction:Hide()
...
function ExitProperty(data, backdoor)
  exports['core']:CallbacksServer("Properties:ExitProperty", {}, function(pId)
    ...
    if _placingFurniture then
      exports['objects']:Cancel(true, true)
      Phone:ResetRoute()
    ...
    --exports['polyzonehandler']:PolyZoneRemove("property-int-zone")
